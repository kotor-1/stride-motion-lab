 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var I_;function Ky(){if(I_)return he;I_=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),g=Symbol.for("react.activity"),x=Symbol.iterator;function S(P){return P===null||typeof P!="object"?null:(P=x&&P[x]||P["@@iterator"],typeof P=="function"?P:null)}var E={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},b=Object.assign,M={};function _(P,nt,Et){this.props=P,this.context=nt,this.refs=M,this.updater=Et||E}_.prototype.isReactComponent={},_.prototype.setState=function(P,nt){if(typeof P!="object"&&typeof P!="function"&&P!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,P,nt,"setState")},_.prototype.forceUpdate=function(P){this.updater.enqueueForceUpdate(this,P,"forceUpdate")};function F(){}F.prototype=_.prototype;function L(P,nt,Et){this.props=P,this.context=nt,this.refs=M,this.updater=Et||E}var D=L.prototype=new F;D.constructor=L,b(D,_.prototype),D.isPureReactComponent=!0;var G=Array.isArray;function N(){}var I={H:null,A:null,T:null,S:null},W=Object.prototype.hasOwnProperty;function U(P,nt,Et){var rt=Et.ref;return{$$typeof:r,type:P,key:nt,ref:rt!==void 0?rt:null,props:Et}}function w(P,nt){return U(P.type,nt,P.props)}function V(P){return typeof P=="object"&&P!==null&&P.$$typeof===r}function J(P){var nt={"=":"=0",":":"=2"};return"$"+P.replace(/[=:]/g,function(Et){return nt[Et]})}var lt=/\/+/g;function ht(P,nt){return typeof P=="object"&&P!==null&&P.key!=null?J(""+P.key):nt.toString(36)}function dt(P){switch(P.status){case"fulfilled":return P.value;case"rejected":throw P.reason;default:switch(typeof P.status=="string"?P.then(N,N):(P.status="pending",P.then(function(nt){P.status==="pending"&&(P.status="fulfilled",P.value=nt)},function(nt){P.status==="pending"&&(P.status="rejected",P.reason=nt)})),P.status){case"fulfilled":return P.value;case"rejected":throw P.reason}}throw P}function B(P,nt,Et,rt,Rt){var Y=typeof P;(Y==="undefined"||Y==="boolean")&&(P=null);var ut=!1;if(P===null)ut=!0;else switch(Y){case"bigint":case"string":case"number":ut=!0;break;case"object":switch(P.$$typeof){case r:case t:ut=!0;break;case v:return ut=P._init,B(ut(P._payload),nt,Et,rt,Rt)}}if(ut)return Rt=Rt(P),ut=rt===""?"."+ht(P,0):rt,G(Rt)?(Et="",ut!=null&&(Et=ut.replace(lt,"$&/")+"/"),B(Rt,nt,Et,"",function(zt){return zt})):Rt!=null&&(V(Rt)&&(Rt=w(Rt,Et+(Rt.key==null||P&&P.key===Rt.key?"":(""+Rt.key).replace(lt,"$&/")+"/")+ut)),nt.push(Rt)),1;ut=0;var Ut=rt===""?".":rt+":";if(G(P))for(var Pt=0;Pt<P.length;Pt++)rt=P[Pt],Y=Ut+ht(rt,Pt),ut+=B(rt,nt,Et,Y,Rt);else if(Pt=S(P),typeof Pt=="function")for(P=Pt.call(P),Pt=0;!(rt=P.next()).done;)rt=rt.value,Y=Ut+ht(rt,Pt++),ut+=B(rt,nt,Et,Y,Rt);else if(Y==="object"){if(typeof P.then=="function")return B(dt(P),nt,Et,rt,Rt);throw nt=String(P),Error("Objects are not valid as a React child (found: "+(nt==="[object Object]"?"object with keys {"+Object.keys(P).join(", ")+"}":nt)+"). If you meant to render a collection of children, use an array instead.")}return ut}function $(P,nt,Et){if(P==null)return P;var rt=[],Rt=0;return B(P,rt,"","",function(Y){return nt.call(Et,Y,Rt++)}),rt}function q(P){if(P._status===-1){var nt=P._result;nt=nt(),nt.then(function(Et){(P._status===0||P._status===-1)&&(P._status=1,P._result=Et)},function(Et){(P._status===0||P._status===-1)&&(P._status=2,P._result=Et)}),P._status===-1&&(P._status=0,P._result=nt)}if(P._status===1)return P._result.default;throw P._result}var Mt=typeof reportError=="function"?reportError:function(P){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var nt=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof P=="object"&&P!==null&&typeof P.message=="string"?String(P.message):String(P),error:P});if(!window.dispatchEvent(nt))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",P);return}console.error(P)},Ct={map:$,forEach:function(P,nt,Et){$(P,function(){nt.apply(this,arguments)},Et)},count:function(P){var nt=0;return $(P,function(){nt++}),nt},toArray:function(P){return $(P,function(nt){return nt})||[]},only:function(P){if(!V(P))throw Error("React.Children.only expected to receive a single React element child.");return P}};return he.Activity=g,he.Children=Ct,he.Component=_,he.Fragment=i,he.Profiler=l,he.PureComponent=L,he.StrictMode=s,he.Suspense=m,he.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=I,he.__COMPILER_RUNTIME={__proto__:null,c:function(P){return I.H.useMemoCache(P)}},he.cache=function(P){return function(){return P.apply(null,arguments)}},he.cacheSignal=function(){return null},he.cloneElement=function(P,nt,Et){if(P==null)throw Error("The argument must be a React element, but you passed "+P+".");var rt=b({},P.props),Rt=P.key;if(nt!=null)for(Y in nt.key!==void 0&&(Rt=""+nt.key),nt)!W.call(nt,Y)||Y==="key"||Y==="__self"||Y==="__source"||Y==="ref"&&nt.ref===void 0||(rt[Y]=nt[Y]);var Y=arguments.length-2;if(Y===1)rt.children=Et;else if(1<Y){for(var ut=Array(Y),Ut=0;Ut<Y;Ut++)ut[Ut]=arguments[Ut+2];rt.children=ut}return U(P.type,Rt,rt)},he.createContext=function(P){return P={$$typeof:h,_currentValue:P,_currentValue2:P,_threadCount:0,Provider:null,Consumer:null},P.Provider=P,P.Consumer={$$typeof:c,_context:P},P},he.createElement=function(P,nt,Et){var rt,Rt={},Y=null;if(nt!=null)for(rt in nt.key!==void 0&&(Y=""+nt.key),nt)W.call(nt,rt)&&rt!=="key"&&rt!=="__self"&&rt!=="__source"&&(Rt[rt]=nt[rt]);var ut=arguments.length-2;if(ut===1)Rt.children=Et;else if(1<ut){for(var Ut=Array(ut),Pt=0;Pt<ut;Pt++)Ut[Pt]=arguments[Pt+2];Rt.children=Ut}if(P&&P.defaultProps)for(rt in ut=P.defaultProps,ut)Rt[rt]===void 0&&(Rt[rt]=ut[rt]);return U(P,Y,Rt)},he.createRef=function(){return{current:null}},he.forwardRef=function(P){return{$$typeof:d,render:P}},he.isValidElement=V,he.lazy=function(P){return{$$typeof:v,_payload:{_status:-1,_result:P},_init:q}},he.memo=function(P,nt){return{$$typeof:p,type:P,compare:nt===void 0?null:nt}},he.startTransition=function(P){var nt=I.T,Et={};I.T=Et;try{var rt=P(),Rt=I.S;Rt!==null&&Rt(Et,rt),typeof rt=="object"&&rt!==null&&typeof rt.then=="function"&&rt.then(N,Mt)}catch(Y){Mt(Y)}finally{nt!==null&&Et.types!==null&&(nt.types=Et.types),I.T=nt}},he.unstable_useCacheRefresh=function(){return I.H.useCacheRefresh()},he.use=function(P){return I.H.use(P)},he.useActionState=function(P,nt,Et){return I.H.useActionState(P,nt,Et)},he.useCallback=function(P,nt){return I.H.useCallback(P,nt)},he.useContext=function(P){return I.H.useContext(P)},he.useDebugValue=function(){},he.useDeferredValue=function(P,nt){return I.H.useDeferredValue(P,nt)},he.useEffect=function(P,nt){return I.H.useEffect(P,nt)},he.useEffectEvent=function(P){return I.H.useEffectEvent(P)},he.useId=function(){return I.H.useId()},he.useImperativeHandle=function(P,nt,Et){return I.H.useImperativeHandle(P,nt,Et)},he.useInsertionEffect=function(P,nt){return I.H.useInsertionEffect(P,nt)},he.useLayoutEffect=function(P,nt){return I.H.useLayoutEffect(P,nt)},he.useMemo=function(P,nt){return I.H.useMemo(P,nt)},he.useOptimistic=function(P,nt){return I.H.useOptimistic(P,nt)},he.useReducer=function(P,nt,Et){return I.H.useReducer(P,nt,Et)},he.useRef=function(P){return I.H.useRef(P)},he.useState=function(P){return I.H.useState(P)},he.useSyncExternalStore=function(P,nt,Et){return I.H.useSyncExternalStore(P,nt,Et)},he.useTransition=function(){return I.H.useTransition()},he.version="19.2.8",he}var B_;function Id(){return B_||(B_=1,ih.exports=Ky()),ih.exports}var se=Id();const Qy=rv(se);var ah={exports:{}},wo={},sh={exports:{}},rh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var F_;function Jy(){return F_||(F_=1,(function(r){function t(B,$){var q=B.length;B.push($);t:for(;0<q;){var Mt=q-1>>>1,Ct=B[Mt];if(0<l(Ct,$))B[Mt]=$,B[q]=Ct,q=Mt;else break t}}function i(B){return B.length===0?null:B[0]}function s(B){if(B.length===0)return null;var $=B[0],q=B.pop();if(q!==$){B[0]=q;t:for(var Mt=0,Ct=B.length,P=Ct>>>1;Mt<P;){var nt=2*(Mt+1)-1,Et=B[nt],rt=nt+1,Rt=B[rt];if(0>l(Et,q))rt<Ct&&0>l(Rt,Et)?(B[Mt]=Rt,B[rt]=q,Mt=rt):(B[Mt]=Et,B[nt]=q,Mt=nt);else if(rt<Ct&&0>l(Rt,q))B[Mt]=Rt,B[rt]=q,Mt=rt;else break t}}return $}function l(B,$){var q=B.sortIndex-$.sortIndex;return q!==0?q:B.id-$.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var h=Date,d=h.now();r.unstable_now=function(){return h.now()-d}}var m=[],p=[],v=1,g=null,x=3,S=!1,E=!1,b=!1,M=!1,_=typeof setTimeout=="function"?setTimeout:null,F=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;function D(B){for(var $=i(p);$!==null;){if($.callback===null)s(p);else if($.startTime<=B)s(p),$.sortIndex=$.expirationTime,t(m,$);else break;$=i(p)}}function G(B){if(b=!1,D(B),!E)if(i(m)!==null)E=!0,N||(N=!0,J());else{var $=i(p);$!==null&&dt(G,$.startTime-B)}}var N=!1,I=-1,W=5,U=-1;function w(){return M?!0:!(r.unstable_now()-U<W)}function V(){if(M=!1,N){var B=r.unstable_now();U=B;var $=!0;try{t:{E=!1,b&&(b=!1,F(I),I=-1),S=!0;var q=x;try{e:{for(D(B),g=i(m);g!==null&&!(g.expirationTime>B&&w());){var Mt=g.callback;if(typeof Mt=="function"){g.callback=null,x=g.priorityLevel;var Ct=Mt(g.expirationTime<=B);if(B=r.unstable_now(),typeof Ct=="function"){g.callback=Ct,D(B),$=!0;break e}g===i(m)&&s(m),D(B)}else s(m);g=i(m)}if(g!==null)$=!0;else{var P=i(p);P!==null&&dt(G,P.startTime-B),$=!1}}break t}finally{g=null,x=q,S=!1}$=void 0}}finally{$?J():N=!1}}}var J;if(typeof L=="function")J=function(){L(V)};else if(typeof MessageChannel<"u"){var lt=new MessageChannel,ht=lt.port2;lt.port1.onmessage=V,J=function(){ht.postMessage(null)}}else J=function(){_(V,0)};function dt(B,$){I=_(function(){B(r.unstable_now())},$)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(B){B.callback=null},r.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<B?Math.floor(1e3/B):5},r.unstable_getCurrentPriorityLevel=function(){return x},r.unstable_next=function(B){switch(x){case 1:case 2:case 3:var $=3;break;default:$=x}var q=x;x=$;try{return B()}finally{x=q}},r.unstable_requestPaint=function(){M=!0},r.unstable_runWithPriority=function(B,$){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var q=x;x=B;try{return $()}finally{x=q}},r.unstable_scheduleCallback=function(B,$,q){var Mt=r.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?Mt+q:Mt):q=Mt,B){case 1:var Ct=-1;break;case 2:Ct=250;break;case 5:Ct=1073741823;break;case 4:Ct=1e4;break;default:Ct=5e3}return Ct=q+Ct,B={id:v++,callback:$,priorityLevel:B,startTime:q,expirationTime:Ct,sortIndex:-1},q>Mt?(B.sortIndex=q,t(p,B),i(m)===null&&B===i(p)&&(b?(F(I),I=-1):b=!0,dt(G,q-Mt))):(B.sortIndex=Ct,t(m,B),E||S||(E=!0,N||(N=!0,J()))),B},r.unstable_shouldYield=w,r.unstable_wrapCallback=function(B){var $=x;return function(){var q=x;x=$;try{return B.apply(this,arguments)}finally{x=q}}}})(rh)),rh}var H_;function $y(){return H_||(H_=1,sh.exports=Jy()),sh.exports}var oh={exports:{}},Un={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var k_;function nS(){if(k_)return wo;k_=1;var r=$y(),t=Id(),i=eS();function s(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function c(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function h(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function d(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function m(e){if(c(e)!==e)throw Error(s(188))}function p(e){var n=e.alternate;if(!n){if(n=c(e),n===null)throw Error(s(188));return n!==e?null:e}for(var a=e,o=n;;){var u=a.return;if(u===null)break;var f=u.alternate;if(f===null){if(o=u.return,o!==null){a=o;continue}break}if(u.child===f.child){for(f=u.child;f;){if(f===a)return m(u),e;if(f===o)return m(u),n;f=f.sibling}throw Error(s(188))}if(a.return!==o.return)a=u,o=f;else{for(var y=!1,A=u.child;A;){if(A===a){y=!0,a=u,o=f;break}if(A===o){y=!0,o=u,a=f;break}A=A.sibling}if(!y){for(A=f.child;A;){if(A===a){y=!0,a=f,o=u;break}if(A===o){y=!0,o=f,a=u;break}A=A.sibling}if(!y)throw Error(s(189))}}if(a.alternate!==o)throw Error(s(190))}if(a.tag!==3)throw Error(s(188));return a.stateNode.current===a?e:n}function v(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=v(e),n!==null)return n;e=e.sibling}return null}var g=Object.assign,x=Symbol.for("react.element"),S=Symbol.for("react.transitional.element"),E=Symbol.for("react.portal"),b=Symbol.for("react.fragment"),M=Symbol.for("react.strict_mode"),_=Symbol.for("react.profiler"),F=Symbol.for("react.consumer"),L=Symbol.for("react.context"),D=Symbol.for("react.forward_ref"),G=Symbol.for("react.suspense"),N=Symbol.for("react.suspense_list"),I=Symbol.for("react.memo"),W=Symbol.for("react.lazy"),U=Symbol.for("react.activity"),w=Symbol.for("react.memo_cache_sentinel"),V=Symbol.iterator;function J(e){return e===null||typeof e!="object"?null:(e=V&&e[V]||e["@@iterator"],typeof e=="function"?e:null)}var lt=Symbol.for("react.client.reference");function ht(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===lt?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case b:return"Fragment";case _:return"Profiler";case M:return"StrictMode";case G:return"Suspense";case N:return"SuspenseList";case U:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case E:return"Portal";case L:return e.displayName||"Context";case F:return(e._context.displayName||"Context")+".Consumer";case D:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case I:return n=e.displayName||null,n!==null?n:ht(e.type)||"Memo";case W:n=e._payload,e=e._init;try{return ht(e(n))}catch{}}return null}var dt=Array.isArray,B=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,$=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,q={pending:!1,data:null,method:null,action:null},Mt=[],Ct=-1;function P(e){return{current:e}}function nt(e){0>Ct||(e.current=Mt[Ct],Mt[Ct]=null,Ct--)}function Et(e,n){Ct++,Mt[Ct]=e.current,e.current=n}var rt=P(null),Rt=P(null),Y=P(null),ut=P(null);function Ut(e,n){switch(Et(Y,n),Et(Rt,e),Et(rt,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?a_(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=a_(n),e=s_(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}nt(rt),Et(rt,e)}function Pt(){nt(rt),nt(Rt),nt(Y)}function zt(e){e.memoizedState!==null&&Et(ut,e);var n=rt.current,a=s_(n,e.type);n!==a&&(Et(Rt,e),Et(rt,a))}function Ft(e){Rt.current===e&&(nt(rt),nt(Rt)),ut.current===e&&(nt(ut),To._currentValue=q)}var re,z;function oe(e){if(re===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);re=n&&n[1]||"",z=-1<a.stack.indexOf(`
    at`)?" (<anonymous>)":-1<a.stack.indexOf("@")?"@unknown:0:0":""}return`
`+re+e+z}var ee=!1;function qt(e,n){if(!e||ee)return"";ee=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var o={DetermineComponentFrameRoot:function(){try{if(n){var xt=function(){throw Error()};if(Object.defineProperty(xt.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(xt,[])}catch(ft){var st=ft}Reflect.construct(e,[],xt)}else{try{xt.call()}catch(ft){st=ft}e.call(xt.prototype)}}else{try{throw Error()}catch(ft){st=ft}(xt=e())&&typeof xt.catch=="function"&&xt.catch(function(){})}}catch(ft){if(ft&&st&&typeof ft.stack=="string")return[ft.stack,st.stack]}return[null,null]}};o.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var u=Object.getOwnPropertyDescriptor(o.DetermineComponentFrameRoot,"name");u&&u.configurable&&Object.defineProperty(o.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var f=o.DetermineComponentFrameRoot(),y=f[0],A=f[1];if(y&&A){var H=y.split(`
`),at=A.split(`
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,ge={alphahash_fragment:eE,alphahash_pars_fragment:nE,alphamap_fragment:iE,alphamap_pars_fragment:aE,alphatest_fragment:sE,alphatest_pars_fragment:rE,aomap_fragment:oE,aomap_pars_fragment:lE,batching_pars_vertex:cE,batching_vertex:uE,begin_vertex:fE,beginnormal_vertex:hE,bsdfs:dE,iridescence_fragment:pE,bumpmap_pars_fragment:mE,clipping_planes_fragment:gE,clipping_planes_pars_fragment:_E,clipping_planes_pars_vertex:vE,clipping_planes_vertex:xE,color_fragment:yE,color_pars_fragment:SE,color_pars_vertex:ME,color_vertex:EE,common:TE,cube_uv_reflection_fragment:bE,defaultnormal_vertex:AE,displacementmap_pars_vertex:RE,displacementmap_vertex:CE,emissivemap_fragment:wE,emissivemap_pars_fragment:DE,colorspace_fragment:UE,colorspace_pars_fragment:LE,envmap_fragment:NE,envmap_common_pars_fragment:OE,envmap_pars_fragment:PE,envmap_pars_vertex:zE,envmap_physical_pars_fragment:qE,envmap_vertex:IE,fog_vertex:BE,fog_pars_vertex:FE,fog_fragment:HE,fog_pars_fragment:GE,gradientmap_pars_fragment:VE,lightmap_pars_fragment:kE,lights_lambert_fragment:jE,lights_lambert_pars_fragment:XE,lights_pars_begin:WE,lights_toon_fragment:YE,lights_toon_pars_fragment:ZE,lights_phong_fragment:KE,lights_phong_pars_fragment:QE,lights_physical_fragment:JE,lights_physical_pars_fragment:$E,lights_fragment_begin:tT,lights_fragment_maps:eT,lights_fragment_end:nT,logdepthbuf_fragment:iT,logdepthbuf_pars_fragment:aT,logdepthbuf_pars_vertex:sT,logdepthbuf_vertex:rT,map_fragment:oT,map_pars_fragment:lT,map_particle_fragment:cT,map_particle_pars_fragment:uT,metalnessmap_fragment:fT,metalnessmap_pars_fragment:hT,morphinstance_vertex:dT,morphcolor_vertex:pT,morphnormal_vertex:mT,morphtarget_pars_vertex:gT,morphtarget_vertex:_T,normal_fragment_begin:vT,normal_fragment_maps:xT,normal_pars_fragment:yT,normal_pars_vertex:ST,normal_vertex:MT,normalmap_pars_fragment:ET,clearcoat_normal_fragment_begin:TT,clearcoat_normal_fragment_maps:bT,clearcoat_pars_fragment:AT,iridescence_pars_fragment:RT,opaque_fragment:CT,packing:wT,premultiplied_alpha_fragment:DT,project_vertex:UT,dithering_fragment:LT,dithering_pars_fragment:NT,roughnessmap_fragment:OT,roughnessmap_pars_fragment:PT,shadowmap_pars_fragment:zT,shadowmap_pars_vertex:IT,shadowmap_vertex:BT,shadowmask_pars_fragment:FT,skinbase_vertex:HT,skinning_pars_vertex:GT,skinning_vertex:VT,skinnormal_vertex:kT,specularmap_fragment:jT,specularmap_pars_fragment:XT,tonemapping_fragment:WT,tonemapping_pars_fragment:qT,transmission_fragment:YT,transmission_pars_fragment:ZT,uv_pars_fragment:KT,uv_pars_vertex:QT,uv_vertex:JT,worldpos_vertex:$T,background_vert:t1,background_frag:e1,backgroundCube_vert:n1,backgroundCube_frag:i1,cube_vert:a1,cube_frag:s1,depth_vert:r1,depth_frag:o1,distanceRGBA_vert:l1,distanceRGBA_frag:c1,equirect_vert:u1,equirect_frag:f1,linedashed_vert:h1,linedashed_frag:d1,meshbasic_vert:p1,meshbasic_frag:m1,meshlambert_vert:g1,meshlambert_frag:_1,meshmatcap_vert:v1,meshmatcap_frag:x1,meshnormal_vert:y1,meshnormal_frag:S1,meshphong_vert:M1,meshphong_frag:E1,meshphysical_vert:T1,meshphysical_frag:b1,meshtoon_vert:A1,meshtoon_frag:R1,points_vert:C1,points_frag:w1,shadow_vert:D1,shadow_frag:U1,sprite_vert:L1,sprite_frag:N1},Bt={common:{diffuse:{value:new _e(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new me},alphaMap:{value:null},alphaMapTransform:{value:new me},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new me}},envmap:{envMap:{value:null},envMapRotation:{value:new me},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new me}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new me}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new me},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new me},normalScale:{value:new fe(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new me},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new me}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new me}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new me}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new _e(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new _e(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new me},alphaTest:{value:0},uvTransform:{value:new me}},sprite:{diffuse:{value:new _e(16777215)},opacity:{value:1},center:{value:new fe(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new me},alphaMap:{value:null},alphaMapTransform:{value:new me},alphaTest:{value:0}}},Pi={basic:{uniforms:In([Bt.common,Bt.specularmap,Bt.envmap,Bt.aomap,Bt.lightmap,Bt.fog]),vertexShader:ge.meshbasic_vert,fragmentShader:ge.meshbasic_frag},lambert:{uniforms:In([Bt.common,Bt.specularmap,Bt.envmap,Bt.aomap,Bt.lightmap,Bt.emissivemap,Bt.bumpmap,Bt.normalmap,Bt.displacementmap,Bt.fog,Bt.lights,{emissive:{value:new _e(0)}}]),vertexShader:ge.meshlambert_vert,fragmentShader:ge.meshlambert_frag},phong:{uniforms:In([Bt.common,Bt.specularmap,Bt.envmap,Bt.aomap,Bt.lightmap,Bt.emissivemap,Bt.bumpmap,Bt.normalmap,Bt.displacementmap,Bt.fog,Bt.lights,{emissive:{value:new _e(0)},specular:{value:new _e(1118481)},shininess:{value:30}}]),vertexShader:ge.meshphong_vert,fragmentShader:ge.meshphong_frag},standard:{uniforms:In([Bt.common,Bt.envmap,Bt.aomap,Bt.lightmap,Bt.emissivemap,Bt.bumpmap,Bt.normalmap,Bt.displacementmap,Bt.roughnessmap,Bt.metalnessmap,Bt.fog,Bt.lights,{emissive:{value:new _e(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:ge.meshphysical_vert,fragmentShader:ge.meshphysical_frag},toon:{uniforms:In([Bt.common,Bt.aomap,Bt.lightmap,Bt.emissivemap,Bt.bumpmap,Bt.normalmap,Bt.displacementmap,Bt.gradientmap,Bt.fog,Bt.lights,{emissive:{value:new _e(0)}}]),vertexShader:ge.meshtoon_vert,fragmentShader:ge.meshtoon_frag},matcap:{uniforms:In([Bt.common,Bt.bumpmap,Bt.normalmap,Bt.displacementmap,Bt.fog,{matcap:{value:null}}]),vertexShader:ge.meshmatcap_vert,fragmentShader:ge.meshmatcap_frag},points:{uniforms:In([Bt.points,Bt.fog]),vertexShader:ge.points_vert,fragmentShader:ge.points_frag},dashed:{uniforms:In([Bt.common,Bt.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:ge.linedashed_vert,fragmentShader:ge.linedashed_frag},depth:{uniforms:In([Bt.common,Bt.displacementmap]),vertexShader:ge.depth_vert,fragmentShader:ge.depth_frag},normal:{uniforms:In([Bt.common,Bt.bumpmap,Bt.normalmap,Bt.displacementmap,{opacity:{value:1}}]),vertexShader:ge.meshnormal_vert,fragmentShader:ge.meshnormal_frag},sprite:{uniforms:In([Bt.sprite,Bt.fog]),vertexShader:ge.sprite_vert,fragmentShader:ge.sprite_frag},background:{uniforms:{uvTransform:{value:new me},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:ge.background_vert,fragmentShader:ge.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new me}},vertexShader:ge.backgroundCube_vert,fragmentShader:ge.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:ge.cube_vert,fragmentShader:ge.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:ge.equirect_vert,fragmentShader:ge.equirect_frag},distanceRGBA:{uniforms:In([Bt.common,Bt.displacementmap,{referencePosition:{value:new tt},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:ge.distanceRGBA_vert,fragmentShader:ge.distanceRGBA_frag},shadow:{uniforms:In([Bt.lights,Bt.fog,{color:{value:new _e(0)},opacity:{value:1}}]),vertexShader:ge.shadow_vert,fragmentShader:ge.shadow_frag}};Pi.physical={uniforms:In([Pi.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new me},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new me},clearcoatNormalScale:{value:new fe(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new me},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new me},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new me},sheen:{value:0},sheenColor:{value:new _e(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new me},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new me},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new me},transmissionSamplerSize:{value:new fe},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new me},attenuationDistance:{value:0},attenuationColor:{value:new _e(0)},specularColor:{value:new _e(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new me},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new me},anisotropyVector:{value:new fe},anisotropyMap:{value:null},anisotropyMapTransform:{value:new me}}]),vertexShader:ge.meshphysical_vert,fragmentShader:ge.meshphysical_frag};const Cc={r:0,b:0,g:0},_s=new Fi,O1=new sn;function P1(r,t,i,s,l,c,h){const d=new _e(0);let m=c===!0?0:1,p,v,g=null,x=0,S=null;function E(L){let D=L.isScene===!0?L.background:null;return D&&D.isTexture&&(D=(L.backgroundBlurriness>0?i:t).get(D)),D}function b(L){let D=!1;const G=E(L);G===null?_(d,m):G&&G.isColor&&(_(G,1),D=!0);const N=r.xr.getEnvironmentBlendMode();N==="additive"?s.buffers.color.setClear(0,0,0,1,h):N==="alpha-blend"&&s.buffers.color.setClear(0,0,0,0,h),(r.autoClear||D)&&(s.buffers.depth.setTest(!0),s.buffers.depth.setMask(!0),s.buffers.color.setMask(!0),r.clear(r.autoClearColor,r.autoClearDepth,r.autoClearStencil))}function M(L,D){const G=E(D);G&&(G.isCubeTexture||G.mapping===Xc)?(v===void 0&&(v=new Bn(new Yo(1,1,1),new qa({name:"BackgroundCubeMaterial",uniforms:Nr(Pi.backgroundCube.uniforms),vertexShader:Pi.backgroundCube.vertexShader,fragmentShader:Pi.backgroundCube.fragmentShader,side:Yn,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),v.geometry.deleteAttribute("normal"),v.geometry.deleteAttribute("uv"),v.onBeforeRender=function(N,I,W){this.matrixWorld.copyPosition(W.matrixWorld)},Object.defineProperty(v.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),l.update(v)),_s.copy(D.backgroundRotation),_s.x*=-1,_s.y*=-1,_s.z*=-1,G.isCubeTexture&&G.isRenderTargetTexture===!1&&(_s.y*=-1,_s.z*=-1),v.material.uniforms.envMap.value=G,v.material.uniforms.flipEnvMap.value=G.isCubeTexture&&G.isRenderTargetTexture===!1?-1:1,v.material.uniforms.backgroundBlurriness.value=D.backgroundBlurriness,v.material.uniforms.backgroundIntensity.value=D.backgroundIntensity,v.material.uniforms.backgroundRotation.value.setFromMatrix4(O1.makeRotationFromEuler(_s)),v.material.toneMapped=Le.getTransfer(G.colorSpace)!==Ve,(g!==G||x!==G.version||S!==r.toneMapping)&&(v.material.needsUpdate=!0,g=G,x=G.version,S=r.toneMapping),v.layers.enableAll(),L.unshift(v,v.geometry,v.material,0,0,null)):G&&G.isTexture&&(p===void 0&&(p=new Bn(new qc(2,2),new qa({name:"BackgroundMaterial",uniforms:Nr(Pi.background.uniforms),vertexShader:Pi.background.vertexShader,fragmentShader:Pi.background.fragmentShader,side:Wa,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),p.geometry.deleteAttribute("normal"),Object.defineProperty(p.material,"map",{get:function(){return this.uniforms.t2D.value}}),l.update(p)),p.material.uniforms.t2D.value=G,p.material.uniforms.backgroundIntensity.value=D.backgroundIntensity,p.material.toneMapped=Le.getTransfer(G.colorSpace)!==Ve,G.matrixAutoUpdate===!0&&G.updateMatrix(),p.material.uniforms.uvTransform.value.copy(G.matrix),(g!==G||x!==G.version||S!==r.toneMapping)&&(p.material.needsUpdate=!0,g=G,x=G.version,S=r.toneMapping),p.layers.enableAll(),L.unshift(p,p.geometry,p.material,0,0,null))}function _(L,D){L.getRGB(Cc,Rv(r)),s.buffers.color.setClear(Cc.r,Cc.g,Cc.b,D,h)}function F(){v!==void 0&&(v.geometry.dispose(),v.material.dispose(),v=void 0),p!==void 0&&(p.geometry.dispose(),p.material.dispose(),p=void 0)}return{getClearColor:function(){return d},setClearColor:function(L,D=1){d.set(L),m=D,_(d,m)},getClearAlpha:function(){return m},setClearAlpha:function(L){m=L,_(d,m)},render:b,addToRenderList:M,dispose:F}}function z1(r,t){const i=r.getParameter(r.MAX_VERTEX_ATTRIBS),s={},l=x(null);let c=l,h=!1;function d(w,V,J,lt,ht){let dt=!1;const B=g(lt,J,V);c!==B&&(c=B,p(c.object)),dt=S(w,lt,J,ht),dt&&E(w,lt,J,ht),ht!==null&&t.update(ht,r.ELEMENT_ARRAY_BUFFER),(dt||h)&&(h=!1,D(w,V,J,lt),ht!==null&&r.bindBuffer(r.ELEMENT_ARRAY_BUFFER,t.get(ht).buffer))}function m(){return r.createVertexArray()}function p(w){return r.bindVertexArray(w)}function v(w){return r.deleteVertexArray(w)}function g(w,V,J){const lt=J.wireframe===!0;let ht=s[w.id];ht===void 0&&(ht={},s[w.id]=ht);let dt=ht[V.id];dt===void 0&&(dt={},ht[V.id]=dt);let B=dt[lt];return B===void 0&&(B=x(m()),dt[lt]=B),B}function x(w){const V=[],J=[],lt=[];for(let ht=0;ht<i;ht++)V[ht]=0,J[ht]=0,lt[ht]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:V,enabledAttributes:J,attributeDivisors:lt,object:w,attributes:{},index:null}}function S(w,V,J,lt){const ht=c.attributes,dt=V.attributes;let B=0;const $=J.getAttributes();for(const q in $)if($[q].location>=0){const Ct=ht[q];let P=dt[q];if(P===void 0&&(q==="instanceMatrix"&&w.instanceMatrix&&(P=w.instanceMatrix),q==="instanceColor"&&w.instanceColor&&(P=w.instanceColor)),Ct===void 0||Ct.attribute!==P||P&&Ct.data!==P.data)return!0;B++}return c.attributesNum!==B||c.index!==lt}function E(w,V,J,lt){const ht={},dt=V.attributes;let B=0;const $=J.getAttributes();for(const q in $)if($[q].location>=0){let Ct=dt[q];Ct===void 0&&(q==="instanceMatrix"&&w.instanceMatrix&&(Ct=w.instanceMatrix),q==="instanceColor"&&w.instanceColor&&(Ct=w.instanceColor));const P={};P.attribute=Ct,Ct&&Ct.data&&(P.data=Ct.data),ht[q]=P,B++}c.attributes=ht,c.attributesNum=B,c.index=lt}function b(){const w=c.newAttributes;for(let V=0,J=w.length;V<J;V++)w[V]=0}function M(w){_(w,0)}function _(w,V){const J=c.newAttributes,lt=c.enabledAttributes,ht=c.attributeDivisors;J[w]=1,lt[w]===0&&(r.enableVertexAttribArray(w),lt[w]=1),ht[w]!==V&&(r.vertexAttribDivisor(w,V),ht[w]=V)}function F(){const w=c.newAttributes,V=c.enabledAttributes;for(let J=0,lt=V.length;J<lt;J++)V[J]!==w[J]&&(r.disableVertexAttribArray(J),V[J]=0)}function L(w,V,J,lt,ht,dt,B){B===!0?r.vertexAttribIPointer(w,V,J,ht,dt):r.vertexAttribPointer(w,V,J,lt,ht,dt)}function D(w,V,J,lt){b();const ht=lt.attributes,dt=J.getAttributes(),B=V.defaultAttributeValues;for(const $ in dt){const q=dt[$];if(q.location>=0){let Mt=ht[$];if(Mt===void 0&&($==="instanceMatrix"&&w.instanceMatrix&&(Mt=w.instanceMatrix),$==="instanceColor"&&w.instanceColor&&(Mt=w.instanceColor)),Mt!==void 0){const Ct=Mt.normalized,P=Mt.itemSize,nt=t.get(Mt);if(nt===void 0)continue;const Et=nt.buffer,rt=nt.type,Rt=nt.bytesPerElement,Y=rt===r.INT||rt===r.UNSIGNED_INT||Mt.gpuType===Fd;if(Mt.isInterleavedBufferAttribute){const ut=Mt.data,Ut=ut.stride,Pt=Mt.offset;if(ut.isInstancedInterleavedBuffer){for(let zt=0;zt<q.locationSize;zt++)_(q.location+zt,ut.meshPerAttribute);w.isInstancedMesh!==!0&&lt._maxInstanceCount===void 0&&(lt._maxInstanceCount=ut.meshPerAttribute*ut.count)}else for(let zt=0;zt<q.locationSize;zt++)M(q.location+zt);r.bindBuffer(r.ARRAY_BUFFER,Et);for(let zt=0;zt<q.locationSize;zt++)L(q.location+zt,P/q.locationSize,rt,Ct,Ut*Rt,(Pt+P/q.locationSize*zt)*Rt,Y)}else{if(Mt.isInstancedBufferAttribute){for(let ut=0;ut<q.locationSize;ut++)_(q.location+ut,Mt.meshPerAttribute);w.isInstancedMesh!==!0&&lt._maxInstanceCount===void 0&&(lt._maxInstanceCount=Mt.meshPerAttribute*Mt.count)}else for(let ut=0;ut<q.locationSize;ut++)M(q.location+ut);r.bindBuffer(r.ARRAY_BUFFER,Et);for(let ut=0;ut<q.locationSize;ut++)L(q.location+ut,P/q.locationSize,rt,Ct,P*Rt,P/q.locationSize*ut*Rt,Y)}}else if(B!==void 0){const Ct=B[$];if(Ct!==void 0)switch(Ct.length){case 2:r.vertexAttrib2fv(q.location,Ct);break;case 3:r.vertexAttrib3fv(q.location,Ct);break;case 4:r.vertexAttrib4fv(q.location,Ct);break;default:r.vertexAttrib1fv(q.location,Ct)}}}}F()}function G(){W();for(const w in s){const V=s[w];for(const J in V){const lt=V[J];for(const ht in lt)v(lt[ht].object),delete lt[ht];delete V[J]}delete s[w]}}function N(w){if(s[w.id]===void 0)return;const V=s[w.id];for(const J in V){const lt=V[J];for(const ht in lt)v(lt[ht].object),delete lt[ht];delete V[J]}delete s[w.id]}function I(w){for(const V in s){const J=s[V];if(J[w.id]===void 0)continue;const lt=J[w.id];for(const ht in lt)v(lt[ht].object),delete lt[ht];delete J[w.id]}}function W(){U(),h=!0,c!==l&&(c=l,p(c.object))}function U(){l.geometry=null,l.program=null,l.wireframe=!1}return{setup:d,reset:W,resetDefaultState:U,dispose:G,releaseStatesOfGeometry:N,releaseStatesOfProgram:I,initAttributes:b,enableAttribute:M,disableUnusedAttributes:F}}function I1(r,t,i){let s;function l(p){s=p}function c(p,v){r.drawArrays(s,p,v),i.update(v,s,1)}function h(p,v,g){g!==0&&(r.drawArraysInstanced(s,p,v,g),i.update(v,s,g))}function d(p,v,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawArraysWEBGL(s,p,0,v,0,g);let S=0;for(let E=0;E<g;E++)S+=v[E];i.update(S,s,1)}function m(p,v,g,x){if(g===0)return;const S=t.get("WEBGL_multi_draw");if(S===null)for(let E=0;E<p.length;E++)h(p[E],v[E],x[E]);else{S.multiDrawArraysInstancedWEBGL(s,p,0,v,0,x,0,g);let E=0;for(let b=0;b<g;b++)E+=v[b]*x[b];i.update(E,s,1)}}this.setMode=l,this.render=c,this.renderInstances=h,this.renderMultiDraw=d,this.renderMultiDrawInstances=m}function B1(r,t,i,s){let l;function c(){if(l!==void 0)return l;if(t.has("EXT_texture_filter_anisotropic")===!0){const I=t.get("EXT_texture_filter_anisotropic");l=r.getParameter(I.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else l=0;return l}function h(I){return!(I!==Ri&&s.convert(I)!==r.getParameter(r.IMPLEMENTATION_COLOR_READ_FORMAT))}function d(I){const W=I===Xo&&(t.has("EXT_color_buffer_half_float")||t.has("EXT_color_buffer_float"));return!(I!==Bi&&s.convert(I)!==r.getParameter(r.IMPLEMENTATION_COLOR_READ_TYPE)&&I!==ua&&!W)}function m(I){if(I==="highp"){if(r.getShaderPrecisionFormat(r.VERTEX_SHADER,r.HIGH_FLOAT).precision>0&&r.getShaderPrecisionFormat(r.FRAGMENT_SHADER,r.HIGH_FLOAT).precision>0)return"highp";I="mediump"}return I==="mediump"&&r.getShaderPrecisionFormat(r.VERTEX_SHADER,r.MEDIUM_FLOAT).precision>0&&r.getShaderPrecisionFormat(r.FRAGMENT_SHADER,r.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let p=i.precision!==void 0?i.precision:"highp";const v=m(p);v!==p&&(console.warn("THREE.WebGLRenderer:",p,"not supported, using",v,"instead."),p=v);const g=i.logarithmicDepthBuffer===!0,x=i.reversedDepthBuffer===!0&&t.has("EXT_clip_control"),S=r.getParameter(r.MAX_TEXTURE_IMAGE_UNITS),E=r.getParameter(r.MAX_VERTEX_TEXTURE_IMAGE_UNITS),b=r.getParameter(r.MAX_TEXTURE_SIZE),M=r.getParameter(r.MAX_CUBE_MAP_TEXTURE_SIZE),_=r.getParameter(r.MAX_VERTEX_ATTRIBS),F=r.getParameter(r.MAX_VERTEX_UNIFORM_VECTORS),L=r.getParameter(r.MAX_VARYING_VECTORS),D=r.getParameter(r.MAX_FRAGMENT_UNIFORM_VECTORS),G=E>0,N=r.getParameter(r.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:c,getMaxPrecision:m,textureFormatReadable:h,textureTypeReadable:d,precision:p,logarithmicDepthBuffer:g,reversedDepthBuffer:x,maxTextures:S,maxVertexTextures:E,maxTextureSize:b,maxCubemapSize:M,maxAttributes:_,maxVertexUniforms:F,maxVaryings:L,maxFragmentUniforms:D,vertexTextures:G,maxSamples:N}}function F1(r){const t=this;let i=null,s=0,l=!1,c=!1;const h=new Va,d=new me,m={value:null,needsUpdate:!1};this.uniform=m,this.numPlanes=0,this.numIntersection=0,this.init=function(g,x){const S=g.length!==0||x||s!==0||l;return l=x,s=g.length,S},this.beginShadows=function(){c=!0,v(null)},this.endShadows=function(){c=!1},this.setGlobalState=function(g,x){i=v(g,x,0)},this.setState=function(g,x,S){const E=g.clippingPlanes,b=g.clipIntersection,M=g.clipShadows,_=r.get(g);if(!l||E===null||E.length===0||c&&!M)c?v(null):p();else{const F=c?0:s,L=F*4;let D=_.clippingState||null;m.value=D,D=v(E,x,L,S);for(let G=0;G!==L;++G)D[G]=i[G];_.clippingState=D,this.numIntersection=b?this.numPlanes:0,this.numPlanes+=F}};function p(){m.value!==i&&(m.value=i,m.needsUpdate=s>0),t.numPlanes=s,t.numIntersection=0}function v(g,x,S,E){const b=g!==null?g.length:0;let M=null;if(b!==0){if(M=m.value,E!==!0||M===null){const _=S+b*4,F=x.matrixWorldInverse;d.getNormalMatrix(F),(M===null||M.length<_)&&(M=new Float32Array(_));for(let L=0,D=S;L!==b;++L,D+=4)h.copy(g[L]).applyMatrix4(F,d),h.normal.toArray(M,D),M[D+3]=h.constant}m.value=M,m.needsUpdate=!0}return t.numPlanes=b,t.numIntersection=0,M}}function H1(r){let t=new WeakMap;function i(h,d){return d===nd?h.mapping=Dr:d===id&&(h.mapping=Ur),h}function s(h){if(h&&h.isTexture){const d=h.mapping;if(d===nd||d===id)if(t.has(h)){const m=t.get(h).texture;return i(m,h.mapping)}else{const m=h.image;if(m&&m.height>0){const p=new IM(m.height);return p.fromEquirectangularTexture(r,h),t.set(h,p),h.addEventListener("dispose",l),i(p.texture,h.mapping)}else return null}}return h}function l(h){const d=h.target;d.removeEventListener("dispose",l);const m=t.get(d);m!==void 0&&(t.delete(d),m.dispose())}function c(){t=new WeakMap}return{get:s,dispose:c}}const br=4,C0=[.125,.215,.35,.446,.526,.582],Ss=20,Ih=new Ov,w0=new _e;let Bh=null,Fh=0,Hh=0,Gh=!1;const xs=(1+Math.sqrt(5))/2,Er=1/xs,D0=[new tt(-xs,Er,0),new tt(xs,Er,0),new tt(-Er,0,xs),new tt(Er,0,xs),new tt(0,xs,-Er),new tt(0,xs,Er),new tt(-1,1,-1),new tt(1,1,-1),new tt(-1,1,1),new tt(1,1,1)],G1=new tt;class U0{constructor(t){this._renderer=t,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._lodPlanes=[],this._sizeLods=[],this._sigmas=[],this._blurMaterial=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._compileMaterial(this._blurMaterial)}fromScene(t,i=0,s=.1,l=100,c={}){const{size:h=256,position:d=G1}=c;Bh=this._renderer.getRenderTarget(),Fh=this._renderer.getActiveCubeFace(),Hh=this._renderer.getActiveMipmapLevel(),Gh=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(h);const m=this._allocateTargets();return m.depthBuffer=!0,this._sceneToCubeUV(t,s,l,m,d),i>0&&this._blur(m,0,0,i),this._applyPMREM(m),this._cleanup(m),m}fromEquirectangular(t,i=null){return this._fromTexture(t,i)}fromCubemap(t,i=null){return this._fromTexture(t,i)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=O0(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=N0(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose()}_setSize(t){this._lodMax=Math.floor(Math.log2(t)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let t=0;t<this._lodPlanes.length;t++)this._lodPlanes[t].dispose()}_cleanup(t){this._renderer.setRenderTarget(Bh,Fh,Hh),this._renderer.xr.enabled=Gh,t.scissorTest=!1,wc(t,0,0,t.width,t.height)}_fromTexture(t,i){t.mapping===Dr||t.mapping===Ur?this._setSize(t.image.length===0?16:t.image[0].width||t.image[0].image.width):this._setSize(t.image.width/4),Bh=this._renderer.getRenderTarget(),Fh=this._renderer.getActiveCubeFace(),Hh=this._renderer.getActiveMipmapLevel(),Gh=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const s=i||this._allocateTargets();return this._textureToCubeUV(t,s),this._applyPMREM(s),this._cleanup(s),s}_allocateTargets(){const t=3*Math.max(this._cubeSize,112),i=4*this._cubeSize,s={magFilter:zi,minFilter:zi,generateMipmaps:!1,type:Xo,format:Ri,colorSpace:Lr,depthBuffer:!1},l=L0(t,i,s);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==t||this._pingPongRenderTarget.height!==i){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=L0(t,i,s);const{_lodMax:c}=this;({sizeLods:this._sizeLods,lodPlanes:this._lodPlanes,sigmas:this._sigmas}=V1(c)),this._blurMaterial=k1(c,t,i)}return l}_compileMaterial(t){const i=new Bn(this._lodPlanes[0],t);this._renderer.compile(i,Ih)}_sceneToCubeUV(t,i,s,l,c){const m=new _i(90,1,i,s),p=[1,-1,1,1,1,1],v=[1,1,1,-1,-1,-1],g=this._renderer,x=g.autoClear,S=g.toneMapping;g.getClearColor(w0),g.toneMapping=Xa,g.autoClear=!1,g.state.buffers.depth.getReversed()&&(g.setRenderTarget(l),g.clearDepth(),g.setRenderTarget(null));const b=new Fo({name:"PMREM.Background",side:Yn,depthWrite:!1,depthTest:!1}),M=new Bn(new Yo,b);let _=!1;const F=t.background;F?F.isColor&&(b.color.copy(F),t.background=null,_=!0):(b.color.copy(w0),_=!0);for(let L=0;L<6;L++){const D=L%3;D===0?(m.up.set(0,p[L],0),m.position.set(c.x,c.y,c.z),m.lookAt(c.x+v[L],c.y,c.z)):D===1?(m.up.set(0,0,p[L]),m.position.set(c.x,c.y,c.z),m.lookAt(c.x,c.y+v[L],c.z)):(m.up.set(0,p[L],0),m.position.set(c.x,c.y,c.z),m.lookAt(c.x,c.y,c.z+v[L]));const G=this._cubeSize;wc(l,D*G,L>2?G:0,G,G),g.setRenderTarget(l),_&&g.render(M,m),g.render(t,m)}M.geometry.dispose(),M.material.dispose(),g.toneMapping=S,g.autoClear=x,t.background=F}_textureToCubeUV(t,i){const s=this._renderer,l=t.mapping===Dr||t.mapping===Ur;l?(this._cubemapMaterial===null&&(this._cubemapMaterial=O0()),this._cubemapMaterial.uniforms.flipEnvMap.value=t.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=N0());const c=l?this._cubemapMaterial:this._equirectMaterial,h=new Bn(this._lodPlanes[0],c),d=c.uniforms;d.envMap.value=t;const m=this._cubeSize;wc(i,0,0,3*m,2*m),s.setRenderTarget(i),s.render(h,Ih)}_applyPMREM(t){const i=this._renderer,s=i.autoClear;i.autoClear=!1;const l=this._lodPlanes.length;for(let c=1;c<l;c++){const h=Math.sqrt(this._sigmas[c]*this._sigmas[c]-this._sigmas[c-1]*this._sigmas[c-1]),d=D0[(l-c-1)%D0.length];this._blur(t,c-1,c,h,d)}i.autoClear=s}_blur(t,i,s,l,c){const h=this._pingPongRenderTarget;this._halfBlur(t,h,i,s,l,"latitudinal",c),this._halfBlur(h,t,s,s,l,"longitudinal",c)}_halfBlur(t,i,s,l,c,h,d){const m=this._renderer,p=this._blurMaterial;h!=="latitudinal"&&h!=="longitudinal"&&console.error("blur direction must be either latitudinal or longitudinal!");const v=3,g=new Bn(this._lodPlanes[l],p),x=p.uniforms,S=this._sizeLods[s]-1,E=isFinite(c)?Math.PI/(2*S):2*Math.PI/(2*Ss-1),b=c/E,M=isFinite(c)?1+Math.floor(v*b):Ss;M>Ss&&console.warn(`sigmaRadians, ${c}, is too large and will clip, as it requested ${M} samples when the maximum is set to ${Ss}`);const _=[];let F=0;for(let I=0;I<Ss;++I){const W=I/b,U=Math.exp(-W*W/2);_.push(U),I===0?F+=U:I<M&&(F+=2*U)}for(let I=0;I<_.length;I++)_[I]=_[I]/F;x.envMap.value=t.texture,x.samples.value=M,x.weights.value=_,x.latitudinal.value=h==="latitudinal",d&&(x.poleAxis.value=d);const{_lodMax:L}=this;x.dTheta.value=E,x.mipInt.value=L-s;const D=this._sizeLods[l],G=3*D*(l>L-br?l-L+br:0),N=4*(this._cubeSize-D);wc(i,G,N,3*D,2*D),m.setRenderTarget(i),m.render(g,Ih)}}function V1(r){const t=[],i=[],s=[];let l=r;const c=r-br+1+C0.length;for(let h=0;h<c;h++){const d=Math.pow(2,l);i.push(d);let m=1/d;h>r-br?m=C0[h-r+br-1]:h===0&&(m=0),s.push(m);const p=1/(d-2),v=-p,g=1+p,x=[v,v,g,v,g,g,v,v,g,g,v,g],S=6,E=6,b=3,M=2,_=1,F=new Float32Array(b*E*S),L=new Float32Array(M*E*S),D=new Float32Array(_*E*S);for(let N=0;N<S;N++){const I=N%3*2/3-1,W=N>2?0:-1,U=[I,W,0,I+2/3,W,0,I+2/3,W+1,0,I,W,0,I+2/3,W+1,0,I,W+1,0];F.set(U,b*E*N),L.set(x,M*E*N);const w=[N,N,N,N,N,N];D.set(w,_*E*N)}const G=new Fn;G.setAttribute("position",new vi(F,b)),G.setAttribute("uv",new vi(L,M)),G.setAttribute("faceIndex",new vi(D,_)),t.push(G),l>br&&l--}return{lodPlanes:t,sizeLods:i,sigmas:s}}function L0(r,t,i){const s=new As(r,t,i);return s.texture.mapping=Xc,s.texture.name="PMREM.cubeUv",s.scissorTest=!0,s}function wc(r,t,i,s,l){r.viewport.set(t,i,s,l),r.scissor.set(t,i,s,l)}function k1(r,t,i){const s=new Float32Array(Ss),l=new tt(0,1,0);return new qa({name:"SphericalGaussianBlur",defines:{n:Ss,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:$d(),fragmentShader:`
	...
	`}function j1(r){let t=new WeakMap,i=null;function s(d){if(d&&d.isTexture){const m=d.mapping,p=m===nd||m===id,v=m===Dr||m===Ur;if(p||v){let g=t.get(d);const x=g!==void 0?g.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==x)return i===null&&(i=new U0(r)),g=p?i.fromEquirectangular(d,g):i.fromCubemap(d,g),g.texture.pmremVersion=d.pmremVersion,t.set(d,g),g.texture;if(g!==void 0)return g.texture;{const S=d.image;return p&&S&&S.height>0||v&&S&&l(S)?(i===null&&(i=new U0(r)),g=p?i.fromEquirectangular(d):i.fromCubemap(d),g.texture.pmremVersion=d.pmremVersion,t.set(d,g),d.addEventListener("dispose",c),g.texture):null}}}return d}function l(d){let m=0;const p=6;for(let v=0;v<p;v++)d[v]!==void 0&&m++;return m===p}function c(d){const m=d.target;m.removeEventListener("dispose",c);const p=t.get(m);p!==void 0&&(t.delete(m),p.dispose())}function h(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:h}}function X1(r){const t={};function i(s){if(t[s]!==void 0)return t[s];let l;switch(s){case"WEBGL_depth_texture":l=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":l=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":l=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":l=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:l=r.getExtension(s)}return t[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&jo("THREE.WebGLRenderer: "+s+" extension not supported."),l}}}function W1(r,t,i,s){const l={},c=new WeakMap;function h(g){const x=g.target;x.index!==null&&t.remove(x.index);for(const E in x.attributes)t.remove(x.attributes[E]);x.removeEventListener("dispose",h),delete l[x.id];const S=c.get(x);S&&(t.remove(S),c.delete(x)),s.releaseStatesOfGeometry(x),x.isInstancedBufferGeometry===!0&&delete x._maxInstanceCount,i.memory.geometries--}function d(g,x){return l[x.id]===!0||(x.addEventListener("dispose",h),l[x.id]=!0,i.memory.geometries++),x}function m(g){const x=g.attributes;for(const S in x)t.update(x[S],r.ARRAY_BUFFER)}function p(g){const x=[],S=g.index,E=g.attributes.position;let b=0;if(S!==null){const F=S.array;b=S.version;for(let L=0,D=F.length;L<D;L+=3){const G=F[L+0],N=F[L+1],I=F[L+2];x.push(G,N,N,I,I,G)}}else if(E!==void 0){const F=E.array;b=E.version;for(let L=0,D=F.length/3-1;L<D;L+=3){const G=L+0,N=L+1,I=L+2;x.push(G,N,N,I,I,G)}}else return;const M=new(Sv(x)?Av:bv)(x,1);M.version=b;const _=c.get(g);_&&t.remove(_),c.set(g,M)}function v(g){const x=c.get(g);if(x){const S=g.index;S!==null&&x.version<S.version&&p(g)}else p(g);return c.get(g)}return{get:d,update:m,getWireframeAttribute:v}}function q1(r,t,i){let s;function l(x){s=x}let c,h;function d(x){c=x.type,h=x.bytesPerElement}function m(x,S){r.drawElements(s,S,c,x*h),i.update(S,s,1)}function p(x,S,E){E!==0&&(r.drawElementsInstanced(s,S,c,x*h,E),i.update(S,s,E))}function v(x,S,E){if(E===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,S,0,c,x,0,E);let M=0;for(let _=0;_<E;_++)M+=S[_];i.update(M,s,1)}function g(x,S,E,b){if(E===0)return;const M=t.get("WEBGL_multi_draw");if(M===null)for(let _=0;_<x.length;_++)p(x[_]/h,S[_],b[_]);else{M.multiDrawElementsInstancedWEBGL(s,S,0,c,x,0,b,0,E);let _=0;for(let F=0;F<E;F++)_+=S[F]*b[F];i.update(_,s,1)}}this.setMode=l,this.setIndex=d,this.render=m,this.renderInstances=p,this.renderMultiDraw=v,this.renderMultiDrawInstances=g}function Y1(r){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,h,d){switch(i.calls++,h){case r.TRIANGLES:i.triangles+=d*(c/3);break;case r.LINES:i.lines+=d*(c/2);break;case r.LINE_STRIP:i.lines+=d*(c-1);break;case r.LINE_LOOP:i.lines+=d*c;break;case r.POINTS:i.points+=d*c;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",h);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:s}}function Z1(r,t,i){const s=new WeakMap,l=new an;function c(h,d,m){const p=h.morphTargetInfluences,v=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,g=v!==void 0?v.length:0;let x=s.get(d);if(x===void 0||x.count!==g){let U=function(){I.dispose(),s.delete(d),d.removeEventListener("dispose",U)};x!==void 0&&x.texture.dispose();const S=d.morphAttributes.position!==void 0,E=d.morphAttributes.normal!==void 0,b=d.morphAttributes.color!==void 0,M=d.morphAttributes.position||[],_=d.morphAttributes.normal||[],F=d.morphAttributes.color||[];let L=0;S===!0&&(L=1),E===!0&&(L=2),b===!0&&(L=3);let D=d.attributes.position.count*L,G=1;D>t.maxTextureSize&&(G=Math.ceil(D/t.maxTextureSize),D=t.maxTextureSize);const N=new Float32Array(D*G*4*g),I=new Mv(N,D,G,g);I.type=ua,I.needsUpdate=!0;const W=L*4;for(let w=0;w<g;w++){const V=M[w],J=_[w],lt=F[w],ht=D*G*4*w;for(let dt=0;dt<V.count;dt++){const B=dt*W;S===!0&&(l.fromBufferAttribute(V,dt),N[ht+B+0]=l.x,N[ht+B+1]=l.y,N[ht+B+2]=l.z,N[ht+B+3]=0),E===!0&&(l.fromBufferAttribute(J,dt),N[ht+B+4]=l.x,N[ht+B+5]=l.y,N[ht+B+6]=l.z,N[ht+B+7]=0),b===!0&&(l.fromBufferAttribute(lt,dt),N[ht+B+8]=l.x,N[ht+B+9]=l.y,N[ht+B+10]=l.z,N[ht+B+11]=lt.itemSize===4?l.w:1)}}x={count:g,texture:I,size:new fe(D,G)},s.set(d,x),d.addEventListener("dispose",U)}if(h.isInstancedMesh===!0&&h.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",h.morphTexture,i);else{let S=0;for(let b=0;b<p.length;b++)S+=p[b];const E=d.morphTargetsRelative?1:1-S;m.getUniforms().setValue(r,"morphTargetBaseInfluence",E),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",x.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",x.size)}return{update:c}}function K1(r,t,i,s){let l=new WeakMap;function c(m){const p=s.render.frame,v=m.geometry,g=t.get(m,v);if(l.get(g)!==p&&(t.update(g),l.set(g,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",d)===!1&&m.addEventListener("dispose",d),l.get(m)!==p&&(i.update(m.instanceMatrix,r.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,r.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const x=m.skeleton;l.get(x)!==p&&(x.update(),l.set(x,p))}return g}function h(){l=new WeakMap}function d(m){const p=m.target;p.removeEventListener("dispose",d),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:c,dispose:h}}const zv=new Zn,P0=new Uv(1,1),Iv=new Mv,Bv=new yM,Fv=new wv,z0=[],I0=[],B0=new Float32Array(16),F0=new Float32Array(9),H0=new Float32Array(4);function zr(r,t,i){const s=r[0];if(s<=0||s>0)return r;const l=t*i;let c=z0[l];if(c===void 0&&(c=new Float32Array(l),z0[l]=c),t!==0){s.toArray(c,0);for(let h=1,d=0;h!==t;++h)d+=i,r[h].toArray(c,d)}return c}function vn(r,t){if(r.length!==t.length)return!1;for(let i=0,s=r.length;i<s;i++)if(r[i]!==t[i])return!1;return!0}function xn(r,t){for(let i=0,s=t.length;i<s;i++)r[i]=t[i]}function Yc(r,t){let i=I0[t];i===void 0&&(i=new Int32Array(t),I0[t]=i);for(let s=0;s!==t;++s)i[s]=r.allocateTextureUnit();return i}function Q1(r,t){const i=this.cache;i[0]!==t&&(r.uniform1f(this.addr,t),i[0]=t)}function J1(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(vn(i,t))return;r.uniform2fv(this.addr,t),xn(i,t)}}function $1(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else if(t.r!==void 0)(i[0]!==t.r||i[1]!==t.g||i[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),i[0]=t.r,i[1]=t.g,i[2]=t.b);else{if(vn(i,t))return;r.uniform3fv(this.addr,t),xn(i,t)}}function tb(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(vn(i,t))return;r.uniform4fv(this.addr,t),xn(i,t)}}function eb(r,t){const i=this.cache,s=t.elements;if(s===void 0){if(vn(i,t))return;r.uniformMatrix2fv(this.addr,!1,t),xn(i,t)}else{if(vn(i,s))return;H0.set(s),r.uniformMatrix2fv(this.addr,!1,H0),xn(i,s)}}function nb(r,t){const i=this.cache,s=t.elements;if(s===void 0){if(vn(i,t))return;r.uniformMatrix3fv(this.addr,!1,t),xn(i,t)}else{if(vn(i,s))return;F0.set(s),r.uniformMatrix3fv(this.addr,!1,F0),xn(i,s)}}function ib(r,t){const i=this.cache,s=t.elements;if(s===void 0){if(vn(i,t))return;r.uniformMatrix4fv(this.addr,!1,t),xn(i,t)}else{if(vn(i,s))return;B0.set(s),r.uniformMatrix4fv(this.addr,!1,B0),xn(i,s)}}function ab(r,t){const i=this.cache;i[0]!==t&&(r.uniform1i(this.addr,t),i[0]=t)}function sb(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(vn(i,t))return;r.uniform2iv(this.addr,t),xn(i,t)}}function rb(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(vn(i,t))return;r.uniform3iv(this.addr,t),xn(i,t)}}function ob(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(vn(i,t))return;r.uniform4iv(this.addr,t),xn(i,t)}}function lb(r,t){const i=this.cache;i[0]!==t&&(r.uniform1ui(this.addr,t),i[0]=t)}function cb(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(vn(i,t))return;r.uniform2uiv(this.addr,t),xn(i,t)}}function ub(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(vn(i,t))return;r.uniform3uiv(this.addr,t),xn(i,t)}}function fb(r,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(vn(i,t))return;r.uniform4uiv(this.addr,t),xn(i,t)}}function hb(r,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l);let c;this.type===r.SAMPLER_2D_SHADOW?(P0.compareFunction=yv,c=P0):c=zv,i.setTexture2D(t||c,l)}function db(r,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture3D(t||Bv,l)}function pb(r,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTextureCube(t||Fv,l)}function mb(r,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture2DArray(t||Iv,l)}function gb(r){switch(r){case 5126:return Q1;case 35664:return J1;case 35665:return $1;case 35666:return tb;case 35674:return eb;case 35675:return nb;case 35676:return ib;case 5124:case 35670:return ab;case 35667:case 35671:return sb;case 35668:case 35672:return rb;case 35669:case 35673:return ob;case 5125:return lb;case 36294:return cb;case 36295:return ub;case 36296:return fb;case 35678:case 36198:case 36298:case 36306:case 35682:return hb;case 35679:case 36299:case 36307:return db;case 35680:case 36300:case 36308:case 36293:return pb;case 36289:case 36303:case 36311:case 36292:return mb}}function _b(r,t){r.uniform1fv(this.addr,t)}function vb(r,t){const i=zr(t,this.size,2);r.uniform2fv(this.addr,i)}function xb(r,t){const i=zr(t,this.size,3);r.uniform3fv(this.addr,i)}function yb(r,t){const i=zr(t,this.size,4);r.uniform4fv(this.addr,i)}function Sb(r,t){const i=zr(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,i)}function Mb(r,t){const i=zr(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,i)}function Eb(r,t){const i=zr(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,i)}function Tb(r,t){r.uniform1iv(this.addr,t)}function bb(r,t){r.uniform2iv(this.addr,t)}function Ab(r,t){r.uniform3iv(this.addr,t)}function Rb(r,t){r.uniform4iv(this.addr,t)}function Cb(r,t){r.uniform1uiv(this.addr,t)}function wb(r,t){r.uniform2uiv(this.addr,t)}function Db(r,t){r.uniform3uiv(this.addr,t)}function Ub(r,t){r.uniform4uiv(this.addr,t)}function Lb(r,t,i){const s=this.cache,l=t.length,c=Yc(i,l);vn(s,c)||(r.uniform1iv(this.addr,c),xn(s,c));for(let h=0;h!==l;++h)i.setTexture2D(t[h]||zv,c[h])}function Nb(r,t,i){const s=this.cache,l=t.length,c=Yc(i,l);vn(s,c)||(r.uniform1iv(this.addr,c),xn(s,c));for(let h=0;h!==l;++h)i.setTexture3D(t[h]||Bv,c[h])}function Ob(r,t,i){const s=this.cache,l=t.length,c=Yc(i,l);vn(s,c)||(r.uniform1iv(this.addr,c),xn(s,c));for(let h=0;h!==l;++h)i.setTextureCube(t[h]||Fv,c[h])}function Pb(r,t,i){const s=this.cache,l=t.length,c=Yc(i,l);vn(s,c)||(r.uniform1iv(this.addr,c),xn(s,c));for(let h=0;h!==l;++h)i.setTexture2DArray(t[h]||Iv,c[h])}function zb(r){switch(r){case 5126:return _b;case 35664:return vb;case 35665:return xb;case 35666:return yb;case 35674:return Sb;case 35675:return Mb;case 35676:return Eb;case 5124:case 35670:return Tb;case 35667:case 35671:return bb;case 35668:case 35672:return Ab;case 35669:case 35673:return Rb;case 5125:return Cb;case 36294:return wb;case 36295:return Db;case 36296:return Ub;case 35678:case 36198:case 36298:case 36306:case 35682:return Lb;case 35679:case 36299:case 36307:return Nb;case 35680:case 36300:case 36308:case 36293:return Ob;case 36289:case 36303:case 36311:case 36292:return Pb}}class Ib{constructor(t,i,s){this.id=t,this.addr=s,this.cache=[],this.type=i.type,this.setValue=gb(i.type)}}class Bb{constructor(t,i,s){this.id=t,this.addr=s,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=zb(i.type)}}class Fb{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,i,s){const l=this.seq;for(let c=0,h=l.length;c!==h;++c){const d=l[c];d.setValue(t,i[d.id],s)}}}const Vh=/(\w+)(\])?(\[|\.)?/g;function G0(r,t){r.seq.push(t),r.map[t.id]=t}function Hb(r,t,i){const s=r.name,l=s.length;for(Vh.lastIndex=0;;){const c=Vh.exec(s),h=Vh.lastIndex;let d=c[1];const m=c[2]==="]",p=c[3];if(m&&(d=d|0),p===void 0||p==="["&&h+2===l){G0(i,p===void 0?new Ib(d,r,t):new Bb(d,r,t));break}else{let g=i.map[d];g===void 0&&(g=new Fb(d),G0(i,g)),i=g}}}class Ic{constructor(t,i){this.seq=[],this.map={};const s=t.getProgramParameter(i,t.ACTIVE_UNIFORMS);for(let l=0;l<s;++l){const c=t.getActiveUniform(i,l),h=t.getUniformLocation(i,c.name);Hb(c,h,this)}}setValue(t,i,s,l){const c=this.map[i];c!==void 0&&c.setValue(t,s,l)}setOptional(t,i,s){const l=i[s];l!==void 0&&this.setValue(t,s,l)}static upload(t,i,s,l){for(let c=0,h=i.length;c!==h;++c){const d=i[c],m=s[d.id];m.needsUpdate!==!1&&d.setValue(t,m.value,l)}}static seqWithValue(t,i){const s=[];for(let l=0,c=t.length;l!==c;++l){const h=t[l];h.id in i&&s.push(h)}return s}}function V0(r,t,i){const s=r.createShader(t);return r.shaderSource(s,i),r.compileShader(s),s}const Gb=37297;let Vb=0;function kb(r,t){const i=r.split(`
`),s=[],l=Math.max(t-6,0),c=Math.min(t+6,i.length);for(let h=l;h<c;h++){const d=h+1;s.push(`${d===t?">":" "} ${d}: ${i[h]}`)}return s.join(`
`)}const k0=new me;function jb(r){Le._getMatrix(k0,Le.workingColorSpace,r);const t=`mat3( ${k0.elements.map(i=>i.toFixed(4))} )`;switch(Le.getTransfer(r)){case Bc:return[t,"LinearTransferOETF"];case Ve:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",r),[t,"LinearTransferOETF"]}}function j0(r,t,i){const s=r.getShaderParameter(t,r.COMPILE_STATUS),c=(r.getShaderInfoLog(t)||"").trim();if(s&&c==="")return"";const h=/ERROR: 0:(\d+)/.exec(c);if(h){const d=parseInt(h[1]);return i.toUpperCase()+`

`+c+`

`+kb(r.getShaderSource(t),d)}else return c}function Xb(r,t){const i=jb(t);return[`vec4 ${r}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}function Wb(r,t){let i;switch(t){case qS:i="Linear";break;case YS:i="Reinhard";break;case ZS:i="Cineon";break;case KS:i="ACESFilmic";break;case JS:i="AgX";break;case $S:i="Neutral";break;case QS:i="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),i="Linear"}return"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Dc=new tt;function qb(){Le.getLuminanceCoefficients(Dc);const r=Dc.x.toFixed(4),t=Dc.y.toFixed(4),i=Dc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+_);const L=F+M+h,D=F+_+d,G=V0(l,l.VERTEX_SHADER,L),N=V0(l,l.FRAGMENT_SHADER,D);l.attachShader(b,G),l.attachShader(b,N),i.index0AttributeName!==void 0?l.bindAttribLocation(b,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(b,0,"position"),l.linkProgram(b);function I(V){if(r.debug.checkShaderErrors){const J=l.getProgramInfoLog(b)||"",lt=l.getShaderInfoLog(G)||"",ht=l.getShaderInfoLog(N)||"",dt=J.trim(),B=lt.trim(),$=ht.trim();let q=!0,Mt=!0;if(l.getProgramParameter(b,l.LINK_STATUS)===!1)if(q=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,b,G,N);else{const Ct=j0(l,G,"vertex"),P=j0(l,N,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(b,l.VALIDATE_STATUS)+`
...
Program Info Log: `+dt+`
`+Ct+`
`+P)}else dt!==""?console.warn("THREE.WebGLProgram: Program Info Log:",dt):(B===""||$==="")&&(Mt=!1);Mt&&(V.diagnostics={runnable:q,programLog:dt,vertexShader:{log:B,prefix:M},fragmentShader:{log:$,prefix:_}})}l.deleteShader(G),l.deleteShader(N),W=new Ic(l,b),U=Kb(l,b)}let W;this.getUniforms=function(){return W===void 0&&I(this),W};let U;this.getAttributes=function(){return U===void 0&&I(this),U};let w=i.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return w===!1&&(w=l.getProgramParameter(b,Gb)),w},this.destroy=function(){s.releaseStatesOfProgram(this),l.deleteProgram(b),this.program=void 0},this.type=i.shaderType,this.name=i.shaderName,this.id=Vb++,this.cacheKey=t,this.usedTimes=1,this.program=b,this.vertexShader=G,this.fragmentShader=N,this}let lA=0;class cA{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const i=t.vertexShader,s=t.fragmentShader,l=this._getShaderStage(i),c=this._getShaderStage(s),h=this._getShaderCacheForMaterial(t);return h.has(l)===!1&&(h.add(l),l.usedTimes++),h.has(c)===!1&&(h.add(c),c.usedTimes++),this}remove(t){const i=this.materialCache.get(t);for(const s of i)s.usedTimes--,s.usedTimes===0&&this.shaderCache.delete(s.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const i=this.materialCache;let s=i.get(t);return s===void 0&&(s=new Set,i.set(t,s)),s}_getShaderStage(t){const i=this.shaderCache;let s=i.get(t);return s===void 0&&(s=new uA(t),i.set(t,s)),s}}class uA{constructor(t){this.id=lA++,this.code=t,this.usedTimes=0}}function fA(r,t,i,s,l,c,h){const d=new Ev,m=new cA,p=new Set,v=[],g=l.logarithmicDepthBuffer,x=l.vertexTextures;let S=l.precision;const E={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function b(U){return p.add(U),U===0?"uv":`uv${U}`}function M(U,w,V,J,lt){const ht=J.fog,dt=lt.geometry,B=U.isMeshStandardMaterial?J.environment:null,$=(U.isMeshStandardMaterial?i:t).get(U.envMap||B),q=$&&$.mapping===Xc?$.image.height:null,Mt=E[U.type];U.precision!==null&&(S=l.getMaxPrecision(U.precision),S!==U.precision&&console.warn("THREE.WebGLProgram.getParameters:",U.precision,"not supported, using",S,"instead."));const Ct=dt.morphAttributes.position||dt.morphAttributes.normal||dt.morphAttributes.color,P=Ct!==void 0?Ct.length:0;let nt=0;dt.morphAttributes.position!==void 0&&(nt=1),dt.morphAttributes.normal!==void 0&&(nt=2),dt.morphAttributes.color!==void 0&&(nt=3);let Et,rt,Rt,Y;if(Mt){const Ce=Pi[Mt];Et=Ce.vertexShader,rt=Ce.fragmentShader}else Et=U.vertexShader,rt=U.fragmentShader,m.update(U),Rt=m.getVertexShaderID(U),Y=m.getFragmentShaderID(U);const ut=r.getRenderTarget(),Ut=r.state.buffers.depth.getReversed(),Pt=lt.isInstancedMesh===!0,zt=lt.isBatchedMesh===!0,Ft=!!U.map,re=!!U.matcap,z=!!$,oe=!!U.aoMap,ee=!!U.lightMap,qt=!!U.bumpMap,Gt=!!U.normalMap,xe=!!U.displacementMap,Ot=!!U.emissiveMap,te=!!U.metalnessMap,Qe=!!U.roughnessMap,qe=U.anisotropy>0,O=U.clearcoat>0,T=U.dispersion>0,et=U.iridescence>0,mt=U.sheen>0,At=U.transmission>0,pt=qe&&!!U.anisotropyMap,Qt=O&&!!U.clearcoatMap,Nt=O&&!!U.clearcoatNormalMap,Zt=O&&!!U.clearcoatRoughnessMap,Kt=et&&!!U.iridescenceMap,bt=et&&!!U.iridescenceThicknessMap,Dt=mt&&!!U.sheenColorMap,$t=mt&&!!U.sheenRoughnessMap,j=!!U.specularMap,gt=!!U.specularColorMap,Yt=!!U.specularIntensityMap,k=At&&!!U.transmissionMap,St=At&&!!U.thicknessMap,Lt=!!U.gradientMap,Vt=!!U.alphaMap,wt=U.alphaTest>0,yt=!!U.alphaHash,kt=!!U.extensions;let ue=Xa;U.toneMapped&&(ut===null||ut.isXRRenderTarget===!0)&&(ue=r.toneMapping);const ze={shaderID:Mt,shaderType:U.type,shaderName:U.name,vertexShader:Et,fragmentShader:rt,defines:U.defines,customVertexShaderID:Rt,customFragmentShaderID:Y,isRawShaderMaterial:U.isRawShaderMaterial===!0,glslVersion:U.glslVersion,precision:S,batching:zt,batchingColor:zt&&lt._colorsTexture!==null,instancing:Pt,instancingColor:Pt&&lt.instanceColor!==null,instancingMorph:Pt&&lt.morphTexture!==null,supportsVertexTextures:x,outputColorSpace:ut===null?r.outputColorSpace:ut.isXRRenderTarget===!0?ut.texture.colorSpace:Lr,alphaToCoverage:!!U.alphaToCoverage,map:Ft,matcap:re,envMap:z,envMapMode:z&&$.mapping,envMapCubeUVHeight:q,aoMap:oe,lightMap:ee,bumpMap:qt,normalMap:Gt,displacementMap:x&&xe,emissiveMap:Ot,normalMapObjectSpace:Gt&&U.normalMapType===iM,normalMapTangentSpace:Gt&&U.normalMapType===xv,metalnessMap:te,roughnessMap:Qe,anisotropy:qe,anisotropyMap:pt,clearcoat:O,clearcoatMap:Qt,clearcoatNormalMap:Nt,clearcoatRoughnessMap:Zt,dispersion:T,iridescence:et,iridescenceMap:Kt,iridescenceThicknessMap:bt,sheen:mt,sheenColorMap:Dt,sheenRoughnessMap:$t,specularMap:j,specularColorMap:gt,specularIntensityMap:Yt,transmission:At,transmissionMap:k,thicknessMap:St,gradientMap:Lt,opaque:U.transparent===!1&&U.blending===Rr&&U.alphaToCoverage===!1,alphaMap:Vt,alphaTest:wt,alphaHash:yt,combine:U.combine,mapUv:Ft&&b(U.map.channel),aoMapUv:oe&&b(U.aoMap.channel),lightMapUv:ee&&b(U.lightMap.channel),bumpMapUv:qt&&b(U.bumpMap.channel),normalMapUv:Gt&&b(U.normalMap.channel),displacementMapUv:xe&&b(U.displacementMap.channel),emissiveMapUv:Ot&&b(U.emissiveMap.channel),metalnessMapUv:te&&b(U.metalnessMap.channel),roughnessMapUv:Qe&&b(U.roughnessMap.channel),anisotropyMapUv:pt&&b(U.anisotropyMap.channel),clearcoatMapUv:Qt&&b(U.clearcoatMap.channel),clearcoatNormalMapUv:Nt&&b(U.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Zt&&b(U.clearcoatRoughnessMap.channel),iridescenceMapUv:Kt&&b(U.iridescenceMap.channel),iridescenceThicknessMapUv:bt&&b(U.iridescenceThicknessMap.channel),sheenColorMapUv:Dt&&b(U.sheenColorMap.channel),sheenRoughnessMapUv:$t&&b(U.sheenRoughnessMap.channel),specularMapUv:j&&b(U.specularMap.channel),specularColorMapUv:gt&&b(U.specularColorMap.channel),specularIntensityMapUv:Yt&&b(U.specularIntensityMap.channel),transmissionMapUv:k&&b(U.transmissionMap.channel),thicknessMapUv:St&&b(U.thicknessMap.channel),alphaMapUv:Vt&&b(U.alphaMap.channel),vertexTangents:!!dt.attributes.tangent&&(Gt||qe),vertexColors:U.vertexColors,vertexAlphas:U.vertexColors===!0&&!!dt.attributes.color&&dt.attributes.color.itemSize===4,pointsUvs:lt.isPoints===!0&&!!dt.attributes.uv&&(Ft||Vt),fog:!!ht,useFog:U.fog===!0,fogExp2:!!ht&&ht.isFogExp2,flatShading:U.flatShading===!0&&U.wireframe===!1,sizeAttenuation:U.sizeAttenuation===!0,logarithmicDepthBuffer:g,reversedDepthBuffer:Ut,skinning:lt.isSkinnedMesh===!0,morphTargets:dt.morphAttributes.position!==void 0,morphNormals:dt.morphAttributes.normal!==void 0,morphColors:dt.morphAttributes.color!==void 0,morphTargetsCount:P,morphTextureStride:nt,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numClippingPlanes:h.numPlanes,numClipIntersection:h.numIntersection,dithering:U.dithering,shadowMapEnabled:r.shadowMap.enabled&&V.length>0,shadowMapType:r.shadowMap.type,toneMapping:ue,decodeVideoTexture:Ft&&U.map.isVideoTexture===!0&&Le.getTransfer(U.map.colorSpace)===Ve,decodeVideoTextureEmissive:Ot&&U.emissiveMap.isVideoTexture===!0&&Le.getTransfer(U.emissiveMap.colorSpace)===Ve,premultipliedAlpha:U.premultipliedAlpha,doubleSided:U.side===bi,flipSided:U.side===Yn,useDepthPacking:U.depthPacking>=0,depthPacking:U.depthPacking||0,index0AttributeName:U.index0AttributeName,extensionClipCullDistance:kt&&U.extensions.clipCullDistance===!0&&s.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(kt&&U.extensions.multiDraw===!0||zt)&&s.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:s.has("KHR_parallel_shader_compile"),customProgramCacheKey:U.customProgramCacheKey()};return ze.vertexUv1s=p.has(1),ze.vertexUv2s=p.has(2),ze.vertexUv3s=p.has(3),p.clear(),ze}function _(U){const w=[];if(U.shaderID?w.push(U.shaderID):(w.push(U.customVertexShaderID),w.push(U.customFragmentShaderID)),U.defines!==void 0)for(const V in U.defines)w.push(V),w.push(U.defines[V]);return U.isRawShaderMaterial===!1&&(F(w,U),L(w,U),w.push(r.outputColorSpace)),w.push(U.customProgramCacheKey),w.join()}function F(U,w){U.push(w.precision),U.push(w.outputColorSpace),U.push(w.envMapMode),U.push(w.envMapCubeUVHeight),U.push(w.mapUv),U.push(w.alphaMapUv),U.push(w.lightMapUv),U.push(w.aoMapUv),U.push(w.bumpMapUv),U.push(w.normalMapUv),U.push(w.displacementMapUv),U.push(w.emissiveMapUv),U.push(w.metalnessMapUv),U.push(w.roughnessMapUv),U.push(w.anisotropyMapUv),U.push(w.clearcoatMapUv),U.push(w.clearcoatNormalMapUv),U.push(w.clearcoatRoughnessMapUv),U.push(w.iridescenceMapUv),U.push(w.iridescenceThicknessMapUv),U.push(w.sheenColorMapUv),U.push(w.sheenRoughnessMapUv),U.push(w.specularMapUv),U.push(w.specularColorMapUv),U.push(w.specularIntensityMapUv),U.push(w.transmissionMapUv),U.push(w.thicknessMapUv),U.push(w.combine),U.push(w.fogExp2),U.push(w.sizeAttenuation),U.push(w.morphTargetsCount),U.push(w.morphAttributeCount),U.push(w.numDirLights),U.push(w.numPointLights),U.push(w.numSpotLights),U.push(w.numSpotLightMaps),U.push(w.numHemiLights),U.push(w.numRectAreaLights),U.push(w.numDirLightShadows),U.push(w.numPointLightShadows),U.push(w.numSpotLightShadows),U.push(w.numSpotLightShadowsWithMaps),U.push(w.numLightProbes),U.push(w.shadowMapType),U.push(w.toneMapping),U.push(w.numClippingPlanes),U.push(w.numClipIntersection),U.push(w.depthPacking)}function L(U,w){d.disableAll(),w.supportsVertexTextures&&d.enable(0),w.instancing&&d.enable(1),w.instancingColor&&d.enable(2),w.instancingMorph&&d.enable(3),w.matcap&&d.enable(4),w.envMap&&d.enable(5),w.normalMapObjectSpace&&d.enable(6),w.normalMapTangentSpace&&d.enable(7),w.clearcoat&&d.enable(8),w.iridescence&&d.enable(9),w.alphaTest&&d.enable(10),w.vertexColors&&d.enable(11),w.vertexAlphas&&d.enable(12),w.vertexUv1s&&d.enable(13),w.vertexUv2s&&d.enable(14),w.vertexUv3s&&d.enable(15),w.vertexTangents&&d.enable(16),w.anisotropy&&d.enable(17),w.alphaHash&&d.enable(18),w.batching&&d.enable(19),w.dispersion&&d.enable(20),w.batchingColor&&d.enable(21),w.gradientMap&&d.enable(22),U.push(d.mask),d.disableAll(),w.fog&&d.enable(0),w.useFog&&d.enable(1),w.flatShading&&d.enable(2),w.logarithmicDepthBuffer&&d.enable(3),w.reversedDepthBuffer&&d.enable(4),w.skinning&&d.enable(5),w.morphTargets&&d.enable(6),w.morphNormals&&d.enable(7),w.morphColors&&d.enable(8),w.premultipliedAlpha&&d.enable(9),w.shadowMapEnabled&&d.enable(10),w.doubleSided&&d.enable(11),w.flipSided&&d.enable(12),w.useDepthPacking&&d.enable(13),w.dithering&&d.enable(14),w.transmission&&d.enable(15),w.sheen&&d.enable(16),w.opaque&&d.enable(17),w.pointsUvs&&d.enable(18),w.decodeVideoTexture&&d.enable(19),w.decodeVideoTextureEmissive&&d.enable(20),w.alphaToCoverage&&d.enable(21),U.push(d.mask)}function D(U){const w=E[U.type];let V;if(w){const J=Pi[w];V=NM.clone(J.uniforms)}else V=U.uniforms;return V}function G(U,w){let V;for(let J=0,lt=v.length;J<lt;J++){const ht=v[J];if(ht.cacheKey===w){V=ht,++V.usedTimes;break}}return V===void 0&&(V=new oA(r,w,U,c),v.push(V)),V}function N(U){if(--U.usedTimes===0){const w=v.indexOf(U);v[w]=v[v.length-1],v.pop(),U.destroy()}}function I(U){m.remove(U)}function W(){m.dispose()}return{getParameters:M,getProgramCacheKey:_,getUniforms:D,acquireProgram:G,releaseProgram:N,releaseShaderCache:I,programs:v,dispose:W}}function hA(){let r=new WeakMap;function t(h){return r.has(h)}function i(h){let d=r.get(h);return d===void 0&&(d={},r.set(h,d)),d}function s(h){r.delete(h)}function l(h,d,m){r.get(h)[d]=m}function c(){r=new WeakMap}return{has:t,get:i,remove:s,update:l,dispose:c}}function dA(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.material.id!==t.material.id?r.material.id-t.material.id:r.z!==t.z?r.z-t.z:r.id-t.id}function Z0(r,t){return r.groupOrder!==t.groupOrder?r.groupOrder-t.groupOrder:r.renderOrder!==t.renderOrder?r.renderOrder-t.renderOrder:r.z!==t.z?t.z-r.z:r.id-t.id}function K0(){const r=[];let t=0;const i=[],s=[],l=[];function c(){t=0,i.length=0,s.length=0,l.length=0}function h(g,x,S,E,b,M){let _=r[t];return _===void 0?(_={id:g.id,object:g,geometry:x,material:S,groupOrder:E,renderOrder:g.renderOrder,z:b,group:M},r[t]=_):(_.id=g.id,_.object=g,_.geometry=x,_.material=S,_.groupOrder=E,_.renderOrder=g.renderOrder,_.z=b,_.group=M),t++,_}function d(g,x,S,E,b,M){const _=h(g,x,S,E,b,M);S.transmission>0?s.push(_):S.transparent===!0?l.push(_):i.push(_)}function m(g,x,S,E,b,M){const _=h(g,x,S,E,b,M);S.transmission>0?s.unshift(_):S.transparent===!0?l.unshift(_):i.unshift(_)}function p(g,x){i.length>1&&i.sort(g||dA),s.length>1&&s.sort(x||Z0),l.length>1&&l.sort(x||Z0)}function v(){for(let g=t,x=r.length;g<x;g++){const S=r[g];if(S.id===null)break;S.id=null,S.object=null,S.geometry=null,S.material=null,S.group=null}}return{opaque:i,transmissive:s,transparent:l,init:c,push:d,unshift:m,finish:v,sort:p}}function pA(){let r=new WeakMap;function t(s,l){const c=r.get(s);let h;return c===void 0?(h=new K0,r.set(s,[h])):l>=c.length?(h=new K0,c.push(h)):h=c[l],h}function i(){r=new WeakMap}return{get:t,dispose:i}}function mA(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let i;switch(t.type){case"DirectionalLight":i={direction:new tt,color:new _e};break;case"SpotLight":i={position:new tt,direction:new tt,color:new _e,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":i={position:new tt,color:new _e,distance:0,decay:0};break;case"HemisphereLight":i={direction:new tt,skyColor:new _e,groundColor:new _e};break;case"RectAreaLight":i={color:new _e,position:new tt,halfWidth:new tt,halfHeight:new tt};break}return r[t.id]=i,i}}}function gA(){const r={};return{get:function(t){if(r[t.id]!==void 0)return r[t.id];let i;switch(t.type){case"DirectionalLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new fe};break;case"SpotLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new fe};break;case"PointLight":i={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new fe,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[t.id]=i,i}}}let _A=0;function vA(r,t){return(t.castShadow?2:0)-(r.castShadow?2:0)+(t.map?1:0)-(r.map?1:0)}function xA(r){const t=new mA,i=gA(),s={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let p=0;p<9;p++)s.probe.push(new tt);const l=new tt,c=new sn,h=new sn;function d(p){let v=0,g=0,x=0;for(let U=0;U<9;U++)s.probe[U].set(0,0,0);let S=0,E=0,b=0,M=0,_=0,F=0,L=0,D=0,G=0,N=0,I=0;p.sort(vA);for(let U=0,w=p.length;U<w;U++){const V=p[U],J=V.color,lt=V.intensity,ht=V.distance,dt=V.shadow&&V.shadow.map?V.shadow.map.texture:null;if(V.isAmbientLight)v+=J.r*lt,g+=J.g*lt,x+=J.b*lt;else if(V.isLightProbe){for(let B=0;B<9;B++)s.probe[B].addScaledVector(V.sh.coefficients[B],lt);I++}else if(V.isDirectionalLight){const B=t.get(V);if(B.color.copy(V.color).multiplyScalar(V.intensity),V.castShadow){const $=V.shadow,q=i.get(V);q.shadowIntensity=$.intensity,q.shadowBias=$.bias,q.shadowNormalBias=$.normalBias,q.shadowRadius=$.radius,q.shadowMapSize=$.mapSize,s.directionalShadow[S]=q,s.directionalShadowMap[S]=dt,s.directionalShadowMatrix[S]=V.shadow.matrix,F++}s.directional[S]=B,S++}else if(V.isSpotLight){const B=t.get(V);B.position.setFromMatrixPosition(V.matrixWorld),B.color.copy(J).multiplyScalar(lt),B.distance=ht,B.coneCos=Math.cos(V.angle),B.penumbraCos=Math.cos(V.angle*(1-V.penumbra)),B.decay=V.decay,s.spot[b]=B;const $=V.shadow;if(V.map&&(s.spotLightMap[G]=V.map,G++,$.updateMatrices(V),V.castShadow&&N++),s.spotLightMatrix[b]=$.matrix,V.castShadow){const q=i.get(V);q.shadowIntensity=$.intensity,q.shadowBias=$.bias,q.shadowNormalBias=$.normalBias,q.shadowRadius=$.radius,q.shadowMapSize=$.mapSize,s.spotShadow[b]=q,s.spotShadowMap[b]=dt,D++}b++}else if(V.isRectAreaLight){const B=t.get(V);B.color.copy(J).multiplyScalar(lt),B.halfWidth.set(V.width*.5,0,0),B.halfHeight.set(0,V.height*.5,0),s.rectArea[M]=B,M++}else if(V.isPointLight){const B=t.get(V);if(B.color.copy(V.color).multiplyScalar(V.intensity),B.distance=V.distance,B.decay=V.decay,V.castShadow){const $=V.shadow,q=i.get(V);q.shadowIntensity=$.intensity,q.shadowBias=$.bias,q.shadowNormalBias=$.normalBias,q.shadowRadius=$.radius,q.shadowMapSize=$.mapSize,q.shadowCameraNear=$.camera.near,q.shadowCameraFar=$.camera.far,s.pointShadow[E]=q,s.pointShadowMap[E]=dt,s.pointShadowMatrix[E]=V.shadow.matrix,L++}s.point[E]=B,E++}else if(V.isHemisphereLight){const B=t.get(V);B.skyColor.copy(V.color).multiplyScalar(lt),B.groundColor.copy(V.groundColor).multiplyScalar(lt),s.hemi[_]=B,_++}}M>0&&(r.has("OES_texture_float_linear")===!0?(s.rectAreaLTC1=Bt.LTC_FLOAT_1,s.rectAreaLTC2=Bt.LTC_FLOAT_2):(s.rectAreaLTC1=Bt.LTC_HALF_1,s.rectAreaLTC2=Bt.LTC_HALF_2)),s.ambient[0]=v,s.ambient[1]=g,s.ambient[2]=x;const W=s.hash;(W.directionalLength!==S||W.pointLength!==E||W.spotLength!==b||W.rectAreaLength!==M||W.hemiLength!==_||W.numDirectionalShadows!==F||W.numPointShadows!==L||W.numSpotShadows!==D||W.numSpotMaps!==G||W.numLightProbes!==I)&&(s.directional.length=S,s.spot.length=b,s.rectArea.length=M,s.point.length=E,s.hemi.length=_,s.directionalShadow.length=F,s.directionalShadowMap.length=F,s.pointShadow.length=L,s.pointShadowMap.length=L,s.spotShadow.length=D,s.spotShadowMap.length=D,s.directionalShadowMatrix.length=F,s.pointShadowMatrix.length=L,s.spotLightMatrix.length=D+G-N,s.spotLightMap.length=G,s.numSpotLightShadowsWithMaps=N,s.numLightProbes=I,W.directionalLength=S,W.pointLength=E,W.spotLength=b,W.rectAreaLength=M,W.hemiLength=_,W.numDirectionalShadows=F,W.numPointShadows=L,W.numSpotShadows=D,W.numSpotMaps=G,W.numLightProbes=I,s.version=_A++)}function m(p,v){let g=0,x=0,S=0,E=0,b=0;const M=v.matrixWorldInverse;for(let _=0,F=p.length;_<F;_++){const L=p[_];if(L.isDirectionalLight){const D=s.directional[g];D.direction.setFromMatrixPosition(L.matrixWorld),l.setFromMatrixPosition(L.target.matrixWorld),D.direction.sub(l),D.direction.transformDirection(M),g++}else if(L.isSpotLight){const D=s.spot[S];D.position.setFromMatrixPosition(L.matrixWorld),D.position.applyMatrix4(M),D.direction.setFromMatrixPosition(L.matrixWorld),l.setFromMatrixPosition(L.target.matrixWorld),D.direction.sub(l),D.direction.transformDirection(M),S++}else if(L.isRectAreaLight){const D=s.rectArea[E];D.position.setFromMatrixPosition(L.matrixWorld),D.position.applyMatrix4(M),h.identity(),c.copy(L.matrixWorld),c.premultiply(M),h.extractRotation(c),D.halfWidth.set(L.width*.5,0,0),D.halfHeight.set(0,L.height*.5,0),D.halfWidth.applyMatrix4(h),D.halfHeight.applyMatrix4(h),E++}else if(L.isPointLight){const D=s.point[x];D.position.setFromMatrixPosition(L.matrixWorld),D.position.applyMatrix4(M),x++}else if(L.isHemisphereLight){const D=s.hemi[b];D.direction.setFromMatrixPosition(L.matrixWorld),D.direction.transformDirection(M),b++}}}return{setup:d,setupView:m,state:s}}function Q0(r){const t=new xA(r),i=[],s=[];function l(v){p.camera=v,i.length=0,s.length=0}function c(v){i.push(v)}function h(v){s.push(v)}function d(){t.setup(i)}function m(v){t.setupView(i,v)}const p={lightsArray:i,shadowsArray:s,camera:null,lights:t,transmissionRenderTarget:{}};return{init:l,state:p,setupLights:d,setupLightsView:m,pushLight:c,pushShadow:h}}function yA(r){let t=new WeakMap;function i(l,c=0){const h=t.get(l);let d;return h===void 0?(d=new Q0(r),t.set(l,[d])):c>=h.length?(d=new Q0(r),h.push(d)):d=h[c],d}function s(){t=new WeakMap}return{get:i,dispose:s}}const SA=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function EA(r,t,i){let s=new Yd;const l=new fe,c=new fe,h=new an,d=new jM({depthPacking:nM}),m=new XM,p={},v=i.maxTextureSize,g={[Wa]:Yn,[Yn]:Wa,[bi]:bi},x=new qa({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new fe},radius:{value:4}},vertexShader:SA,fragmentShader:MA}),S=x.clone();S.defines.HORIZONTAL_PASS=1;const E=new Fn;E.setAttribute("position",new vi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const b=new Bn(E,x),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=lv;let _=this.type;this.render=function(N,I,W){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||N.length===0)return;const U=r.getRenderTarget(),w=r.getActiveCubeFace(),V=r.getActiveMipmapLevel(),J=r.state;J.setBlending(ja),J.buffers.depth.getReversed()===!0?J.buffers.color.setClear(0,0,0,0):J.buffers.color.setClear(1,1,1,1),J.buffers.depth.setTest(!0),J.setScissorTest(!1);const lt=_!==ca&&this.type===ca,ht=_===ca&&this.type!==ca;for(let dt=0,B=N.length;dt<B;dt++){const $=N[dt],q=$.shadow;if(q===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(q.autoUpdate===!1&&q.needsUpdate===!1)continue;l.copy(q.mapSize);const Mt=q.getFrameExtents();if(l.multiply(Mt),c.copy(q.mapSize),(l.x>v||l.y>v)&&(l.x>v&&(c.x=Math.floor(v/Mt.x),l.x=c.x*Mt.x,q.mapSize.x=c.x),l.y>v&&(c.y=Math.floor(v/Mt.y),l.y=c.y*Mt.y,q.mapSize.y=c.y)),q.map===null||lt===!0||ht===!0){const P=this.type!==ca?{minFilter:Ci,magFilter:Ci}:{};q.map!==null&&q.map.dispose(),q.map=new As(l.x,l.y,P),q.map.texture.name=$.name+".shadowMap",q.camera.updateProjectionMatrix()}r.setRenderTarget(q.map),r.clear();const Ct=q.getViewportCount();for(let P=0;P<Ct;P++){const nt=q.getViewport(P);h.set(c.x*nt.x,c.y*nt.y,c.x*nt.z,c.y*nt.w),J.viewport(h),q.updateMatrices($,P),s=q.getFrustum(),D(I,W,q.camera,$,this.type)}q.isPointLightShadow!==!0&&this.type===ca&&F(q,W),q.needsUpdate=!1}_=this.type,M.needsUpdate=!1,r.setRenderTarget(U,w,V)};function F(N,I){const W=t.update(b);x.defines.VSM_SAMPLES!==N.blurSamples&&(x.defines.VSM_SAMPLES=N.blurSamples,S.defines.VSM_SAMPLES=N.blurSamples,x.needsUpdate=!0,S.needsUpdate=!0),N.mapPass===null&&(N.mapPass=new As(l.x,l.y)),x.uniforms.shadow_pass.value=N.map.texture,x.uniforms.resolution.value=N.mapSize,x.uniforms.radius.value=N.radius,r.setRenderTarget(N.mapPass),r.clear(),r.renderBufferDirect(I,null,W,x,b,null),S.uniforms.shadow_pass.value=N.mapPass.texture,S.uniforms.resolution.value=N.mapSize,S.uniforms.radius.value=N.radius,r.setRenderTarget(N.map),r.clear(),r.renderBufferDirect(I,null,W,S,b,null)}function L(N,I,W,U){let w=null;const V=W.isPointLight===!0?N.customDistanceMaterial:N.customDepthMaterial;if(V!==void 0)w=V;else if(w=W.isPointLight===!0?m:d,r.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0||I.alphaToCoverage===!0){const J=w.uuid,lt=I.uuid;let ht=p[J];ht===void 0&&(ht={},p[J]=ht);let dt=ht[lt];dt===void 0&&(dt=w.clone(),ht[lt]=dt,I.addEventListener("dispose",G)),w=dt}if(w.visible=I.visible,w.wireframe=I.wireframe,U===ca?w.side=I.shadowSide!==null?I.shadowSide:I.side:w.side=I.shadowSide!==null?I.shadowSide:g[I.side],w.alphaMap=I.alphaMap,w.alphaTest=I.alphaToCoverage===!0?.5:I.alphaTest,w.map=I.map,w.clipShadows=I.clipShadows,w.clippingPlanes=I.clippingPlanes,w.clipIntersection=I.clipIntersection,w.displacementMap=I.displacementMap,w.displacementScale=I.displacementScale,w.displacementBias=I.displacementBias,w.wireframeLinewidth=I.wireframeLinewidth,w.linewidth=I.linewidth,W.isPointLight===!0&&w.isMeshDistanceMaterial===!0){const J=r.properties.get(w);J.light=W}return w}function D(N,I,W,U,w){if(N.visible===!1)return;if(N.layers.test(I.layers)&&(N.isMesh||N.isLine||N.isPoints)&&(N.castShadow||N.receiveShadow&&w===ca)&&(!N.frustumCulled||s.intersectsObject(N))){N.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,N.matrixWorld);const lt=t.update(N),ht=N.material;if(Array.isArray(ht)){const dt=lt.groups;for(let B=0,$=dt.length;B<$;B++){const q=dt[B],Mt=ht[q.materialIndex];if(Mt&&Mt.visible){const Ct=L(N,Mt,U,w);N.onBeforeShadow(r,N,I,W,lt,Ct,q),r.renderBufferDirect(W,null,lt,Ct,N,q),N.onAfterShadow(r,N,I,W,lt,Ct,q)}}}else if(ht.visible){const dt=L(N,ht,U,w);N.onBeforeShadow(r,N,I,W,lt,dt,null),r.renderBufferDirect(W,null,lt,dt,N,null),N.onAfterShadow(r,N,I,W,lt,dt,null)}}const J=N.children;for(let lt=0,ht=J.length;lt<ht;lt++)D(J[lt],I,W,U,w)}function G(N){N.target.removeEventListener("dispose",G);for(const W in p){const U=p[W],w=N.target.uuid;w in U&&(U[w].dispose(),delete U[w])}}}const TA={[Zh]:Kh,[Qh]:td,[Jh]:ed,[wr]:$h,[Kh]:Zh,[td]:Qh,[ed]:Jh,[$h]:wr};function bA(r,t){function i(){let k=!1;const St=new an;let Lt=null;const Vt=new an(0,0,0,0);return{setMask:function(wt){Lt!==wt&&!k&&(r.colorMask(wt,wt,wt,wt),Lt=wt)},setLocked:function(wt){k=wt},setClear:function(wt,yt,kt,ue,ze){ze===!0&&(wt*=ue,yt*=ue,kt*=ue),St.set(wt,yt,kt,ue),Vt.equals(St)===!1&&(r.clearColor(wt,yt,kt,ue),Vt.copy(St))},reset:function(){k=!1,Lt=null,Vt.set(-1,0,0,0)}}}function s(){let k=!1,St=!1,Lt=null,Vt=null,wt=null;return{setReversed:function(yt){if(St!==yt){const kt=t.get("EXT_clip_control");yt?kt.clipControlEXT(kt.LOWER_LEFT_EXT,kt.ZERO_TO_ONE_EXT):kt.clipControlEXT(kt.LOWER_LEFT_EXT,kt.NEGATIVE_ONE_TO_ONE_EXT),St=yt;const ue=wt;wt=null,this.setClear(ue)}},getReversed:function(){return St},setTest:function(yt){yt?ut(r.DEPTH_TEST):Ut(r.DEPTH_TEST)},setMask:function(yt){Lt!==yt&&!k&&(r.depthMask(yt),Lt=yt)},setFunc:function(yt){if(St&&(yt=TA[yt]),Vt!==yt){switch(yt){case Zh:r.depthFunc(r.NEVER);break;case Kh:r.depthFunc(r.ALWAYS);break;case Qh:r.depthFunc(r.LESS);break;case wr:r.depthFunc(r.LEQUAL);break;case Jh:r.depthFunc(r.EQUAL);break;case $h:r.depthFunc(r.GEQUAL);break;case td:r.depthFunc(r.GREATER);break;case ed:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}Vt=yt}},setLocked:function(yt){k=yt},setClear:function(yt){wt!==yt&&(St&&(yt=1-yt),r.clearDepth(yt),wt=yt)},reset:function(){k=!1,Lt=null,Vt=null,wt=null,St=!1}}}function l(){let k=!1,St=null,Lt=null,Vt=null,wt=null,yt=null,kt=null,ue=null,ze=null;return{setTest:function(Ce){k||(Ce?ut(r.STENCIL_TEST):Ut(r.STENCIL_TEST))},setMask:function(Ce){St!==Ce&&!k&&(r.stencilMask(Ce),St=Ce)},setFunc:function(Ce,On,ri){(Lt!==Ce||Vt!==On||wt!==ri)&&(r.stencilFunc(Ce,On,ri),Lt=Ce,Vt=On,wt=ri)},setOp:function(Ce,On,ri){(yt!==Ce||kt!==On||ue!==ri)&&(r.stencilOp(Ce,On,ri),yt=Ce,kt=On,ue=ri)},setLocked:function(Ce){k=Ce},setClear:function(Ce){ze!==Ce&&(r.clearStencil(Ce),ze=Ce)},reset:function(){k=!1,St=null,Lt=null,Vt=null,wt=null,yt=null,kt=null,ue=null,ze=null}}}const c=new i,h=new s,d=new l,m=new WeakMap,p=new WeakMap;let v={},g={},x=new WeakMap,S=[],E=null,b=!1,M=null,_=null,F=null,L=null,D=null,G=null,N=null,I=new _e(0,0,0),W=0,U=!1,w=null,V=null,J=null,lt=null,ht=null;const dt=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,$=0;const q=r.getParameter(r.VERSION);q.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(q)[1]),B=$>=1):q.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),B=$>=2);let Mt=null,Ct={};const P=r.getParameter(r.SCISSOR_BOX),nt=r.getParameter(r.VIEWPORT),Et=new an().fromArray(P),rt=new an().fromArray(nt);function Rt(k,St,Lt,Vt){const wt=new Uint8Array(4),yt=r.createTexture();r.bindTexture(k,yt),r.texParameteri(k,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(k,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let kt=0;kt<Lt;kt++)k===r.TEXTURE_3D||k===r.TEXTURE_2D_ARRAY?r.texImage3D(St,0,r.RGBA,1,1,Vt,0,r.RGBA,r.UNSIGNED_BYTE,wt):r.texImage2D(St+kt,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,wt);return yt}const Y={};Y[r.TEXTURE_2D]=Rt(r.TEXTURE_2D,r.TEXTURE_2D,1),Y[r.TEXTURE_CUBE_MAP]=Rt(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Y[r.TEXTURE_2D_ARRAY]=Rt(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Y[r.TEXTURE_3D]=Rt(r.TEXTURE_3D,r.TEXTURE_3D,1,1),c.setClear(0,0,0,1),h.setClear(1),d.setClear(0),ut(r.DEPTH_TEST),h.setFunc(wr),qt(!1),Gt(K_),ut(r.CULL_FACE),oe(ja);function ut(k){v[k]!==!0&&(r.enable(k),v[k]=!0)}function Ut(k){v[k]!==!1&&(r.disable(k),v[k]=!1)}function Pt(k,St){return g[k]!==St?(r.bindFramebuffer(k,St),g[k]=St,k===r.DRAW_FRAMEBUFFER&&(g[r.FRAMEBUFFER]=St),k===r.FRAMEBUFFER&&(g[r.DRAW_FRAMEBUFFER]=St),!0):!1}function zt(k,St){let Lt=S,Vt=!1;if(k){Lt=x.get(St),Lt===void 0&&(Lt=[],x.set(St,Lt));const wt=k.textures;if(Lt.length!==wt.length||Lt[0]!==r.COLOR_ATTACHMENT0){for(let yt=0,kt=wt.length;yt<kt;yt++)Lt[yt]=r.COLOR_ATTACHMENT0+yt;Lt.length=wt.length,Vt=!0}}else Lt[0]!==r.BACK&&(Lt[0]=r.BACK,Vt=!0);Vt&&r.drawBuffers(Lt)}function Ft(k){return E!==k?(r.useProgram(k),E=k,!0):!1}const re={[ys]:r.FUNC_ADD,[CS]:r.FUNC_SUBTRACT,[wS]:r.FUNC_REVERSE_SUBTRACT};re[DS]=r.MIN,re[US]=r.MAX;const z={[LS]:r.ZERO,[NS]:r.ONE,[OS]:r.SRC_COLOR,[qh]:r.SRC_ALPHA,[HS]:r.SRC_ALPHA_SATURATE,[BS]:r.DST_COLOR,[zS]:r.DST_ALPHA,[PS]:r.ONE_MINUS_SRC_COLOR,[Yh]:r.ONE_MINUS_SRC_ALPHA,[FS]:r.ONE_MINUS_DST_COLOR,[IS]:r.ONE_MINUS_DST_ALPHA,[GS]:r.CONSTANT_COLOR,[VS]:r.ONE_MINUS_CONSTANT_COLOR,[kS]:r.CONSTANT_ALPHA,[jS]:r.ONE_MINUS_CONSTANT_ALPHA};function oe(k,St,Lt,Vt,wt,yt,kt,ue,ze,Ce){if(k===ja){b===!0&&(Ut(r.BLEND),b=!1);return}if(b===!1&&(ut(r.BLEND),b=!0),k!==RS){if(k!==M||Ce!==U){if((_!==ys||D!==ys)&&(r.blendEquation(r.FUNC_ADD),_=ys,D=ys),Ce)switch(k){case Rr:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Q_:r.blendFunc(r.ONE,r.ONE);break;case J_:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case $_:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",k);break}else switch(k){case Rr:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Q_:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case J_:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case $_:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",k);break}F=null,L=null,G=null,N=null,I.set(0,0,0),W=0,M=k,U=Ce}return}wt=wt||St,yt=yt||Lt,kt=kt||Vt,(St!==_||wt!==D)&&(r.blendEquationSeparate(re[St],re[wt]),_=St,D=wt),(Lt!==F||Vt!==L||yt!==G||kt!==N)&&(r.blendFuncSeparate(z[Lt],z[Vt],z[yt],z[kt]),F=Lt,L=Vt,G=yt,N=kt),(ue.equals(I)===!1||ze!==W)&&(r.blendColor(ue.r,ue.g,ue.b,ze),I.copy(ue),W=ze),M=k,U=!1}function ee(k,St){k.side===bi?Ut(r.CULL_FACE):ut(r.CULL_FACE);let Lt=k.side===Yn;St&&(Lt=!Lt),qt(Lt),k.blending===Rr&&k.transparent===!1?oe(ja):oe(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),h.setFunc(k.depthFunc),h.setTest(k.depthTest),h.setMask(k.depthWrite),c.setMask(k.colorWrite);const Vt=k.stencilWrite;d.setTest(Vt),Vt&&(d.setMask(k.stencilWriteMask),d.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),d.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),Ot(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?ut(r.SAMPLE_ALPHA_TO_COVERAGE):Ut(r.SAMPLE_ALPHA_TO_COVERAGE)}function qt(k){w!==k&&(k?r.frontFace(r.CW):r.frontFace(r.CCW),w=k)}function Gt(k){k!==TS?(ut(r.CULL_FACE),k!==V&&(k===K_?r.cullFace(r.BACK):k===bS?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Ut(r.CULL_FACE),V=k}function xe(k){k!==J&&(B&&r.lineWidth(k),J=k)}function Ot(k,St,Lt){k?(ut(r.POLYGON_OFFSET_FILL),(lt!==St||ht!==Lt)&&(r.polygonOffset(St,Lt),lt=St,ht=Lt)):Ut(r.POLYGON_OFFSET_FILL)}function te(k){k?ut(r.SCISSOR_TEST):Ut(r.SCISSOR_TEST)}function Qe(k){k===void 0&&(k=r.TEXTURE0+dt-1),Mt!==k&&(r.activeTexture(k),Mt=k)}function qe(k,St,Lt){Lt===void 0&&(Mt===null?Lt=r.TEXTURE0+dt-1:Lt=Mt);let Vt=Ct[Lt];Vt===void 0&&(Vt={type:void 0,texture:void 0},Ct[Lt]=Vt),(Vt.type!==k||Vt.texture!==St)&&(Mt!==Lt&&(r.activeTexture(Lt),Mt=Lt),r.bindTexture(k,St||Y[k]),Vt.type=k,Vt.texture=St)}function O(){const k=Ct[Mt];k!==void 0&&k.type!==void 0&&(r.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function T(){try{r.compressedTexImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function et(){try{r.compressedTexImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function mt(){try{r.texSubImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function At(){try{r.texSubImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function pt(){try{r.compressedTexSubImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Qt(){try{r.compressedTexSubImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Nt(){try{r.texStorage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Zt(){try{r.texStorage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Kt(){try{r.texImage2D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function bt(){try{r.texImage3D(...arguments)}catch(k){console.error("THREE.WebGLState:",k)}}function Dt(k){Et.equals(k)===!1&&(r.scissor(k.x,k.y,k.z,k.w),Et.copy(k))}function $t(k){rt.equals(k)===!1&&(r.viewport(k.x,k.y,k.z,k.w),rt.copy(k))}function j(k,St){let Lt=p.get(St);Lt===void 0&&(Lt=new WeakMap,p.set(St,Lt));let Vt=Lt.get(k);Vt===void 0&&(Vt=r.getUniformBlockIndex(St,k.name),Lt.set(k,Vt))}function gt(k,St){const Vt=p.get(St).get(k);m.get(St)!==Vt&&(r.uniformBlockBinding(St,Vt,k.__bindingPointIndex),m.set(St,Vt))}function Yt(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),h.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),v={},Mt=null,Ct={},g={},x=new WeakMap,S=[],E=null,b=!1,M=null,_=null,F=null,L=null,D=null,G=null,N=null,I=new _e(0,0,0),W=0,U=!1,w=null,V=null,J=null,lt=null,ht=null,Et.set(0,0,r.canvas.width,r.canvas.height),rt.set(0,0,r.canvas.width,r.canvas.height),c.reset(),h.reset(),d.reset()}return{buffers:{color:c,depth:h,stencil:d},enable:ut,disable:Ut,bindFramebuffer:Pt,drawBuffers:zt,useProgram:Ft,setBlending:oe,setMaterial:ee,setFlipSided:qt,setCullFace:Gt,setLineWidth:xe,setPolygonOffset:Ot,setScissorTest:te,activeTexture:Qe,bindTexture:qe,unbindTexture:O,compressedTexImage2D:T,compressedTexImage3D:et,texImage2D:Kt,texImage3D:bt,updateUBOMapping:j,uniformBlockBinding:gt,texStorage2D:Nt,texStorage3D:Zt,texSubImage2D:mt,texSubImage3D:At,compressedTexSubImage2D:pt,compressedTexSubImage3D:Qt,scissor:Dt,viewport:$t,reset:Yt}}function AA(r,t,i,s,l,c,h){const d=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new fe,v=new WeakMap;let g;const x=new WeakMap;let S=!1;try{S=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(O,T){return S?new OffscreenCanvas(O,T):Hc("canvas")}function b(O,T,et){let mt=1;const At=qe(O);if((At.width>et||At.height>et)&&(mt=et/Math.max(At.width,At.height)),mt<1)if(typeof HTMLImageElement<"u"&&O instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&O instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&O instanceof ImageBitmap||typeof VideoFrame<"u"&&O instanceof VideoFrame){const pt=Math.floor(mt*At.width),Qt=Math.floor(mt*At.height);g===void 0&&(g=E(pt,Qt));const Nt=T?E(pt,Qt):g;return Nt.width=pt,Nt.height=Qt,Nt.getContext("2d").drawImage(O,0,0,pt,Qt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+At.width+"x"+At.height+") to ("+pt+"x"+Qt+")."),Nt}else return"data"in O&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+At.width+"x"+At.height+")."),O;return O}function M(O){return O.generateMipmaps}function _(O){r.generateMipmap(O)}function F(O){return O.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:O.isWebGL3DRenderTarget?r.TEXTURE_3D:O.isWebGLArrayRenderTarget||O.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function L(O,T,et,mt,At=!1){if(O!==null){if(r[O]!==void 0)return r[O];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+O+"'")}let pt=T;if(T===r.RED&&(et===r.FLOAT&&(pt=r.R32F),et===r.HALF_FLOAT&&(pt=r.R16F),et===r.UNSIGNED_BYTE&&(pt=r.R8)),T===r.RED_INTEGER&&(et===r.UNSIGNED_BYTE&&(pt=r.R8UI),et===r.UNSIGNED_SHORT&&(pt=r.R16UI),et===r.UNSIGNED_INT&&(pt=r.R32UI),et===r.BYTE&&(pt=r.R8I),et===r.SHORT&&(pt=r.R16I),et===r.INT&&(pt=r.R32I)),T===r.RG&&(et===r.FLOAT&&(pt=r.RG32F),et===r.HALF_FLOAT&&(pt=r.RG16F),et===r.UNSIGNED_BYTE&&(pt=r.RG8)),T===r.RG_INTEGER&&(et===r.UNSIGNED_BYTE&&(pt=r.RG8UI),et===r.UNSIGNED_SHORT&&(pt=r.RG16UI),et===r.UNSIGNED_INT&&(pt=r.RG32UI),et===r.BYTE&&(pt=r.RG8I),et===r.SHORT&&(pt=r.RG16I),et===r.INT&&(pt=r.RG32I)),T===r.RGB_INTEGER&&(et===r.UNSIGNED_BYTE&&(pt=r.RGB8UI),et===r.UNSIGNED_SHORT&&(pt=r.RGB16UI),et===r.UNSIGNED_INT&&(pt=r.RGB32UI),et===r.BYTE&&(pt=r.RGB8I),et===r.SHORT&&(pt=r.RGB16I),et===r.INT&&(pt=r.RGB32I)),T===r.RGBA_INTEGER&&(et===r.UNSIGNED_BYTE&&(pt=r.RGBA8UI),et===r.UNSIGNED_SHORT&&(pt=r.RGBA16UI),et===r.UNSIGNED_INT&&(pt=r.RGBA32UI),et===r.BYTE&&(pt=r.RGBA8I),et===r.SHORT&&(pt=r.RGBA16I),et===r.INT&&(pt=r.RGBA32I)),T===r.RGB&&(et===r.UNSIGNED_INT_5_9_9_9_REV&&(pt=r.RGB9_E5),et===r.UNSIGNED_INT_10F_11F_11F_REV&&(pt=r.R11F_G11F_B10F)),T===r.RGBA){const Qt=At?Bc:Le.getTransfer(mt);et===r.FLOAT&&(pt=r.RGBA32F),et===r.HALF_FLOAT&&(pt=r.RGBA16F),et===r.UNSIGNED_BYTE&&(pt=Qt===Ve?r.SRGB8_ALPHA8:r.RGBA8),et===r.UNSIGNED_SHORT_4_4_4_4&&(pt=r.RGBA4),et===r.UNSIGNED_SHORT_5_5_5_1&&(pt=r.RGB5_A1)}return(pt===r.R16F||pt===r.R32F||pt===r.RG16F||pt===r.RG32F||pt===r.RGBA16F||pt===r.RGBA32F)&&t.get("EXT_color_buffer_float"),pt}function D(O,T){let et;return O?T===null||T===Ts||T===Go?et=r.DEPTH24_STENCIL8:T===ua?et=r.DEPTH32F_STENCIL8:T===Ho&&(et=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===Ts||T===Go?et=r.DEPTH_COMPONENT24:T===ua?et=r.DEPTH_COMPONENT32F:T===Ho&&(et=r.DEPTH_COMPONENT16),et}function G(O,T){return M(O)===!0||O.isFramebufferTexture&&O.minFilter!==Ci&&O.minFilter!==zi?Math.log2(Math.max(T.width,T.height))+1:O.mipmaps!==void 0&&O.mipmaps.length>0?O.mipmaps.length:O.isCompressedTexture&&Array.isArray(O.image)?T.mipmaps.length:1}function N(O){const T=O.target;T.removeEventListener("dispose",N),W(T),T.isVideoTexture&&v.delete(T)}function I(O){const T=O.target;T.removeEventListener("dispose",I),w(T)}function W(O){const T=s.get(O);if(T.__webglInit===void 0)return;const et=O.source,mt=x.get(et);if(mt){const At=mt[T.__cacheKey];At.usedTimes--,At.usedTimes===0&&U(O),Object.keys(mt).length===0&&x.delete(et)}s.remove(O)}function U(O){const T=s.get(O);r.deleteTexture(T.__webglTexture);const et=O.source,mt=x.get(et);delete mt[T.__cacheKey],h.memory.textures--}function w(O){const T=s.get(O);if(O.depthTexture&&(O.depthTexture.dispose(),s.remove(O.depthTexture)),O.isWebGLCubeRenderTarget)for(let mt=0;mt<6;mt++){if(Array.isArray(T.__webglFramebuffer[mt]))for(let At=0;At<T.__webglFramebuffer[mt].length;At++)r.deleteFramebuffer(T.__webglFramebuffer[mt][At]);else r.deleteFramebuffer(T.__webglFramebuffer[mt]);T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer[mt])}else{if(Array.isArray(T.__webglFramebuffer))for(let mt=0;mt<T.__webglFramebuffer.length;mt++)r.deleteFramebuffer(T.__webglFramebuffer[mt]);else r.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&r.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let mt=0;mt<T.__webglColorRenderbuffer.length;mt++)T.__webglColorRenderbuffer[mt]&&r.deleteRenderbuffer(T.__webglColorRenderbuffer[mt]);T.__webglDepthRenderbuffer&&r.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const et=O.textures;for(let mt=0,At=et.length;mt<At;mt++){const pt=s.get(et[mt]);pt.__webglTexture&&(r.deleteTexture(pt.__webglTexture),h.memory.textures--),s.remove(et[mt])}s.remove(O)}let V=0;function J(){V=0}function lt(){const O=V;return O>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+O+" texture units while this GPU supports only "+l.maxTextures),V+=1,O}function ht(O){const T=[];return T.push(O.wrapS),T.push(O.wrapT),T.push(O.wrapR||0),T.push(O.magFilter),T.push(O.minFilter),T.push(O.anisotropy),T.push(O.internalFormat),T.push(O.format),T.push(O.type),T.push(O.generateMipmaps),T.push(O.premultiplyAlpha),T.push(O.flipY),T.push(O.unpackAlignment),T.push(O.colorSpace),T.join()}function dt(O,T){const et=s.get(O);if(O.isVideoTexture&&te(O),O.isRenderTargetTexture===!1&&O.isExternalTexture!==!0&&O.version>0&&et.__version!==O.version){const mt=O.image;if(mt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(mt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Y(et,O,T);return}}else O.isExternalTexture&&(et.__webglTexture=O.sourceTexture?O.sourceTexture:null);i.bindTexture(r.TEXTURE_2D,et.__webglTexture,r.TEXTURE0+T)}function B(O,T){const et=s.get(O);if(O.isRenderTargetTexture===!1&&O.version>0&&et.__version!==O.version){Y(et,O,T);return}i.bindTexture(r.TEXTURE_2D_ARRAY,et.__webglTexture,r.TEXTURE0+T)}function $(O,T){const et=s.get(O);if(O.isRenderTargetTexture===!1&&O.version>0&&et.__version!==O.version){Y(et,O,T);return}i.bindTexture(r.TEXTURE_3D,et.__webglTexture,r.TEXTURE0+T)}function q(O,T){const et=s.get(O);if(O.version>0&&et.__version!==O.version){ut(et,O,T);return}i.bindTexture(r.TEXTURE_CUBE_MAP,et.__webglTexture,r.TEXTURE0+T)}const Mt={[ad]:r.REPEAT,[Ms]:r.CLAMP_TO_EDGE,[sd]:r.MIRRORED_REPEAT},Ct={[Ci]:r.NEAREST,[tM]:r.NEAREST_MIPMAP_NEAREST,[oc]:r.NEAREST_MIPMAP_LINEAR,[zi]:r.LINEAR,[fh]:r.LINEAR_MIPMAP_NEAREST,[Es]:r.LINEAR_MIPMAP_LINEAR},P={[aM]:r.NEVER,[uM]:r.ALWAYS,[sM]:r.LESS,[yv]:r.LEQUAL,[rM]:r.EQUAL,[cM]:r.GEQUAL,[oM]:r.GREATER,[lM]:r.NOTEQUAL};function nt(O,T){if(T.type===ua&&t.has("OES_texture_float_linear")===!1&&(T.magFilter===zi||T.magFilter===fh||T.magFilter===oc||T.magFilter===Es||T.minFilter===zi||T.minFilter===fh||T.minFilter===oc||T.minFilter===Es)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(O,r.TEXTURE_WRAP_S,Mt[T.wrapS]),r.texParameteri(O,r.TEXTURE_WRAP_T,Mt[T.wrapT]),(O===r.TEXTURE_3D||O===r.TEXTURE_2D_ARRAY)&&r.texParameteri(O,r.TEXTURE_WRAP_R,Mt[T.wrapR]),r.texParameteri(O,r.TEXTURE_MAG_FILTER,Ct[T.magFilter]),r.texParameteri(O,r.TEXTURE_MIN_FILTER,Ct[T.minFilter]),T.compareFunction&&(r.texParameteri(O,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(O,r.TEXTURE_COMPARE_FUNC,P[T.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===Ci||T.minFilter!==oc&&T.minFilter!==Es||T.type===ua&&t.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||s.get(T).__currentAnisotropy){const et=t.get("EXT_texture_filter_anisotropic");r.texParameterf(O,et.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,l.getMaxAnisotropy())),s.get(T).__currentAnisotropy=T.anisotropy}}}function Et(O,T){let et=!1;O.__webglInit===void 0&&(O.__webglInit=!0,T.addEventListener("dispose",N));const mt=T.source;let At=x.get(mt);At===void 0&&(At={},x.set(mt,At));const pt=ht(T);if(pt!==O.__cacheKey){At[pt]===void 0&&(At[pt]={texture:r.createTexture(),usedTimes:0},h.memory.textures++,et=!0),At[pt].usedTimes++;const Qt=At[O.__cacheKey];Qt!==void 0&&(At[O.__cacheKey].usedTimes--,Qt.usedTimes===0&&U(T)),O.__cacheKey=pt,O.__webglTexture=At[pt].texture}return et}function rt(O,T,et){return Math.floor(Math.floor(O/et)/T)}function Rt(O,T,et,mt){const pt=O.updateRanges;if(pt.length===0)i.texSubImage2D(r.TEXTURE_2D,0,0,0,T.width,T.height,et,mt,T.data);else{pt.sort((bt,Dt)=>bt.start-Dt.start);let Qt=0;for(let bt=1;bt<pt.length;bt++){const Dt=pt[Qt],$t=pt[bt],j=Dt.start+Dt.count,gt=rt($t.start,T.width,4),Yt=rt(Dt.start,T.width,4);$t.start<=j+1&&gt===Yt&&rt($t.start+$t.count-1,T.width,4)===gt?Dt.count=Math.max(Dt.count,$t.start+$t.count-Dt.start):(++Qt,pt[Qt]=$t)}pt.length=Qt+1;const Nt=r.getParameter(r.UNPACK_ROW_LENGTH),Zt=r.getParameter(r.UNPACK_SKIP_PIXELS),Kt=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,T.width);for(let bt=0,Dt=pt.length;bt<Dt;bt++){const $t=pt[bt],j=Math.floor($t.start/4),gt=Math.ceil($t.count/4),Yt=j%T.width,k=Math.floor(j/T.width),St=gt,Lt=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,Yt),r.pixelStorei(r.UNPACK_SKIP_ROWS,k),i.texSubImage2D(r.TEXTURE_2D,0,Yt,k,St,Lt,et,mt,T.data)}O.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,Nt),r.pixelStorei(r.UNPACK_SKIP_PIXELS,Zt),r.pixelStorei(r.UNPACK_SKIP_ROWS,Kt)}}function Y(O,T,et){let mt=r.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(mt=r.TEXTURE_2D_ARRAY),T.isData3DTexture&&(mt=r.TEXTURE_3D);const At=Et(O,T),pt=T.source;i.bindTexture(mt,O.__webglTexture,r.TEXTURE0+et);const Qt=s.get(pt);if(pt.version!==Qt.__version||At===!0){i.activeTexture(r.TEXTURE0+et);const Nt=Le.getPrimaries(Le.workingColorSpace),Zt=T.colorSpace===ka?null:Le.getPrimaries(T.colorSpace),Kt=T.colorSpace===ka||Nt===Zt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Kt);let bt=b(T.image,!1,l.maxTextureSize);bt=Qe(T,bt);const Dt=c.convert(T.format,T.colorSpace),$t=c.convert(T.type);let j=L(T.internalFormat,Dt,$t,T.colorSpace,T.isVideoTexture);nt(mt,T);let gt;const Yt=T.mipmaps,k=T.isVideoTexture!==!0,St=Qt.__version===void 0||At===!0,Lt=pt.dataReady,Vt=G(T,bt);if(T.isDepthTexture)j=D(T.format===ko,T.type),St&&(k?i.texStorage2D(r.TEXTURE_2D,1,j,bt.width,bt.height):i.texImage2D(r.TEXTURE_2D,0,j,bt.width,bt.height,0,Dt,$t,null));else if(T.isDataTexture)if(Yt.length>0){k&&St&&i.texStorage2D(r.TEXTURE_2D,Vt,j,Yt[0].width,Yt[0].height);for(let wt=0,yt=Yt.length;wt<yt;wt++)gt=Yt[wt],k?Lt&&i.texSubImage2D(r.TEXTURE_2D,wt,0,0,gt.width,gt.height,Dt,$t,gt.data):i.texImage2D(r.TEXTURE_2D,wt,j,gt.width,gt.height,0,Dt,$t,gt.data);T.generateMipmaps=!1}else k?(St&&i.texStorage2D(r.TEXTURE_2D,Vt,j,bt.width,bt.height),Lt&&Rt(T,bt,Dt,$t)):i.texImage2D(r.TEXTURE_2D,0,j,bt.width,bt.height,0,Dt,$t,bt.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){k&&St&&i.texStorage3D(r.TEXTURE_2D_ARRAY,Vt,j,Yt[0].width,Yt[0].height,bt.depth);for(let wt=0,yt=Yt.length;wt<yt;wt++)if(gt=Yt[wt],T.format!==Ri)if(Dt!==null)if(k){if(Lt)if(T.layerUpdates.size>0){const kt=R0(gt.width,gt.height,T.format,T.type);for(const ue of T.layerUpdates){const ze=gt.data.subarray(ue*kt/gt.data.BYTES_PER_ELEMENT,(ue+1)*kt/gt.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,wt,0,0,ue,gt.width,gt.height,1,Dt,ze)}T.clearLayerUpdates()}else i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,wt,0,0,0,gt.width,gt.height,bt.depth,Dt,gt.data)}else i.compressedTexImage3D(r.TEXTURE_2D_ARRAY,wt,j,gt.width,gt.height,bt.depth,0,gt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else k?Lt&&i.texSubImage3D(r.TEXTURE_2D_ARRAY,wt,0,0,0,gt.width,gt.height,bt.depth,Dt,$t,gt.data):i.texImage3D(r.TEXTURE_2D_ARRAY,wt,j,gt.width,gt.height,bt.depth,0,Dt,$t,gt.data)}else{k&&St&&i.texStorage2D(r.TEXTURE_2D,Vt,j,Yt[0].width,Yt[0].height);for(let wt=0,yt=Yt.length;wt<yt;wt++)gt=Yt[wt],T.format!==Ri?Dt!==null?k?Lt&&i.compressedTexSubImage2D(r.TEXTURE_2D,wt,0,0,gt.width,gt.height,Dt,gt.data):i.compressedTexImage2D(r.TEXTURE_2D,wt,j,gt.width,gt.height,0,gt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):k?Lt&&i.texSubImage2D(r.TEXTURE_2D,wt,0,0,gt.width,gt.height,Dt,$t,gt.data):i.texImage2D(r.TEXTURE_2D,wt,j,gt.width,gt.height,0,Dt,$t,gt.data)}else if(T.isDataArrayTexture)if(k){if(St&&i.texStorage3D(r.TEXTURE_2D_ARRAY,Vt,j,bt.width,bt.height,bt.depth),Lt)if(T.layerUpdates.size>0){const wt=R0(bt.width,bt.height,T.format,T.type);for(const yt of T.layerUpdates){const kt=bt.data.subarray(yt*wt/bt.data.BYTES_PER_ELEMENT,(yt+1)*wt/bt.data.BYTES_PER_ELEMENT);i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,yt,bt.width,bt.height,1,Dt,$t,kt)}T.clearLayerUpdates()}else i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,bt.width,bt.height,bt.depth,Dt,$t,bt.data)}else i.texImage3D(r.TEXTURE_2D_ARRAY,0,j,bt.width,bt.height,bt.depth,0,Dt,$t,bt.data);else if(T.isData3DTexture)k?(St&&i.texStorage3D(r.TEXTURE_3D,Vt,j,bt.width,bt.height,bt.depth),Lt&&i.texSubImage3D(r.TEXTURE_3D,0,0,0,0,bt.width,bt.height,bt.depth,Dt,$t,bt.data)):i.texImage3D(r.TEXTURE_3D,0,j,bt.width,bt.height,bt.depth,0,Dt,$t,bt.data);else if(T.isFramebufferTexture){if(St)if(k)i.texStorage2D(r.TEXTURE_2D,Vt,j,bt.width,bt.height);else{let wt=bt.width,yt=bt.height;for(let kt=0;kt<Vt;kt++)i.texImage2D(r.TEXTURE_2D,kt,j,wt,yt,0,Dt,$t,null),wt>>=1,yt>>=1}}else if(Yt.length>0){if(k&&St){const wt=qe(Yt[0]);i.texStorage2D(r.TEXTURE_2D,Vt,j,wt.width,wt.height)}for(let wt=0,yt=Yt.length;wt<yt;wt++)gt=Yt[wt],k?Lt&&i.texSubImage2D(r.TEXTURE_2D,wt,0,0,Dt,$t,gt):i.texImage2D(r.TEXTURE_2D,wt,j,Dt,$t,gt);T.generateMipmaps=!1}else if(k){if(St){const wt=qe(bt);i.texStorage2D(r.TEXTURE_2D,Vt,j,wt.width,wt.height)}Lt&&i.texSubImage2D(r.TEXTURE_2D,0,0,0,Dt,$t,bt)}else i.texImage2D(r.TEXTURE_2D,0,j,Dt,$t,bt);M(T)&&_(mt),Qt.__version=pt.version,T.onUpdate&&T.onUpdate(T)}O.__version=T.version}function ut(O,T,et){if(T.image.length!==6)return;const mt=Et(O,T),At=T.source;i.bindTexture(r.TEXTURE_CUBE_MAP,O.__webglTexture,r.TEXTURE0+et);const pt=s.get(At);if(At.version!==pt.__version||mt===!0){i.activeTexture(r.TEXTURE0+et);const Qt=Le.getPrimaries(Le.workingColorSpace),Nt=T.colorSpace===ka?null:Le.getPrimaries(T.colorSpace),Zt=T.colorSpace===ka||Qt===Nt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Zt);const Kt=T.isCompressedTexture||T.image[0].isCompressedTexture,bt=T.image[0]&&T.image[0].isDataTexture,Dt=[];for(let yt=0;yt<6;yt++)!Kt&&!bt?Dt[yt]=b(T.image[yt],!0,l.maxCubemapSize):Dt[yt]=bt?T.image[yt].image:T.image[yt],Dt[yt]=Qe(T,Dt[yt]);const $t=Dt[0],j=c.convert(T.format,T.colorSpace),gt=c.convert(T.type),Yt=L(T.internalFormat,j,gt,T.colorSpace),k=T.isVideoTexture!==!0,St=pt.__version===void 0||mt===!0,Lt=At.dataReady;let Vt=G(T,$t);nt(r.TEXTURE_CUBE_MAP,T);let wt;if(Kt){k&&St&&i.texStorage2D(r.TEXTURE_CUBE_MAP,Vt,Yt,$t.width,$t.height);for(let yt=0;yt<6;yt++){wt=Dt[yt].mipmaps;for(let kt=0;kt<wt.length;kt++){const ue=wt[kt];T.format!==Ri?j!==null?k?Lt&&i.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,kt,0,0,ue.width,ue.height,j,ue.data):i.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,kt,Yt,ue.width,ue.height,0,ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):k?Lt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,kt,0,0,ue.width,ue.height,j,gt,ue.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,kt,Yt,ue.width,ue.height,0,j,gt,ue.data)}}}else{if(wt=T.mipmaps,k&&St){wt.length>0&&Vt++;const yt=qe(Dt[0]);i.texStorage2D(r.TEXTURE_CUBE_MAP,Vt,Yt,yt.width,yt.height)}for(let yt=0;yt<6;yt++)if(bt){k?Lt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,0,0,Dt[yt].width,Dt[yt].height,j,gt,Dt[yt].data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,Yt,Dt[yt].width,Dt[yt].height,0,j,gt,Dt[yt].data);for(let kt=0;kt<wt.length;kt++){const ze=wt[kt].image[yt].image;k?Lt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,kt+1,0,0,ze.width,ze.height,j,gt,ze.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,kt+1,Yt,ze.width,ze.height,0,j,gt,ze.data)}}else{k?Lt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,0,0,j,gt,Dt[yt]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,Yt,j,gt,Dt[yt]);for(let kt=0;kt<wt.length;kt++){const ue=wt[kt];k?Lt&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,kt+1,0,0,j,gt,ue.image[yt]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+yt,kt+1,Yt,j,gt,ue.image[yt])}}}M(T)&&_(r.TEXTURE_CUBE_MAP),pt.__version=At.version,T.onUpdate&&T.onUpdate(T)}O.__version=T.version}function Ut(O,T,et,mt,At,pt){const Qt=c.convert(et.format,et.colorSpace),Nt=c.convert(et.type),Zt=L(et.internalFormat,Qt,Nt,et.colorSpace),Kt=s.get(T),bt=s.get(et);if(bt.__renderTarget=T,!Kt.__hasExternalTextures){const Dt=Math.max(1,T.width>>pt),$t=Math.max(1,T.height>>pt);At===r.TEXTURE_3D||At===r.TEXTURE_2D_ARRAY?i.texImage3D(At,pt,Zt,Dt,$t,T.depth,0,Qt,Nt,null):i.texImage2D(At,pt,Zt,Dt,$t,0,Qt,Nt,null)}i.bindFramebuffer(r.FRAMEBUFFER,O),Ot(T)?d.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,mt,At,bt.__webglTexture,0,xe(T)):(At===r.TEXTURE_2D||At>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&At<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,mt,At,bt.__webglTexture,pt),i.bindFramebuffer(r.FRAMEBUFFER,null)}function Pt(O,T,et){if(r.bindRenderbuffer(r.RENDERBUFFER,O),T.depthBuffer){const mt=T.depthTexture,At=mt&&mt.isDepthTexture?mt.type:null,pt=D(T.stencilBuffer,At),Qt=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Nt=xe(T);Ot(T)?d.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Nt,pt,T.width,T.height):et?r.renderbufferStorageMultisample(r.RENDERBUFFER,Nt,pt,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,pt,T.width,T.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Qt,r.RENDERBUFFER,O)}else{const mt=T.textures;for(let At=0;At<mt.length;At++){const pt=mt[At],Qt=c.convert(pt.format,pt.colorSpace),Nt=c.convert(pt.type),Zt=L(pt.internalFormat,Qt,Nt,pt.colorSpace),Kt=xe(T);et&&Ot(T)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Kt,Zt,T.width,T.height):Ot(T)?d.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Kt,Zt,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,Zt,T.width,T.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function zt(O,T){if(T&&T.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(r.FRAMEBUFFER,O),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const mt=s.get(T.depthTexture);mt.__renderTarget=T,(!mt.__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),dt(T.depthTexture,0);const At=mt.__webglTexture,pt=xe(T);if(T.depthTexture.format===Vo)Ot(T)?d.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,At,0,pt):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,At,0);else if(T.depthTexture.format===ko)Ot(T)?d.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,At,0,pt):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,At,0);else throw new Error("Unknown depthTexture format")}function Ft(O){const T=s.get(O),et=O.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==O.depthTexture){const mt=O.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),mt){const At=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,mt.removeEventListener("dispose",At)};mt.addEventListener("dispose",At),T.__depthDisposeCallback=At}T.__boundDepthTexture=mt}if(O.depthTexture&&!T.__autoAllocateDepthBuffer){if(et)throw new Error("target.depthTexture not supported in Cube render targets");const mt=O.texture.mipmaps;mt&&mt.length>0?zt(T.__webglFramebuffer[0],O):zt(T.__webglFramebuffer,O)}else if(et){T.__webglDepthbuffer=[];for(let mt=0;mt<6;mt++)if(i.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[mt]),T.__webglDepthbuffer[mt]===void 0)T.__webglDepthbuffer[mt]=r.createRenderbuffer(),Pt(T.__webglDepthbuffer[mt],O,!1);else{const At=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,pt=T.__webglDepthbuffer[mt];r.bindRenderbuffer(r.RENDERBUFFER,pt),r.framebufferRenderbuffer(r.FRAMEBUFFER,At,r.RENDERBUFFER,pt)}}else{const mt=O.texture.mipmaps;if(mt&&mt.length>0?i.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[0]):i.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=r.createRenderbuffer(),Pt(T.__webglDepthbuffer,O,!1);else{const At=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,pt=T.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,pt),r.framebufferRenderbuffer(r.FRAMEBUFFER,At,r.RENDERBUFFER,pt)}}i.bindFramebuffer(r.FRAMEBUFFER,null)}function re(O,T,et){const mt=s.get(O);T!==void 0&&Ut(mt.__webglFramebuffer,O,O.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),et!==void 0&&Ft(O)}function z(O){const T=O.texture,et=s.get(O),mt=s.get(T);O.addEventListener("dispose",I);const At=O.textures,pt=O.isWebGLCubeRenderTarget===!0,Qt=At.length>1;if(Qt||(mt.__webglTexture===void 0&&(mt.__webglTexture=r.createTexture()),mt.__version=T.version,h.memory.textures++),pt){et.__webglFramebuffer=[];for(let Nt=0;Nt<6;Nt++)if(T.mipmaps&&T.mipmaps.length>0){et.__webglFramebuffer[Nt]=[];for(let Zt=0;Zt<T.mipmaps.length;Zt++)et.__webglFramebuffer[Nt][Zt]=r.createFramebuffer()}else et.__webglFramebuffer[Nt]=r.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){et.__webglFramebuffer=[];for(let Nt=0;Nt<T.mipmaps.length;Nt++)et.__webglFramebuffer[Nt]=r.createFramebuffer()}else et.__webglFramebuffer=r.createFramebuffer();if(Qt)for(let Nt=0,Zt=At.length;Nt<Zt;Nt++){const Kt=s.get(At[Nt]);Kt.__webglTexture===void 0&&(Kt.__webglTexture=r.createTexture(),h.memory.textures++)}if(O.samples>0&&Ot(O)===!1){et.__webglMultisampledFramebuffer=r.createFramebuffer(),et.__webglColorRenderbuffer=[],i.bindFramebuffer(r.FRAMEBUFFER,et.__webglMultisampledFramebuffer);for(let Nt=0;Nt<At.length;Nt++){const Zt=At[Nt];et.__webglColorRenderbuffer[Nt]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,et.__webglColorRenderbuffer[Nt]);const Kt=c.convert(Zt.format,Zt.colorSpace),bt=c.convert(Zt.type),Dt=L(Zt.internalFormat,Kt,bt,Zt.colorSpace,O.isXRRenderTarget===!0),$t=xe(O);r.renderbufferStorageMultisample(r.RENDERBUFFER,$t,Dt,O.width,O.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Nt,r.RENDERBUFFER,et.__webglColorRenderbuffer[Nt])}r.bindRenderbuffer(r.RENDERBUFFER,null),O.depthBuffer&&(et.__webglDepthRenderbuffer=r.createRenderbuffer(),Pt(et.__webglDepthRenderbuffer,O,!0)),i.bindFramebuffer(r.FRAMEBUFFER,null)}}if(pt){i.bindTexture(r.TEXTURE_CUBE_MAP,mt.__webglTexture),nt(r.TEXTURE_CUBE_MAP,T);for(let Nt=0;Nt<6;Nt++)if(T.mipmaps&&T.mipmaps.length>0)for(let Zt=0;Zt<T.mipmaps.length;Zt++)Ut(et.__webglFramebuffer[Nt][Zt],O,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Nt,Zt);else Ut(et.__webglFramebuffer[Nt],O,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+Nt,0);M(T)&&_(r.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Qt){for(let Nt=0,Zt=At.length;Nt<Zt;Nt++){const Kt=At[Nt],bt=s.get(Kt);let Dt=r.TEXTURE_2D;(O.isWebGL3DRenderTarget||O.isWebGLArrayRenderTarget)&&(Dt=O.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(Dt,bt.__webglTexture),nt(Dt,Kt),Ut(et.__webglFramebuffer,O,Kt,r.COLOR_ATTACHMENT0+Nt,Dt,0),M(Kt)&&_(Dt)}i.unbindTexture()}else{let Nt=r.TEXTURE_2D;if((O.isWebGL3DRenderTarget||O.isWebGLArrayRenderTarget)&&(Nt=O.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(Nt,mt.__webglTexture),nt(Nt,T),T.mipmaps&&T.mipmaps.length>0)for(let Zt=0;Zt<T.mipmaps.length;Zt++)Ut(et.__webglFramebuffer[Zt],O,T,r.COLOR_ATTACHMENT0,Nt,Zt);else Ut(et.__webglFramebuffer,O,T,r.COLOR_ATTACHMENT0,Nt,0);M(T)&&_(Nt),i.unbindTexture()}O.depthBuffer&&Ft(O)}function oe(O){const T=O.textures;for(let et=0,mt=T.length;et<mt;et++){const At=T[et];if(M(At)){const pt=F(O),Qt=s.get(At).__webglTexture;i.bindTexture(pt,Qt),_(pt),i.unbindTexture()}}}const ee=[],qt=[];function Gt(O){if(O.samples>0){if(Ot(O)===!1){const T=O.textures,et=O.width,mt=O.height;let At=r.COLOR_BUFFER_BIT;const pt=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Qt=s.get(O),Nt=T.length>1;if(Nt)for(let Kt=0;Kt<T.length;Kt++)i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Kt,r.RENDERBUFFER,null),i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Kt,r.TEXTURE_2D,null,0);i.bindFramebuffer(r.READ_FRAMEBUFFER,Qt.__webglMultisampledFramebuffer);const Zt=O.texture.mipmaps;Zt&&Zt.length>0?i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qt.__webglFramebuffer[0]):i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qt.__webglFramebuffer);for(let Kt=0;Kt<T.length;Kt++){if(O.resolveDepthBuffer&&(O.depthBuffer&&(At|=r.DEPTH_BUFFER_BIT),O.stencilBuffer&&O.resolveStencilBuffer&&(At|=r.STENCIL_BUFFER_BIT)),Nt){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Qt.__webglColorRenderbuffer[Kt]);const bt=s.get(T[Kt]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,bt,0)}r.blitFramebuffer(0,0,et,mt,0,0,et,mt,At,r.NEAREST),m===!0&&(ee.length=0,qt.length=0,ee.push(r.COLOR_ATTACHMENT0+Kt),O.depthBuffer&&O.resolveDepthBuffer===!1&&(ee.push(pt),qt.push(pt),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,qt)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,ee))}if(i.bindFramebuffer(r.READ_FRAMEBUFFER,null),i.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),Nt)for(let Kt=0;Kt<T.length;Kt++){i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Kt,r.RENDERBUFFER,Qt.__webglColorRenderbuffer[Kt]);const bt=s.get(T[Kt]).__webglTexture;i.bindFramebuffer(r.FRAMEBUFFER,Qt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Kt,r.TEXTURE_2D,bt,0)}i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qt.__webglMultisampledFramebuffer)}else if(O.depthBuffer&&O.resolveDepthBuffer===!1&&m){const T=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[T])}}}function xe(O){return Math.min(l.maxSamples,O.samples)}function Ot(O){const T=s.get(O);return O.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function te(O){const T=h.render.frame;v.get(O)!==T&&(v.set(O,T),O.update())}function Qe(O,T){const et=O.colorSpace,mt=O.format,At=O.type;return O.isCompressedTexture===!0||O.isVideoTexture===!0||et!==Lr&&et!==ka&&(Le.getTransfer(et)===Ve?(mt!==Ri||At!==Bi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",et)),T}function qe(O){return typeof HTMLImageElement<"u"&&O instanceof HTMLImageElement?(p.width=O.naturalWidth||O.width,p.height=O.naturalHeight||O.height):typeof VideoFrame<"u"&&O instanceof VideoFrame?(p.width=O.displayWidth,p.height=O.displayHeight):(p.width=O.width,p.height=O.height),p}this.allocateTextureUnit=lt,this.resetTextureUnits=J,this.setTexture2D=dt,this.setTexture2DArray=B,this.setTexture3D=$,this.setTextureCube=q,this.rebindTextures=re,this.setupRenderTarget=z,this.updateRenderTargetMipmap=oe,this.updateMultisampleRenderTarget=Gt,this.setupDepthRenderbuffer=Ft,this.setupFrameBufferTexture=Ut,this.useMultisampledRTT=Ot}function RA(r,t){function i(s,l=ka){let c;const h=Le.getTransfer(l);if(s===Bi)return r.UNSIGNED_BYTE;if(s===Hd)return r.UNSIGNED_SHORT_4_4_4_4;if(s===Gd)return r.UNSIGNED_SHORT_5_5_5_1;if(s===dv)return r.UNSIGNED_INT_5_9_9_9_REV;if(s===pv)return r.UNSIGNED_INT_10F_11F_11F_REV;if(s===fv)return r.BYTE;if(s===hv)return r.SHORT;if(s===Ho)return r.UNSIGNED_SHORT;if(s===Fd)return r.INT;if(s===Ts)return r.UNSIGNED_INT;if(s===ua)return r.FLOAT;if(s===Xo)return r.HALF_FLOAT;if(s===mv)return r.ALPHA;if(s===gv)return r.RGB;if(s===Ri)return r.RGBA;if(s===Vo)return r.DEPTH_COMPONENT;if(s===ko)return r.DEPTH_STENCIL;if(s===_v)return r.RED;if(s===Vd)return r.RED_INTEGER;if(s===vv)return r.RG;if(s===kd)return r.RG_INTEGER;if(s===jd)return r.RGBA_INTEGER;if(s===Lc||s===Nc||s===Oc||s===Pc)if(h===Ve)if(c=t.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(s===Lc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Nc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Oc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Pc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=t.get("WEBGL_compressed_texture_s3tc"),c!==null){if(s===Lc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Nc)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Oc)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Pc)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===rd||s===od||s===ld||s===cd)if(c=t.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(s===rd)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===od)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===ld)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===cd)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===ud||s===fd||s===hd)if(c=t.get("WEBGL_compressed_texture_etc"),c!==null){if(s===ud||s===fd)return h===Ve?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(s===hd)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===dd||s===pd||s===md||s===gd||s===_d||s===vd||s===xd||s===yd||s===Sd||s===Md||s===Ed||s===Td||s===bd||s===Ad)if(c=t.get("WEBGL_compressed_texture_astc"),c!==null){if(s===dd)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===pd)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===md)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===gd)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===_d)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===vd)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===xd)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===yd)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Sd)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Md)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Ed)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Td)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===bd)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===Ad)return h===Ve?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Rd||s===Cd||s===wd)if(c=t.get("EXT_texture_compression_bptc"),c!==null){if(s===Rd)return h===Ve?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Cd)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===wd)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Dd||s===Ud||s===Ld||s===Nd)if(c=t.get("EXT_texture_compression_rgtc"),c!==null){if(s===Dd)return c.COMPRESSED_RED_RGTC1_EXT;if(s===Ud)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Ld)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Nd)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Go?r.UNSIGNED_INT_24_8:r[s]!==void 0?r[s]:null}return{convert:i}}const CA=`
void main() {
...
}`;class DA{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i){if(this.texture===null){const s=new Lv(t.texture);(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,s=new qa({vertexShader:CA,fragmentShader:wA,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Bn(new qc(20,20),s)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class UA extends Rs{constructor(t,i){super();const s=this;let l=null,c=1,h=null,d="local-floor",m=1,p=null,v=null,g=null,x=null,S=null,E=null;const b=typeof XRWebGLBinding<"u",M=new DA,_={},F=i.getContextAttributes();let L=null,D=null;const G=[],N=[],I=new fe;let W=null;const U=new _i;U.viewport=new an;const w=new _i;w.viewport=new an;const V=[U,w],J=new KM;let lt=null,ht=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let ut=G[Y];return ut===void 0&&(ut=new Nh,G[Y]=ut),ut.getTargetRaySpace()},this.getControllerGrip=function(Y){let ut=G[Y];return ut===void 0&&(ut=new Nh,G[Y]=ut),ut.getGripSpace()},this.getHand=function(Y){let ut=G[Y];return ut===void 0&&(ut=new Nh,G[Y]=ut),ut.getHandSpace()};function dt(Y){const ut=N.indexOf(Y.inputSource);if(ut===-1)return;const Ut=G[ut];Ut!==void 0&&(Ut.update(Y.inputSource,Y.frame,p||h),Ut.dispatchEvent({type:Y.type,data:Y.inputSource}))}function B(){l.removeEventListener("select",dt),l.removeEventListener("selectstart",dt),l.removeEventListener("selectend",dt),l.removeEventListener("squeeze",dt),l.removeEventListener("squeezestart",dt),l.removeEventListener("squeezeend",dt),l.removeEventListener("end",B),l.removeEventListener("inputsourceschange",$);for(let Y=0;Y<G.length;Y++){const ut=N[Y];ut!==null&&(N[Y]=null,G[Y].disconnect(ut))}lt=null,ht=null,M.reset();for(const Y in _)delete _[Y];t.setRenderTarget(L),S=null,x=null,g=null,l=null,D=null,Rt.stop(),s.isPresenting=!1,t.setPixelRatio(W),t.setSize(I.width,I.height,!1),s.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){c=Y,s.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){d=Y,s.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||h},this.setReferenceSpace=function(Y){p=Y},this.getBaseLayer=function(){return x!==null?x:S},this.getBinding=function(){return g===null&&b&&(g=new XRWebGLBinding(l,i)),g},this.getFrame=function(){return E},this.getSession=function(){return l},this.setSession=async function(Y){if(l=Y,l!==null){if(L=t.getRenderTarget(),l.addEventListener("select",dt),l.addEventListener("selectstart",dt),l.addEventListener("selectend",dt),l.addEventListener("squeeze",dt),l.addEventListener("squeezestart",dt),l.addEventListener("squeezeend",dt),l.addEventListener("end",B),l.addEventListener("inputsourceschange",$),F.xrCompatible!==!0&&await i.makeXRCompatible(),W=t.getPixelRatio(),t.getSize(I),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let Ut=null,Pt=null,zt=null;F.depth&&(zt=F.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Ut=F.stencil?ko:Vo,Pt=F.stencil?Go:Ts);const Ft={colorFormat:i.RGBA8,depthFormat:zt,scaleFactor:c};g=this.getBinding(),x=g.createProjectionLayer(Ft),l.updateRenderState({layers:[x]}),t.setPixelRatio(1),t.setSize(x.textureWidth,x.textureHeight,!1),D=new As(x.textureWidth,x.textureHeight,{format:Ri,type:Bi,depthTexture:new Uv(x.textureWidth,x.textureHeight,Pt,void 0,void 0,void 0,void 0,void 0,void 0,Ut),stencilBuffer:F.stencil,colorSpace:t.outputColorSpace,samples:F.antialias?4:0,resolveDepthBuffer:x.ignoreDepthValues===!1,resolveStencilBuffer:x.ignoreDepthValues===!1})}else{const Ut={antialias:F.antialias,alpha:!0,depth:F.depth,stencil:F.stencil,framebufferScaleFactor:c};S=new XRWebGLLayer(l,i,Ut),l.updateRenderState({baseLayer:S}),t.setPixelRatio(1),t.setSize(S.framebufferWidth,S.framebufferHeight,!1),D=new As(S.framebufferWidth,S.framebufferHeight,{format:Ri,type:Bi,colorSpace:t.outputColorSpace,stencilBuffer:F.stencil,resolveDepthBuffer:S.ignoreDepthValues===!1,resolveStencilBuffer:S.ignoreDepthValues===!1})}D.isXRRenderTarget=!0,this.setFoveation(m),p=null,h=await l.requestReferenceSpace(d),Rt.setContext(l),Rt.start(),s.isPresenting=!0,s.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function $(Y){for(let ut=0;ut<Y.removed.length;ut++){const Ut=Y.removed[ut],Pt=N.indexOf(Ut);Pt>=0&&(N[Pt]=null,G[Pt].disconnect(Ut))}for(let ut=0;ut<Y.added.length;ut++){const Ut=Y.added[ut];let Pt=N.indexOf(Ut);if(Pt===-1){for(let Ft=0;Ft<G.length;Ft++)if(Ft>=N.length){N.push(Ut),Pt=Ft;break}else if(N[Ft]===null){N[Ft]=Ut,Pt=Ft;break}if(Pt===-1)break}const zt=G[Pt];zt&&zt.connect(Ut)}}const q=new tt,Mt=new tt;function Ct(Y,ut,Ut){q.setFromMatrixPosition(ut.matrixWorld),Mt.setFromMatrixPosition(Ut.matrixWorld);const Pt=q.distanceTo(Mt),zt=ut.projectionMatrix.elements,Ft=Ut.projectionMatrix.elements,re=zt[14]/(zt[10]-1),z=zt[14]/(zt[10]+1),oe=(zt[9]+1)/zt[5],ee=(zt[9]-1)/zt[5],qt=(zt[8]-1)/zt[0],Gt=(Ft[8]+1)/Ft[0],xe=re*qt,Ot=re*Gt,te=Pt/(-qt+Gt),Qe=te*-qt;if(ut.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(Qe),Y.translateZ(te),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),zt[10]===-1)Y.projectionMatrix.copy(ut.projectionMatrix),Y.projectionMatrixInverse.copy(ut.projectionMatrixInverse);else{const qe=re+te,O=z+te,T=xe-Qe,et=Ot+(Pt-Qe),mt=oe*z/O*qe,At=ee*z/O*qe;Y.projectionMatrix.makePerspective(T,et,mt,At,qe,O),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function P(Y,ut){ut===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(ut.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(l===null)return;let ut=Y.near,Ut=Y.far;M.texture!==null&&(M.depthNear>0&&(ut=M.depthNear),M.depthFar>0&&(Ut=M.depthFar)),J.near=w.near=U.near=ut,J.far=w.far=U.far=Ut,(lt!==J.near||ht!==J.far)&&(l.updateRenderState({depthNear:J.near,depthFar:J.far}),lt=J.near,ht=J.far),J.layers.mask=Y.layers.mask|6,U.layers.mask=J.layers.mask&3,w.layers.mask=J.layers.mask&5;const Pt=Y.parent,zt=J.cameras;P(J,Pt);for(let Ft=0;Ft<zt.length;Ft++)P(zt[Ft],Pt);zt.length===2?Ct(J,U,w):J.projectionMatrix.copy(U.projectionMatrix),nt(Y,J,Pt)};function nt(Y,ut,Ut){Ut===null?Y.matrix.copy(ut.matrixWorld):(Y.matrix.copy(Ut.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(ut.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(ut.projectionMatrix),Y.projectionMatrixInverse.copy(ut.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=Od*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return J},this.getFoveation=function(){if(!(x===null&&S===null))return m},this.setFoveation=function(Y){m=Y,x!==null&&(x.fixedFoveation=Y),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=Y)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(J)},this.getCameraTexture=function(Y){return _[Y]};let Et=null;function rt(Y,ut){if(v=ut.getViewerPose(p||h),E=ut,v!==null){const Ut=v.views;S!==null&&(t.setRenderTargetFramebuffer(D,S.framebuffer),t.setRenderTarget(D));let Pt=!1;Ut.length!==J.cameras.length&&(J.cameras.length=0,Pt=!0);for(let z=0;z<Ut.length;z++){const oe=Ut[z];let ee=null;if(S!==null)ee=S.getViewport(oe);else{const Gt=g.getViewSubImage(x,oe);ee=Gt.viewport,z===0&&(t.setRenderTargetTextures(D,Gt.colorTexture,Gt.depthStencilTexture),t.setRenderTarget(D))}let qt=V[z];qt===void 0&&(qt=new _i,qt.layers.enable(z),qt.viewport=new an,V[z]=qt),qt.matrix.fromArray(oe.transform.matrix),qt.matrix.decompose(qt.position,qt.quaternion,qt.scale),qt.projectionMatrix.fromArray(oe.projectionMatrix),qt.projectionMatrixInverse.copy(qt.projectionMatrix).invert(),qt.viewport.set(ee.x,ee.y,ee.width,ee.height),z===0&&(J.matrix.copy(qt.matrix),J.matrix.decompose(J.position,J.quaternion,J.scale)),Pt===!0&&J.cameras.push(qt)}const zt=l.enabledFeatures;if(zt&&zt.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&b){g=s.getBinding();const z=g.getDepthInformation(Ut[0]);z&&z.isValid&&z.texture&&M.init(z,l.renderState)}if(zt&&zt.includes("camera-access")&&b){t.state.unbindTexture(),g=s.getBinding();for(let z=0;z<Ut.length;z++){const oe=Ut[z].camera;if(oe){let ee=_[oe];ee||(ee=new Lv,_[oe]=ee);const qt=g.getCameraImage(oe);ee.sourceTexture=qt}}}}for(let Ut=0;Ut<G.length;Ut++){const Pt=N[Ut],zt=G[Ut];Pt!==null&&zt!==void 0&&zt.update(Pt,ut,p||h)}Et&&Et(Y,ut),ut.detectedPlanes&&s.dispatchEvent({type:"planesdetected",data:ut}),E=null}const Rt=new Pv;Rt.setAnimationLoop(rt),this.setAnimationLoop=function(Y){Et=Y},this.dispose=function(){}}}const vs=new Fi,LA=new sn;function NA(r,t){function i(M,_){M.matrixAutoUpdate===!0&&M.updateMatrix(),_.value.copy(M.matrix)}function s(M,_){_.color.getRGB(M.fogColor.value,Rv(r)),_.isFog?(M.fogNear.value=_.near,M.fogFar.value=_.far):_.isFogExp2&&(M.fogDensity.value=_.density)}function l(M,_,F,L,D){_.isMeshBasicMaterial||_.isMeshLambertMaterial?c(M,_):_.isMeshToonMaterial?(c(M,_),g(M,_)):_.isMeshPhongMaterial?(c(M,_),v(M,_)):_.isMeshStandardMaterial?(c(M,_),x(M,_),_.isMeshPhysicalMaterial&&S(M,_,D)):_.isMeshMatcapMaterial?(c(M,_),E(M,_)):_.isMeshDepthMaterial?c(M,_):_.isMeshDistanceMaterial?(c(M,_),b(M,_)):_.isMeshNormalMaterial?c(M,_):_.isLineBasicMaterial?(h(M,_),_.isLineDashedMaterial&&d(M,_)):_.isPointsMaterial?m(M,_,F,L):_.isSpriteMaterial?p(M,_):_.isShadowMaterial?(M.color.value.copy(_.color),M.opacity.value=_.opacity):_.isShaderMaterial&&(_.uniformsNeedUpdate=!1)}function c(M,_){M.opacity.value=_.opacity,_.color&&M.diffuse.value.copy(_.color),_.emissive&&M.emissive.value.copy(_.emissive).multiplyScalar(_.emissiveIntensity),_.map&&(M.map.value=_.map,i(_.map,M.mapTransform)),_.alphaMap&&(M.alphaMap.value=_.alphaMap,i(_.alphaMap,M.alphaMapTransform)),_.bumpMap&&(M.bumpMap.value=_.bumpMap,i(_.bumpMap,M.bumpMapTransform),M.bumpScale.value=_.bumpScale,_.side===Yn&&(M.bumpScale.value*=-1)),_.normalMap&&(M.normalMap.value=_.normalMap,i(_.normalMap,M.normalMapTransform),M.normalScale.value.copy(_.normalScale),_.side===Yn&&M.normalScale.value.negate()),_.displacementMap&&(M.displacementMap.value=_.displacementMap,i(_.displacementMap,M.displacementMapTransform),M.displacementScale.value=_.displacementScale,M.displacementBias.value=_.displacementBias),_.emissiveMap&&(M.emissiveMap.value=_.emissiveMap,i(_.emissiveMap,M.emissiveMapTransform)),_.specularMap&&(M.specularMap.value=_.specularMap,i(_.specularMap,M.specularMapTransform)),_.alphaTest>0&&(M.alphaTest.value=_.alphaTest);const F=t.get(_),L=F.envMap,D=F.envMapRotation;L&&(M.envMap.value=L,vs.copy(D),vs.x*=-1,vs.y*=-1,vs.z*=-1,L.isCubeTexture&&L.isRenderTargetTexture===!1&&(vs.y*=-1,vs.z*=-1),M.envMapRotation.value.setFromMatrix4(LA.makeRotationFromEuler(vs)),M.flipEnvMap.value=L.isCubeTexture&&L.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=_.reflectivity,M.ior.value=_.ior,M.refractionRatio.value=_.refractionRatio),_.lightMap&&(M.lightMap.value=_.lightMap,M.lightMapIntensity.value=_.lightMapIntensity,i(_.lightMap,M.lightMapTransform)),_.aoMap&&(M.aoMap.value=_.aoMap,M.aoMapIntensity.value=_.aoMapIntensity,i(_.aoMap,M.aoMapTransform))}function h(M,_){M.diffuse.value.copy(_.color),M.opacity.value=_.opacity,_.map&&(M.map.value=_.map,i(_.map,M.mapTransform))}function d(M,_){M.dashSize.value=_.dashSize,M.totalSize.value=_.dashSize+_.gapSize,M.scale.value=_.scale}function m(M,_,F,L){M.diffuse.value.copy(_.color),M.opacity.value=_.opacity,M.size.value=_.size*F,M.scale.value=L*.5,_.map&&(M.map.value=_.map,i(_.map,M.uvTransform)),_.alphaMap&&(M.alphaMap.value=_.alphaMap,i(_.alphaMap,M.alphaMapTransform)),_.alphaTest>0&&(M.alphaTest.value=_.alphaTest)}function p(M,_){M.diffuse.value.copy(_.color),M.opacity.value=_.opacity,M.rotation.value=_.rotation,_.map&&(M.map.value=_.map,i(_.map,M.mapTransform)),_.alphaMap&&(M.alphaMap.value=_.alphaMap,i(_.alphaMap,M.alphaMapTransform)),_.alphaTest>0&&(M.alphaTest.value=_.alphaTest)}function v(M,_){M.specular.value.copy(_.specular),M.shininess.value=Math.max(_.shininess,1e-4)}function g(M,_){_.gradientMap&&(M.gradientMap.value=_.gradientMap)}function x(M,_){M.metalness.value=_.metalness,_.metalnessMap&&(M.metalnessMap.value=_.metalnessMap,i(_.metalnessMap,M.metalnessMapTransform)),M.roughness.value=_.roughness,_.roughnessMap&&(M.roughnessMap.value=_.roughnessMap,i(_.roughnessMap,M.roughnessMapTransform)),_.envMap&&(M.envMapIntensity.value=_.envMapIntensity)}function S(M,_,F){M.ior.value=_.ior,_.sheen>0&&(M.sheenColor.value.copy(_.sheenColor).multiplyScalar(_.sheen),M.sheenRoughness.value=_.sheenRoughness,_.sheenColorMap&&(M.sheenColorMap.value=_.sheenColorMap,i(_.sheenColorMap,M.sheenColorMapTransform)),_.sheenRoughnessMap&&(M.sheenRoughnessMap.value=_.sheenRoughnessMap,i(_.sheenRoughnessMap,M.sheenRoughnessMapTransform))),_.clearcoat>0&&(M.clearcoat.value=_.clearcoat,M.clearcoatRoughness.value=_.clearcoatRoughness,_.clearcoatMap&&(M.clearcoatMap.value=_.clearcoatMap,i(_.clearcoatMap,M.clearcoatMapTransform)),_.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=_.clearcoatRoughnessMap,i(_.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),_.clearcoatNormalMap&&(M.clearcoatNormalMap.value=_.clearcoatNormalMap,i(_.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(_.clearcoatNormalScale),_.side===Yn&&M.clearcoatNormalScale.value.negate())),_.dispersion>0&&(M.dispersion.value=_.dispersion),_.iridescence>0&&(M.iridescence.value=_.iridescence,M.iridescenceIOR.value=_.iridescenceIOR,M.iridescenceThicknessMinimum.value=_.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=_.iridescenceThicknessRange[1],_.iridescenceMap&&(M.iridescenceMap.value=_.iridescenceMap,i(_.iridescenceMap,M.iridescenceMapTransform)),_.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=_.iridescenceThicknessMap,i(_.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),_.transmission>0&&(M.transmission.value=_.transmission,M.transmissionSamplerMap.value=F.texture,M.transmissionSamplerSize.value.set(F.width,F.height),_.transmissionMap&&(M.transmissionMap.value=_.transmissionMap,i(_.transmissionMap,M.transmissionMapTransform)),M.thickness.value=_.thickness,_.thicknessMap&&(M.thicknessMap.value=_.thicknessMap,i(_.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=_.attenuationDistance,M.attenuationColor.value.copy(_.attenuationColor)),_.anisotropy>0&&(M.anisotropyVector.value.set(_.anisotropy*Math.cos(_.anisotropyRotation),_.anisotropy*Math.sin(_.anisotropyRotation)),_.anisotropyMap&&(M.anisotropyMap.value=_.anisotropyMap,i(_.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=_.specularIntensity,M.specularColor.value.copy(_.specularColor),_.specularColorMap&&(M.specularColorMap.value=_.specularColorMap,i(_.specularColorMap,M.specularColorMapTransform)),_.specularIntensityMap&&(M.specularIntensityMap.value=_.specularIntensityMap,i(_.specularIntensityMap,M.specularIntensityMapTransform))}function E(M,_){_.matcap&&(M.matcap.value=_.matcap)}function b(M,_){const F=t.get(_).light;M.referencePosition.value.setFromMatrixPosition(F.matrixWorld),M.nearDistance.value=F.shadow.camera.near,M.farDistance.value=F.shadow.camera.far}return{refreshFogUniforms:s,refreshMaterialUniforms:l}}function OA(r,t,i,s){let l={},c={},h=[];const d=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function m(F,L){const D=L.program;s.uniformBlockBinding(F,D)}function p(F,L){let D=l[F.id];D===void 0&&(E(F),D=v(F),l[F.id]=D,F.addEventListener("dispose",M));const G=L.program;s.updateUBOMapping(F,G);const N=t.render.frame;c[F.id]!==N&&(x(F),c[F.id]=N)}function v(F){const L=g();F.__bindingPointIndex=L;const D=r.createBuffer(),G=F.__size,N=F.usage;return r.bindBuffer(r.UNIFORM_BUFFER,D),r.bufferData(r.UNIFORM_BUFFER,G,N),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,L,D),D}function g(){for(let F=0;F<d;F++)if(h.indexOf(F)===-1)return h.push(F),F;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function x(F){const L=l[F.id],D=F.uniforms,G=F.__cache;r.bindBuffer(r.UNIFORM_BUFFER,L);for(let N=0,I=D.length;N<I;N++){const W=Array.isArray(D[N])?D[N]:[D[N]];for(let U=0,w=W.length;U<w;U++){const V=W[U];if(S(V,N,U,G)===!0){const J=V.__offset,lt=Array.isArray(V.value)?V.value:[V.value];let ht=0;for(let dt=0;dt<lt.length;dt++){const B=lt[dt],$=b(B);typeof B=="number"||typeof B=="boolean"?(V.__data[0]=B,r.bufferSubData(r.UNIFORM_BUFFER,J+ht,V.__data)):B.isMatrix3?(V.__data[0]=B.elements[0],V.__data[1]=B.elements[1],V.__data[2]=B.elements[2],V.__data[3]=0,V.__data[4]=B.elements[3],V.__data[5]=B.elements[4],V.__data[6]=B.elements[5],V.__data[7]=0,V.__data[8]=B.elements[6],V.__data[9]=B.elements[7],V.__data[10]=B.elements[8],V.__data[11]=0):(B.toArray(V.__data,ht),ht+=$.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,J,V.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function S(F,L,D,G){const N=F.value,I=L+"_"+D;if(G[I]===void 0)return typeof N=="number"||typeof N=="boolean"?G[I]=N:G[I]=N.clone(),!0;{const W=G[I];if(typeof N=="number"||typeof N=="boolean"){if(W!==N)return G[I]=N,!0}else if(W.equals(N)===!1)return W.copy(N),!0}return!1}function E(F){const L=F.uniforms;let D=0;const G=16;for(let I=0,W=L.length;I<W;I++){const U=Array.isArray(L[I])?L[I]:[L[I]];for(let w=0,V=U.length;w<V;w++){const J=U[w],lt=Array.isArray(J.value)?J.value:[J.value];for(let ht=0,dt=lt.length;ht<dt;ht++){const B=lt[ht],$=b(B),q=D%G,Mt=q%$.boundary,Ct=q+Mt;D+=Mt,Ct!==0&&G-Ct<$.storage&&(D+=G-Ct),J.__data=new Float32Array($.storage/Float32Array.BYTES_PER_ELEMENT),J.__offset=D,D+=$.storage}}}const N=D%G;return N>0&&(D+=G-N),F.__size=D,F.__cache={},this}function b(F){const L={boundary:0,storage:0};return typeof F=="number"||typeof F=="boolean"?(L.boundary=4,L.storage=4):F.isVector2?(L.boundary=8,L.storage=8):F.isVector3||F.isColor?(L.boundary=16,L.storage=12):F.isVector4?(L.boundary=16,L.storage=16):F.isMatrix3?(L.boundary=48,L.storage=48):F.isMatrix4?(L.boundary=64,L.storage=64):F.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",F),L}function M(F){const L=F.target;L.removeEventListener("dispose",M);const D=h.indexOf(L.__bindingPointIndex);h.splice(D,1),r.deleteBuffer(l[L.id]),delete l[L.id],delete c[L.id]}function _(){for(const F in l)r.deleteBuffer(l[F]);h=[],l={},c={}}return{bind:m,update:p,dispose:_}}class PA{constructor(t={}){const{canvas:i=dM(),context:s=null,depth:l=!0,stencil:c=!1,alpha:h=!1,antialias:d=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:v="default",failIfMajorPerformanceCaveat:g=!1,reversedDepthBuffer:x=!1}=t;this.isWebGLRenderer=!0;let S;if(s!==null){if(typeof WebGLRenderingContext<"u"&&s instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");S=s.getContextAttributes().alpha}else S=h;const E=new Uint32Array(4),b=new Int32Array(4);let M=null,_=null;const F=[],L=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Xa,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const D=this;let G=!1;this._outputColorSpace=gi;let N=0,I=0,W=null,U=-1,w=null;const V=new an,J=new an;let lt=null;const ht=new _e(0);let dt=0,B=i.width,$=i.height,q=1,Mt=null,Ct=null;const P=new an(0,0,B,$),nt=new an(0,0,B,$);let Et=!1;const rt=new Yd;let Rt=!1,Y=!1;const ut=new sn,Ut=new tt,Pt=new an,zt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ft=!1;function re(){return W===null?q:1}let z=s;function oe(R,Z){return i.getContext(R,Z)}try{const R={alpha:!0,depth:l,stencil:c,antialias:d,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:v,failIfMajorPerformanceCaveat:g};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${Bd}`),i.addEventListener("webglcontextlost",Lt,!1),i.addEventListener("webglcontextrestored",Vt,!1),i.addEventListener("webglcontextcreationerror",wt,!1),z===null){const Z="webgl2";if(z=oe(Z,R),z===null)throw oe(Z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(R){throw console.error("THREE.WebGLRenderer: "+R.message),R}let ee,qt,Gt,xe,Ot,te,Qe,qe,O,T,et,mt,At,pt,Qt,Nt,Zt,Kt,bt,Dt,$t,j,gt,Yt;function k(){ee=new X1(z),ee.init(),j=new RA(z,ee),qt=new B1(z,ee,t,j),Gt=new bA(z,ee),qt.reversedDepthBuffer&&x&&Gt.buffers.depth.setReversed(!0),xe=new Y1(z),Ot=new hA,te=new AA(z,ee,Gt,Ot,qt,j,xe),Qe=new H1(D),qe=new j1(D),O=new tE(z),gt=new z1(z,O),T=new W1(z,O,xe,gt),et=new K1(z,T,O,xe),bt=new Z1(z,qt,te),Nt=new F1(Ot),mt=new fA(D,Qe,qe,ee,qt,gt,Nt),At=new NA(D,Ot),pt=new pA,Qt=new yA(ee),Kt=new P1(D,Qe,qe,Gt,et,S,m),Zt=new EA(D,et,qt),Yt=new OA(z,xe,qt,Gt),Dt=new I1(z,ee,xe),$t=new q1(z,ee,xe),xe.programs=mt.programs,D.capabilities=qt,D.extensions=ee,D.properties=Ot,D.renderLists=pt,D.shadowMap=Zt,D.state=Gt,D.info=xe}k();const St=new UA(D,z);this.xr=St,this.getContext=function(){return z},this.getContextAttributes=function(){return z.getContextAttributes()},this.forceContextLoss=function(){const R=ee.get("WEBGL_lose_context");R&&R.loseContext()},this.forceContextRestore=function(){const R=ee.get("WEBGL_lose_context");R&&R.restoreContext()},this.getPixelRatio=function(){return q},this.setPixelRatio=function(R){R!==void 0&&(q=R,this.setSize(B,$,!1))},this.getSize=function(R){return R.set(B,$)},this.setSize=function(R,Z,ot=!0){if(St.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}B=R,$=Z,i.width=Math.floor(R*q),i.height=Math.floor(Z*q),ot===!0&&(i.style.width=R+"px",i.style.height=Z+"px"),this.setViewport(0,0,R,Z)},this.getDrawingBufferSize=function(R){return R.set(B*q,$*q).floor()},this.setDrawingBufferSize=function(R,Z,ot){B=R,$=Z,q=ot,i.width=Math.floor(R*ot),i.height=Math.floor(Z*ot),this.setViewport(0,0,R,Z)},this.getCurrentViewport=function(R){return R.copy(V)},this.getViewport=function(R){return R.copy(P)},this.setViewport=function(R,Z,ot,ct){R.isVector4?P.set(R.x,R.y,R.z,R.w):P.set(R,Z,ot,ct),Gt.viewport(V.copy(P).multiplyScalar(q).round())},this.getScissor=function(R){return R.copy(nt)},this.setScissor=function(R,Z,ot,ct){R.isVector4?nt.set(R.x,R.y,R.z,R.w):nt.set(R,Z,ot,ct),Gt.scissor(J.copy(nt).multiplyScalar(q).round())},this.getScissorTest=function(){return Et},this.setScissorTest=function(R){Gt.setScissorTest(Et=R)},this.setOpaqueSort=function(R){Mt=R},this.setTransparentSort=function(R){Ct=R},this.getClearColor=function(R){return R.copy(Kt.getClearColor())},this.setClearColor=function(){Kt.setClearColor(...arguments)},this.getClearAlpha=function(){return Kt.getClearAlpha()},this.setClearAlpha=function(){Kt.setClearAlpha(...arguments)},this.clear=function(R=!0,Z=!0,ot=!0){let ct=0;if(R){let Q=!1;if(W!==null){const Tt=W.texture.format;Q=Tt===jd||Tt===kd||Tt===Vd}if(Q){const Tt=W.texture.type,It=Tt===Bi||Tt===Ts||Tt===Ho||Tt===Go||Tt===Hd||Tt===Gd,Xt=Kt.getClearColor(),Ht=Kt.getClearAlpha(),ne=Xt.r,ce=Xt.g,ie=Xt.b;It?(E[0]=ne,E[1]=ce,E[2]=ie,E[3]=Ht,z.clearBufferuiv(z.COLOR,0,E)):(b[0]=ne,b[1]=ce,b[2]=ie,b[3]=Ht,z.clearBufferiv(z.COLOR,0,b))}else ct|=z.COLOR_BUFFER_BIT}Z&&(ct|=z.DEPTH_BUFFER_BIT),ot&&(ct|=z.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),z.clear(ct)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",Lt,!1),i.removeEventListener("webglcontextrestored",Vt,!1),i.removeEventListener("webglcontextcreationerror",wt,!1),Kt.dispose(),pt.dispose(),Qt.dispose(),Ot.dispose(),Qe.dispose(),qe.dispose(),et.dispose(),gt.dispose(),Yt.dispose(),mt.dispose(),St.dispose(),St.removeEventListener("sessionstart",ri),St.removeEventListener("sessionend",Ir),wi.stop()};function Lt(R){R.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),G=!0}function Vt(){console.log("THREE.WebGLRenderer: Context Restored."),G=!1;const R=xe.autoReset,Z=Zt.enabled,ot=Zt.autoUpdate,ct=Zt.needsUpdate,Q=Zt.type;k(),xe.autoReset=R,Zt.enabled=Z,Zt.autoUpdate=ot,Zt.needsUpdate=ct,Zt.type=Q}function wt(R){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function yt(R){const Z=R.target;Z.removeEventListener("dispose",yt),kt(Z)}function kt(R){ue(R),Ot.remove(R)}function ue(R){const Z=Ot.get(R).programs;Z!==void 0&&(Z.forEach(function(ot){mt.releaseProgram(ot)}),R.isShaderMaterial&&mt.releaseShaderCache(R))}this.renderBufferDirect=function(R,Z,ot,ct,Q,Tt){Z===null&&(Z=zt);const It=Q.isMesh&&Q.matrixWorld.determinant()<0,Xt=ha(R,Z,ot,ct,Q);Gt.setMaterial(ct,It);let Ht=ot.index,ne=1;if(ct.wireframe===!0){if(Ht=T.getWireframeAttribute(ot),Ht===void 0)return;ne=2}const ce=ot.drawRange,ie=ot.attributes.position;let ve=ce.start*ne,Oe=(ce.start+ce.count)*ne;Tt!==null&&(ve=Math.max(ve,Tt.start*ne),Oe=Math.min(Oe,(Tt.start+Tt.count)*ne)),Ht!==null?(ve=Math.max(ve,0),Oe=Math.min(Oe,Ht.count)):ie!=null&&(ve=Math.max(ve,0),Oe=Math.min(Oe,ie.count));const je=Oe-ve;if(je<0||je===1/0)return;gt.setup(Q,ct,Xt,ot,Ht);let Pe,ye=Dt;if(Ht!==null&&(Pe=O.get(Ht),ye=$t,ye.setIndex(Pe)),Q.isMesh)ct.wireframe===!0?(Gt.setLineWidth(ct.wireframeLinewidth*re()),ye.setMode(z.LINES)):ye.setMode(z.TRIANGLES);else if(Q.isLine){let Wt=ct.linewidth;Wt===void 0&&(Wt=1),Gt.setLineWidth(Wt*re()),Q.isLineSegments?ye.setMode(z.LINES):Q.isLineLoop?ye.setMode(z.LINE_LOOP):ye.setMode(z.LINE_STRIP)}else Q.isPoints?ye.setMode(z.POINTS):Q.isSprite&&ye.setMode(z.TRIANGLES);if(Q.isBatchedMesh)if(Q._multiDrawInstances!==null)jo("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ye.renderMultiDrawInstances(Q._multiDrawStarts,Q._multiDrawCounts,Q._multiDrawCount,Q._multiDrawInstances);else if(ee.get("WEBGL_multi_draw"))ye.renderMultiDraw(Q._multiDrawStarts,Q._multiDrawCounts,Q._multiDrawCount);else{const Wt=Q._multiDrawStarts,We=Q._multiDrawCounts,we=Q._multiDrawCount,bn=Ht?O.get(Ht).bytesPerElement:1,Hi=Ot.get(ct).currentProgram.getUniforms();for(let yn=0;yn<we;yn++)Hi.setValue(z,"_gl_DrawID",yn),ye.render(Wt[yn]/bn,We[yn])}else if(Q.isInstancedMesh)ye.renderInstances(ve,je,Q.count);else if(ot.isInstancedBufferGeometry){const Wt=ot._maxInstanceCount!==void 0?ot._maxInstanceCount:1/0,We=Math.min(ot.instanceCount,Wt);ye.renderInstances(ve,je,We)}else ye.render(ve,je)};function ze(R,Z,ot){R.transparent===!0&&R.side===bi&&R.forceSinglePass===!1?(R.side=Yn,R.needsUpdate=!0,Kn(R,Z,ot),R.side=Wa,R.needsUpdate=!0,Kn(R,Z,ot),R.side=bi):Kn(R,Z,ot)}this.compile=function(R,Z,ot=null){ot===null&&(ot=R),_=Qt.get(ot),_.init(Z),L.push(_),ot.traverseVisible(function(Q){Q.isLight&&Q.layers.test(Z.layers)&&(_.pushLight(Q),Q.castShadow&&_.pushShadow(Q))}),R!==ot&&R.traverseVisible(function(Q){Q.isLight&&Q.layers.test(Z.layers)&&(_.pushLight(Q),Q.castShadow&&_.pushShadow(Q))}),_.setupLights();const ct=new Set;return R.traverse(function(Q){if(!(Q.isMesh||Q.isPoints||Q.isLine||Q.isSprite))return;const Tt=Q.material;if(Tt)if(Array.isArray(Tt))for(let It=0;It<Tt.length;It++){const Xt=Tt[It];ze(Xt,ot,Q),ct.add(Xt)}else ze(Tt,ot,Q),ct.add(Tt)}),_=L.pop(),ct},this.compileAsync=function(R,Z,ot=null){const ct=this.compile(R,Z,ot);return new Promise(Q=>{function Tt(){if(ct.forEach(function(It){Ot.get(It).currentProgram.isReady()&&ct.delete(It)}),ct.size===0){Q(R);return}setTimeout(Tt,10)}ee.get("KHR_parallel_shader_compile")!==null?Tt():setTimeout(Tt,10)})};let Ce=null;function On(R){Ce&&Ce(R)}function ri(){wi.stop()}function Ir(){wi.start()}const wi=new Pv;wi.setAnimationLoop(On),typeof self<"u"&&wi.setContext(self),this.setAnimationLoop=function(R){Ce=R,St.setAnimationLoop(R),R===null?wi.stop():wi.start()},St.addEventListener("sessionstart",ri),St.addEventListener("sessionend",Ir),this.render=function(R,Z){if(Z!==void 0&&Z.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(G===!0)return;if(R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),Z.parent===null&&Z.matrixWorldAutoUpdate===!0&&Z.updateMatrixWorld(),St.enabled===!0&&St.isPresenting===!0&&(St.cameraAutoUpdate===!0&&St.updateCamera(Z),Z=St.getCamera()),R.isScene===!0&&R.onBeforeRender(D,R,Z,W),_=Qt.get(R,L.length),_.init(Z),L.push(_),ut.multiplyMatrices(Z.projectionMatrix,Z.matrixWorldInverse),rt.setFromProjectionMatrix(ut,Ii,Z.reversedDepth),Y=this.localClippingEnabled,Rt=Nt.init(this.clippingPlanes,Y),M=pt.get(R,F.length),M.init(),F.push(M),St.enabled===!0&&St.isPresenting===!0){const Tt=D.xr.getDepthSensingMesh();Tt!==null&&Cs(Tt,Z,-1/0,D.sortObjects)}Cs(R,Z,0,D.sortObjects),M.finish(),D.sortObjects===!0&&M.sort(Mt,Ct),Ft=St.enabled===!1||St.isPresenting===!1||St.hasDepthSensing()===!1,Ft&&Kt.addToRenderList(M,R),this.info.render.frame++,Rt===!0&&Nt.beginShadows();const ot=_.state.shadowsArray;Zt.render(ot,R,Z),Rt===!0&&Nt.endShadows(),this.info.autoReset===!0&&this.info.reset();const ct=M.opaque,Q=M.transmissive;if(_.setupLights(),Z.isArrayCamera){const Tt=Z.cameras;if(Q.length>0)for(let It=0,Xt=Tt.length;It<Xt;It++){const Ht=Tt[It];Ds(ct,Q,R,Ht)}Ft&&Kt.render(R);for(let It=0,Xt=Tt.length;It<Xt;It++){const Ht=Tt[It];ws(M,R,Ht,Ht.viewport)}}else Q.length>0&&Ds(ct,Q,R,Z),Ft&&Kt.render(R),ws(M,R,Z);W!==null&&I===0&&(te.updateMultisampleRenderTarget(W),te.updateRenderTargetMipmap(W)),R.isScene===!0&&R.onAfterRender(D,R,Z),gt.resetDefaultState(),U=-1,w=null,L.pop(),L.length>0?(_=L[L.length-1],Rt===!0&&Nt.setGlobalState(D.clippingPlanes,_.state.camera)):_=null,F.pop(),F.length>0?M=F[F.length-1]:M=null};function Cs(R,Z,ot,ct){if(R.visible===!1)return;if(R.layers.test(Z.layers)){if(R.isGroup)ot=R.renderOrder;else if(R.isLOD)R.autoUpdate===!0&&R.update(Z);else if(R.isLight)_.pushLight(R),R.castShadow&&_.pushShadow(R);else if(R.isSprite){if(!R.frustumCulled||rt.intersectsSprite(R)){ct&&Pt.setFromMatrixPosition(R.matrixWorld).applyMatrix4(ut);const It=et.update(R),Xt=R.material;Xt.visible&&M.push(R,It,Xt,ot,Pt.z,null)}}else if((R.isMesh||R.isLine||R.isPoints)&&(!R.frustumCulled||rt.intersectsObject(R))){const It=et.update(R),Xt=R.material;if(ct&&(R.boundingSphere!==void 0?(R.boundingSphere===null&&R.computeBoundingSphere(),Pt.copy(R.boundingSphere.center)):(It.boundingSphere===null&&It.computeBoundingSphere(),Pt.copy(It.boundingSphere.center)),Pt.applyMatrix4(R.matrixWorld).applyMatrix4(ut)),Array.isArray(Xt)){const Ht=It.groups;for(let ne=0,ce=Ht.length;ne<ce;ne++){const ie=Ht[ne],ve=Xt[ie.materialIndex];ve&&ve.visible&&M.push(R,It,ve,ot,Pt.z,ie)}}else Xt.visible&&M.push(R,It,Xt,ot,Pt.z,null)}}const Tt=R.children;for(let It=0,Xt=Tt.length;It<Xt;It++)Cs(Tt[It],Z,ot,ct)}function ws(R,Z,ot,ct){const Q=R.opaque,Tt=R.transmissive,It=R.transparent;_.setupLightsView(ot),Rt===!0&&Nt.setGlobalState(D.clippingPlanes,ot),ct&&Gt.viewport(V.copy(ct)),Q.length>0&&Ya(Q,Z,ot),Tt.length>0&&Ya(Tt,Z,ot),It.length>0&&Ya(It,Z,ot),Gt.buffers.depth.setTest(!0),Gt.buffers.depth.setMask(!0),Gt.buffers.color.setMask(!0),Gt.setPolygonOffset(!1)}function Ds(R,Z,ot,ct){if((ot.isScene===!0?ot.overrideMaterial:null)!==null)return;_.state.transmissionRenderTarget[ct.id]===void 0&&(_.state.transmissionRenderTarget[ct.id]=new As(1,1,{generateMipmaps:!0,type:ee.has("EXT_color_buffer_half_float")||ee.has("EXT_color_buffer_float")?Xo:Bi,minFilter:Es,samples:4,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Le.workingColorSpace}));const Tt=_.state.transmissionRenderTarget[ct.id],It=ct.viewport||V;Tt.setSize(It.z*D.transmissionResolutionScale,It.w*D.transmissionResolutionScale);const Xt=D.getRenderTarget(),Ht=D.getActiveCubeFace(),ne=D.getActiveMipmapLevel();D.setRenderTarget(Tt),D.getClearColor(ht),dt=D.getClearAlpha(),dt<1&&D.setClearColor(16777215,.5),D.clear(),Ft&&Kt.render(ot);const ce=D.toneMapping;D.toneMapping=Xa;const ie=ct.viewport;if(ct.viewport!==void 0&&(ct.viewport=void 0),_.setupLightsView(ct),Rt===!0&&Nt.setGlobalState(D.clippingPlanes,ct),Ya(R,ot,ct),te.updateMultisampleRenderTarget(Tt),te.updateRenderTargetMipmap(Tt),ee.has("WEBGL_multisampled_render_to_texture")===!1){let ve=!1;for(let Oe=0,je=Z.length;Oe<je;Oe++){const Pe=Z[Oe],ye=Pe.object,Wt=Pe.geometry,We=Pe.material,we=Pe.group;if(We.side===bi&&ye.layers.test(ct.layers)){const bn=We.side;We.side=Yn,We.needsUpdate=!0,Br(ye,ot,ct,Wt,We,we),We.side=bn,We.needsUpdate=!0,ve=!0}}ve===!0&&(te.updateMultisampleRenderTarget(Tt),te.updateRenderTargetMipmap(Tt))}D.setRenderTarget(Xt,Ht,ne),D.setClearColor(ht,dt),ie!==void 0&&(ct.viewport=ie),D.toneMapping=ce}function Ya(R,Z,ot){const ct=Z.isScene===!0?Z.overrideMaterial:null;for(let Q=0,Tt=R.length;Q<Tt;Q++){const It=R[Q],Xt=It.object,Ht=It.geometry,ne=It.group;let ce=It.material;ce.allowOverride===!0&&ct!==null&&(ce=ct),Xt.layers.test(ot.layers)&&Br(Xt,Z,ot,Ht,ce,ne)}}function Br(R,Z,ot,ct,Q,Tt){R.onBeforeRender(D,Z,ot,ct,Q,Tt),R.modelViewMatrix.multiplyMatrices(ot.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),Q.onBeforeRender(D,Z,ot,ct,R,Tt),Q.transparent===!0&&Q.side===bi&&Q.forceSinglePass===!1?(Q.side=Yn,Q.needsUpdate=!0,D.renderBufferDirect(ot,Z,ct,Q,R,Tt),Q.side=Wa,Q.needsUpdate=!0,D.renderBufferDirect(ot,Z,ct,Q,R,Tt),Q.side=bi):D.renderBufferDirect(ot,Z,ct,Q,R,Tt),R.onAfterRender(D,Z,ot,ct,Q,Tt)}function Kn(R,Z,ot){Z.isScene!==!0&&(Z=zt);const ct=Ot.get(R),Q=_.state.lights,Tt=_.state.shadowsArray,It=Q.state.version,Xt=mt.getParameters(R,Q.state,Tt,Z,ot),Ht=mt.getProgramCacheKey(Xt);let ne=ct.programs;ct.environment=R.isMeshStandardMaterial?Z.environment:null,ct.fog=Z.fog,ct.envMap=(R.isMeshStandardMaterial?qe:Qe).get(R.envMap||ct.environment),ct.envMapRotation=ct.environment!==null&&R.envMap===null?Z.environmentRotation:R.envMapRotation,ne===void 0&&(R.addEventListener("dispose",yt),ne=new Map,ct.programs=ne);let ce=ne.get(Ht);if(ce!==void 0){if(ct.currentProgram===ce&&ct.lightsStateVersion===It)return Tn(R,Xt),ce}else Xt.uniforms=mt.getUniforms(R),R.onBeforeCompile(Xt,D),ce=mt.acquireProgram(Xt,Ht),ne.set(Ht,ce),ct.uniforms=Xt.uniforms;const ie=ct.uniforms;return(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)&&(ie.clippingPlanes=Nt.uniform),Tn(R,Xt),ct.needsLights=Zc(R),ct.lightsStateVersion=It,ct.needsLights&&(ie.ambientLightColor.value=Q.state.ambient,ie.lightProbe.value=Q.state.probe,ie.directionalLights.value=Q.state.directional,ie.directionalLightShadows.value=Q.state.directionalShadow,ie.spotLights.value=Q.state.spot,ie.spotLightShadows.value=Q.state.spotShadow,ie.rectAreaLights.value=Q.state.rectArea,ie.ltc_1.value=Q.state.rectAreaLTC1,ie.ltc_2.value=Q.state.rectAreaLTC2,ie.pointLights.value=Q.state.point,ie.pointLightShadows.value=Q.state.pointShadow,ie.hemisphereLights.value=Q.state.hemi,ie.directionalShadowMap.value=Q.state.directionalShadowMap,ie.directionalShadowMatrix.value=Q.state.directionalShadowMatrix,ie.spotShadowMap.value=Q.state.spotShadowMap,ie.spotLightMatrix.value=Q.state.spotLightMatrix,ie.spotLightMap.value=Q.state.spotLightMap,ie.pointShadowMap.value=Q.state.pointShadowMap,ie.pointShadowMatrix.value=Q.state.pointShadowMatrix),ct.currentProgram=ce,ct.uniformsList=null,ce}function cn(R){if(R.uniformsList===null){const Z=R.currentProgram.getUniforms();R.uniformsList=Ic.seqWithValue(Z.seq,R.uniforms)}return R.uniformsList}function Tn(R,Z){const ot=Ot.get(R);ot.outputColorSpace=Z.outputColorSpace,ot.batching=Z.batching,ot.batchingColor=Z.batchingColor,ot.instancing=Z.instancing,ot.instancingColor=Z.instancingColor,ot.instancingMorph=Z.instancingMorph,ot.skinning=Z.skinning,ot.morphTargets=Z.morphTargets,ot.morphNormals=Z.morphNormals,ot.morphColors=Z.morphColors,ot.morphTargetsCount=Z.morphTargetsCount,ot.numClippingPlanes=Z.numClippingPlanes,ot.numIntersection=Z.numClipIntersection,ot.vertexAlphas=Z.vertexAlphas,ot.vertexTangents=Z.vertexTangents,ot.toneMapping=Z.toneMapping}function ha(R,Z,ot,ct,Q){Z.isScene!==!0&&(Z=zt),te.resetTextureUnits();const Tt=Z.fog,It=ct.isMeshStandardMaterial?Z.environment:null,Xt=W===null?D.outputColorSpace:W.isXRRenderTarget===!0?W.texture.colorSpace:Lr,Ht=(ct.isMeshStandardMaterial?qe:Qe).get(ct.envMap||It),ne=ct.vertexColors===!0&&!!ot.attributes.color&&ot.attributes.color.itemSize===4,ce=!!ot.attributes.tangent&&(!!ct.normalMap||ct.anisotropy>0),ie=!!ot.morphAttributes.position,ve=!!ot.morphAttributes.normal,Oe=!!ot.morphAttributes.color;let je=Xa;ct.toneMapped&&(W===null||W.isXRRenderTarget===!0)&&(je=D.toneMapping);const Pe=ot.morphAttributes.position||ot.morphAttributes.normal||ot.morphAttributes.color,ye=Pe!==void 0?Pe.length:0,Wt=Ot.get(ct),We=_.state.lights;if(Rt===!0&&(Y===!0||R!==w)){const mn=R===w&&ct.id===U;Nt.setState(ct,R,mn)}let we=!1;ct.version===Wt.__version?(Wt.needsLights&&Wt.lightsStateVersion!==We.state.version||Wt.outputColorSpace!==Xt||Q.isBatchedMesh&&Wt.batching===!1||!Q.isBatchedMesh&&Wt.batching===!0||Q.isBatchedMesh&&Wt.batchingColor===!0&&Q.colorTexture===null||Q.isBatchedMesh&&Wt.batchingColor===!1&&Q.colorTexture!==null||Q.isInstancedMesh&&Wt.instancing===!1||!Q.isInstancedMesh&&Wt.instancing===!0||Q.isSkinnedMesh&&Wt.skinning===!1||!Q.isSkinnedMesh&&Wt.skinning===!0||Q.isInstancedMesh&&Wt.instancingColor===!0&&Q.instanceColor===null||Q.isInstancedMesh&&Wt.instancingColor===!1&&Q.instanceColor!==null||Q.isInstancedMesh&&Wt.instancingMorph===!0&&Q.morphTexture===null||Q.isInstancedMesh&&Wt.instancingMorph===!1&&Q.morphTexture!==null||Wt.envMap!==Ht||ct.fog===!0&&Wt.fog!==Tt||Wt.numClippingPlanes!==void 0&&(Wt.numClippingPlanes!==Nt.numPlanes||Wt.numIntersection!==Nt.numIntersection)||Wt.vertexAlphas!==ne||Wt.vertexTangents!==ce||Wt.morphTargets!==ie||Wt.morphNormals!==ve||Wt.morphColors!==Oe||Wt.toneMapping!==je||Wt.morphTargetsCount!==ye)&&(we=!0):(we=!0,Wt.__version=ct.version);let bn=Wt.currentProgram;we===!0&&(bn=Kn(ct,Z,Q));let Hi=!1,yn=!1,Ka=!1;const Te=bn.getUniforms(),Dn=Wt.uniforms;if(Gt.useProgram(bn.program)&&(Hi=!0,yn=!0,Ka=!0),ct.id!==U&&(U=ct.id,yn=!0),Hi||w!==R){Gt.buffers.depth.getReversed()&&R.reversedDepth!==!0&&(R._reversedDepth=!0,R.updateProjectionMatrix()),Te.setValue(z,"projectionMatrix",R.projectionMatrix),Te.setValue(z,"viewMatrix",R.matrixWorldInverse);const rn=Te.map.cameraPosition;rn!==void 0&&rn.setValue(z,Ut.setFromMatrixPosition(R.matrixWorld)),qt.logarithmicDepthBuffer&&Te.setValue(z,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2)),(ct.isMeshPhongMaterial||ct.isMeshToonMaterial||ct.isMeshLambertMaterial||ct.isMeshBasicMaterial||ct.isMeshStandardMaterial||ct.isShaderMaterial)&&Te.setValue(z,"isOrthographic",R.isOrthographicCamera===!0),w!==R&&(w=R,yn=!0,Ka=!0)}if(Q.isSkinnedMesh){Te.setOptional(z,Q,"bindMatrix"),Te.setOptional(z,Q,"bindMatrixInverse");const mn=Q.skeleton;mn&&(mn.boneTexture===null&&mn.computeBoneTexture(),Te.setValue(z,"boneTexture",mn.boneTexture,te))}Q.isBatchedMesh&&(Te.setOptional(z,Q,"batchingTexture"),Te.setValue(z,"batchingTexture",Q._matricesTexture,te),Te.setOptional(z,Q,"batchingIdTexture"),Te.setValue(z,"batchingIdTexture",Q._indirectTexture,te),Te.setOptional(z,Q,"batchingColorTexture"),Q._colorsTexture!==null&&Te.setValue(z,"batchingColorTexture",Q._colorsTexture,te));const Pn=ot.morphAttributes;if((Pn.position!==void 0||Pn.normal!==void 0||Pn.color!==void 0)&&bt.update(Q,ot,bn),(yn||Wt.receiveShadow!==Q.receiveShadow)&&(Wt.receiveShadow=Q.receiveShadow,Te.setValue(z,"receiveShadow",Q.receiveShadow)),ct.isMeshGouraudMaterial&&ct.envMap!==null&&(Dn.envMap.value=Ht,Dn.flipEnvMap.value=Ht.isCubeTexture&&Ht.isRenderTargetTexture===!1?-1:1),ct.isMeshStandardMaterial&&ct.envMap===null&&Z.environment!==null&&(Dn.envMapIntensity.value=Z.environmentIntensity),yn&&(Te.setValue(z,"toneMappingExposure",D.toneMappingExposure),Wt.needsLights&&Fr(Dn,Ka),Tt&&ct.fog===!0&&At.refreshFogUniforms(Dn,Tt),At.refreshMaterialUniforms(Dn,ct,q,$,_.state.transmissionRenderTarget[R.id]),Ic.upload(z,cn(Wt),Dn,te)),ct.isShaderMaterial&&ct.uniformsNeedUpdate===!0&&(Ic.upload(z,cn(Wt),Dn,te),ct.uniformsNeedUpdate=!1),ct.isSpriteMaterial&&Te.setValue(z,"center",Q.center),Te.setValue(z,"modelViewMatrix",Q.modelViewMatrix),Te.setValue(z,"normalMatrix",Q.normalMatrix),Te.setValue(z,"modelMatrix",Q.matrixWorld),ct.isShaderMaterial||ct.isRawShaderMaterial){const mn=ct.uniformsGroups;for(let rn=0,Us=mn.length;rn<Us;rn++){const Di=mn[rn];Yt.update(Di,bn),Yt.bind(Di,bn)}}return bn}function Fr(R,Z){R.ambientLightColor.needsUpdate=Z,R.lightProbe.needsUpdate=Z,R.directionalLights.needsUpdate=Z,R.directionalLightShadows.needsUpdate=Z,R.pointLights.needsUpdate=Z,R.pointLightShadows.needsUpdate=Z,R.spotLights.needsUpdate=Z,R.spotLightShadows.needsUpdate=Z,R.rectAreaLights.needsUpdate=Z,R.hemisphereLights.needsUpdate=Z}function Zc(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}this.getActiveCubeFace=function(){return N},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return W},this.setRenderTargetTextures=function(R,Z,ot){const ct=Ot.get(R);ct.__autoAllocateDepthBuffer=R.resolveDepthBuffer===!1,ct.__autoAllocateDepthBuffer===!1&&(ct.__useRenderToTexture=!1),Ot.get(R.texture).__webglTexture=Z,Ot.get(R.depthTexture).__webglTexture=ct.__autoAllocateDepthBuffer?void 0:ot,ct.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(R,Z){const ot=Ot.get(R);ot.__webglFramebuffer=Z,ot.__useDefaultFramebuffer=Z===void 0};const Kc=z.createFramebuffer();this.setRenderTarget=function(R,Z=0,ot=0){W=R,N=Z,I=ot;let ct=!0,Q=null,Tt=!1,It=!1;if(R){const Ht=Ot.get(R);if(Ht.__useDefaultFramebuffer!==void 0)Gt.bindFramebuffer(z.FRAMEBUFFER,null),ct=!1;else if(Ht.__webglFramebuffer===void 0)te.setupRenderTarget(R);else if(Ht.__hasExternalTextures)te.rebindTextures(R,Ot.get(R.texture).__webglTexture,Ot.get(R.depthTexture).__webglTexture);else if(R.depthBuffer){const ie=R.depthTexture;if(Ht.__boundDepthTexture!==ie){if(ie!==null&&Ot.has(ie)&&(R.width!==ie.image.width||R.height!==ie.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");te.setupDepthRenderbuffer(R)}}const ne=R.texture;(ne.isData3DTexture||ne.isDataArrayTexture||ne.isCompressedArrayTexture)&&(It=!0);const ce=Ot.get(R).__webglFramebuffer;R.isWebGLCubeRenderTarget?(Array.isArray(ce[Z])?Q=ce[Z][ot]:Q=ce[Z],Tt=!0):R.samples>0&&te.useMultisampledRTT(R)===!1?Q=Ot.get(R).__webglMultisampledFramebuffer:Array.isArray(ce)?Q=ce[ot]:Q=ce,V.copy(R.viewport),J.copy(R.scissor),lt=R.scissorTest}else V.copy(P).multiplyScalar(q).floor(),J.copy(nt).multiplyScalar(q).floor(),lt=Et;if(ot!==0&&(Q=Kc),Gt.bindFramebuffer(z.FRAMEBUFFER,Q)&&ct&&Gt.drawBuffers(R,Q),Gt.viewport(V),Gt.scissor(J),Gt.setScissorTest(lt),Tt){const Ht=Ot.get(R.texture);z.framebufferTexture2D(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ht.__webglTexture,ot)}else if(It){const Ht=Z;for(let ne=0;ne<R.textures.length;ne++){const ce=Ot.get(R.textures[ne]);z.framebufferTextureLayer(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0+ne,ce.__webglTexture,ot,Ht)}}else if(R!==null&&ot!==0){const Ht=Ot.get(R.texture);z.framebufferTexture2D(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,Ht.__webglTexture,ot)}U=-1},this.readRenderTargetPixels=function(R,Z,ot,ct,Q,Tt,It,Xt=0){if(!(R&&R.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ht=Ot.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&It!==void 0&&(Ht=Ht[It]),Ht){Gt.bindFramebuffer(z.FRAMEBUFFER,Ht);try{const ne=R.textures[Xt],ce=ne.format,ie=ne.type;if(!qt.textureFormatReadable(ce)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!qt.textureTypeReadable(ie)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Z>=0&&Z<=R.width-ct&&ot>=0&&ot<=R.height-Q&&(R.textures.length>1&&z.readBuffer(z.COLOR_ATTACHMENT0+Xt),z.readPixels(Z,ot,ct,Q,j.convert(ce),j.convert(ie),Tt))}finally{const ne=W!==null?Ot.get(W).__webglFramebuffer:null;Gt.bindFramebuffer(z.FRAMEBUFFER,ne)}}},this.readRenderTargetPixelsAsync=async function(R,Z,ot,ct,Q,Tt,It,Xt=0){if(!(R&&R.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ht=Ot.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&It!==void 0&&(Ht=Ht[It]),Ht)if(Z>=0&&Z<=R.width-ct&&ot>=0&&ot<=R.height-Q){Gt.bindFramebuffer(z.FRAMEBUFFER,Ht);const ne=R.textures[Xt],ce=ne.format,ie=ne.type;if(!qt.textureFormatReadable(ce))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!qt.textureTypeReadable(ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ve=z.createBuffer();z.bindBuffer(z.PIXEL_PACK_BUFFER,ve),z.bufferData(z.PIXEL_PACK_BUFFER,Tt.byteLength,z.STREAM_READ),R.textures.length>1&&z.readBuffer(z.COLOR_ATTACHMENT0+Xt),z.readPixels(Z,ot,ct,Q,j.convert(ce),j.convert(ie),0);const Oe=W!==null?Ot.get(W).__webglFramebuffer:null;Gt.bindFramebuffer(z.FRAMEBUFFER,Oe);const je=z.fenceSync(z.SYNC_GPU_COMMANDS_COMPLETE,0);return z.flush(),await pM(z,je,4),z.bindBuffer(z.PIXEL_PACK_BUFFER,ve),z.getBufferSubData(z.PIXEL_PACK_BUFFER,0,Tt),z.deleteBuffer(ve),z.deleteSync(je),Tt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(R,Z=null,ot=0){const ct=Math.pow(2,-ot),Q=Math.floor(R.image.width*ct),Tt=Math.floor(R.image.height*ct),It=Z!==null?Z.x:0,Xt=Z!==null?Z.y:0;te.setTexture2D(R,0),z.copyTexSubImage2D(z.TEXTURE_2D,ot,0,0,It,Xt,Q,Tt),Gt.unbindTexture()};const Zo=z.createFramebuffer(),Za=z.createFramebuffer();this.copyTextureToTexture=function(R,Z,ot=null,ct=null,Q=0,Tt=null){Tt===null&&(Q!==0?(jo("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Tt=Q,Q=0):Tt=0);let It,Xt,Ht,ne,ce,ie,ve,Oe,je;const Pe=R.isCompressedTexture?R.mipmaps[Tt]:R.image;if(ot!==null)It=ot.max.x-ot.min.x,Xt=ot.max.y-ot.min.y,Ht=ot.isBox3?ot.max.z-ot.min.z:1,ne=ot.min.x,ce=ot.min.y,ie=ot.isBox3?ot.min.z:0;else{const Pn=Math.pow(2,-Q);It=Math.floor(Pe.width*Pn),Xt=Math.floor(Pe.height*Pn),R.isDataArrayTexture?Ht=Pe.depth:R.isData3DTexture?Ht=Math.floor(Pe.depth*Pn):Ht=1,ne=0,ce=0,ie=0}ct!==null?(ve=ct.x,Oe=ct.y,je=ct.z):(ve=0,Oe=0,je=0);const ye=j.convert(Z.format),Wt=j.convert(Z.type);let We;Z.isData3DTexture?(te.setTexture3D(Z,0),We=z.TEXTURE_3D):Z.isDataArrayTexture||Z.isCompressedArrayTexture?(te.setTexture2DArray(Z,0),We=z.TEXTURE_2D_ARRAY):(te.setTexture2D(Z,0),We=z.TEXTURE_2D),z.pixelStorei(z.UNPACK_FLIP_Y_WEBGL,Z.flipY),z.pixelStorei(z.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Z.premultiplyAlpha),z.pixelStorei(z.UNPACK_ALIGNMENT,Z.unpackAlignment);const we=z.getParameter(z.UNPACK_ROW_LENGTH),bn=z.getParameter(z.UNPACK_IMAGE_HEIGHT),Hi=z.getParameter(z.UNPACK_SKIP_PIXELS),yn=z.getParameter(z.UNPACK_SKIP_ROWS),Ka=z.getParameter(z.UNPACK_SKIP_IMAGES);z.pixelStorei(z.UNPACK_ROW_LENGTH,Pe.width),z.pixelStorei(z.UNPACK_IMAGE_HEIGHT,Pe.height),z.pixelStorei(z.UNPACK_SKIP_PIXELS,ne),z.pixelStorei(z.UNPACK_SKIP_ROWS,ce),z.pixelStorei(z.UNPACK_SKIP_IMAGES,ie);const Te=R.isDataArrayTexture||R.isData3DTexture,Dn=Z.isDataArrayTexture||Z.isData3DTexture;if(R.isDepthTexture){const Pn=Ot.get(R),mn=Ot.get(Z),rn=Ot.get(Pn.__renderTarget),Us=Ot.get(mn.__renderTarget);Gt.bindFramebuffer(z.READ_FRAMEBUFFER,rn.__webglFramebuffer),Gt.bindFramebuffer(z.DRAW_FRAMEBUFFER,Us.__webglFramebuffer);for(let Di=0;Di<Ht;Di++)Te&&(z.framebufferTextureLayer(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,Ot.get(R).__webglTexture,Q,ie+Di),z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,Ot.get(Z).__webglTexture,Tt,je+Di)),z.blitFramebuffer(ne,ce,It,Xt,ve,Oe,It,Xt,z.DEPTH_BUFFER_BIT,z.NEAREST);Gt.bindFramebuffer(z.READ_FRAMEBUFFER,null),Gt.bindFramebuffer(z.DRAW_FRAMEBUFFER,null)}else if(Q!==0||R.isRenderTargetTexture||Ot.has(R)){const Pn=Ot.get(R),mn=Ot.get(Z);Gt.bindFramebuffer(z.READ_FRAMEBUFFER,Zo),Gt.bindFramebuffer(z.DRAW_FRAMEBUFFER,Za);for(let rn=0;rn<Ht;rn++)Te?z.framebufferTextureLayer(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,Pn.__webglTexture,Q,ie+rn):z.framebufferTexture2D(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,Pn.__webglTexture,Q),Dn?z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,mn.__webglTexture,Tt,je+rn):z.framebufferTexture2D(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,mn.__webglTexture,Tt),Q!==0?z.blitFramebuffer(ne,ce,It,Xt,ve,Oe,It,Xt,z.COLOR_BUFFER_BIT,z.NEAREST):Dn?z.copyTexSubImage3D(We,Tt,ve,Oe,je+rn,ne,ce,It,Xt):z.copyTexSubImage2D(We,Tt,ve,Oe,ne,ce,It,Xt);Gt.bindFramebuffer(z.READ_FRAMEBUFFER,null),Gt.bindFramebuffer(z.DRAW_FRAMEBUFFER,null)}else Dn?R.isDataTexture||R.isData3DTexture?z.texSubImage3D(We,Tt,ve,Oe,je,It,Xt,Ht,ye,Wt,Pe.data):Z.isCompressedArrayTexture?z.compressedTexSubImage3D(We,Tt,ve,Oe,je,It,Xt,Ht,ye,Pe.data):z.texSubImage3D(We,Tt,ve,Oe,je,It,Xt,Ht,ye,Wt,Pe):R.isDataTexture?z.texSubImage2D(z.TEXTURE_2D,Tt,ve,Oe,It,Xt,ye,Wt,Pe.data):R.isCompressedTexture?z.compressedTexSubImage2D(z.TEXTURE_2D,Tt,ve,Oe,Pe.width,Pe.height,ye,Pe.data):z.texSubImage2D(z.TEXTURE_2D,Tt,ve,Oe,It,Xt,ye,Wt,Pe);z.pixelStorei(z.UNPACK_ROW_LENGTH,we),z.pixelStorei(z.UNPACK_IMAGE_HEIGHT,bn),z.pixelStorei(z.UNPACK_SKIP_PIXELS,Hi),z.pixelStorei(z.UNPACK_SKIP_ROWS,yn),z.pixelStorei(z.UNPACK_SKIP_IMAGES,Ka),Tt===0&&Z.generateMipmaps&&z.generateMipmap(We),Gt.unbindTexture()},this.initRenderTarget=function(R){Ot.get(R).__webglFramebuffer===void 0&&te.setupRenderTarget(R)},this.initTexture=function(R){R.isCubeTexture?te.setTextureCube(R,0):R.isData3DTexture?te.setTexture3D(R,0):R.isDataArrayTexture||R.isCompressedArrayTexture?te.setTexture2DArray(R,0):te.setTexture2D(R,0),Gt.unbindTexture()},this.resetState=function(){N=0,I=0,W=null,Gt.reset(),gt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ii}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=Le._getDrawingBufferColorSpace(t),i.unpackColorSpace=Le._getUnpackColorSpace()}}const J0={type:"change"},tp={type:"start"},Hv={type:"end"},Uc=new Wd,$0=new Va,zA=Math.cos(70*hM.DEG2RAD),_n=new tt,qn=2*Math.PI,ke={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},kh=1e-6;class IA extends JM{constructor(t,i=null){super(t,i),this.state=ke.NONE,this.target=new tt,this.cursor=new tt,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Ar.ROTATE,MIDDLE:Ar.DOLLY,RIGHT:Ar.PAN},this.touches={ONE:Tr.ROTATE,TWO:Tr.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new tt,this._lastQuaternion=new bs,this._lastTargetPosition=new tt,this._quat=new bs().setFromUnitVectors(t.up,new tt(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new A0,this._sphericalDelta=new A0,this._scale=1,this._panOffset=new tt,this._rotateStart=new fe,this._rotateEnd=new fe,this._rotateDelta=new fe,this._panStart=new fe,this._panEnd=new fe,this._panDelta=new fe,this._dollyStart=new fe,this._dollyEnd=new fe,this._dollyDelta=new fe,this._dollyDirection=new tt,this._mouse=new fe,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=FA.bind(this),this._onPointerDown=BA.bind(this),this._onPointerUp=HA.bind(this),this._onContextMenu=qA.bind(this),this._onMouseWheel=kA.bind(this),this._onKeyDown=jA.bind(this),this._onTouchStart=XA.bind(this),this._onTouchMove=WA.bind(this),this._onMouseDown=GA.bind(this),this._onMouseMove=VA.bind(this),this._interceptControlDown=YA.bind(this),this._interceptControlUp=ZA.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(J0),this.update(),this.state=ke.NONE}update(t=null){const i=this.object.position;_n.copy(i).sub(this.target),_n.applyQuaternion(this._quat),this._spherical.setFromVector3(_n),this.autoRotate&&this.state===ke.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let s=this.minAzimuthAngle,l=this.maxAzimuthAngle;isFinite(s)&&isFinite(l)&&(s<-Math.PI?s+=qn:s>Math.PI&&(s-=qn),l<-Math.PI?l+=qn:l>Math.PI&&(l-=qn),s<=l?this._spherical.theta=Math.max(s,Math.min(l,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(s+l)/2?Math.max(s,this._spherical.theta):Math.min(l,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let c=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const h=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),c=h!=this._spherical.radius}if(_n.setFromSpherical(this._spherical),_n.applyQuaternion(this._quatInverse),i.copy(this.target).add(_n),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let h=null;if(this.object.isPerspectiveCamera){const d=_n.length();h=this._clampDistance(d*this._scale);const m=d-h;this.object.position.addScaledVector(this._dollyDirection,m),this.object.updateMatrixWorld(),c=!!m}else if(this.object.isOrthographicCamera){const d=new tt(this._mouse.x,this._mouse.y,0);d.unproject(this.object);const m=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),c=m!==this.object.zoom;const p=new tt(this._mouse.x,this._mouse.y,0);p.unproject(this.object),this.object.position.sub(p).add(d),this.object.updateMatrixWorld(),h=_n.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;h!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(h).add(this.object.position):(Uc.origin.copy(this.object.position),Uc.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Uc.direction))<zA?this.object.lookAt(this.target):($0.setFromNormalAndCoplanarPoint(this.object.up,this.target),Uc.intersectPlane($0,this.target))))}else if(this.object.isOrthographicCamera){const h=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),h!==this.object.zoom&&(this.object.updateProjectionMatrix(),c=!0)}return this._scale=1,this._performCursorZoom=!1,c||this._lastPosition.distanceToSquared(this.object.position)>kh||8*(1-this._lastQuaternion.dot(this.object.quaternion))>kh||this._lastTargetPosition.distanceToSquared(this.target)>kh?(this.dispatchEvent(J0),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?qn/60*this.autoRotateSpeed*t:qn/60/60*this.autoRotateSpeed}_getZoomScale(t){const i=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*i)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,i){_n.setFromMatrixColumn(i,0),_n.multiplyScalar(-t),this._panOffset.add(_n)}_panUp(t,i){this.screenSpacePanning===!0?_n.setFromMatrixColumn(i,1):(_n.setFromMatrixColumn(i,0),_n.crossVectors(this.object.up,_n)),_n.multiplyScalar(t),this._panOffset.add(_n)}_pan(t,i){const s=this.domElement;if(this.object.isPerspectiveCamera){const l=this.object.position;_n.copy(l).sub(this.target);let c=_n.length();c*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*c/s.clientHeight,this.object.matrix),this._panUp(2*i*c/s.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/s.clientWidth,this.object.matrix),this._panUp(i*(this.object.top-this.object.bottom)/this.object.zoom/s.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,i){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const s=this.domElement.getBoundingClientRect(),l=t-s.left,c=i-s.top,h=s.width,d=s.height;this._mouse.x=l/h*2-1,this._mouse.y=-(c/d)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const i=this.domElement;this._rotateLeft(qn*this._rotateDelta.x/i.clientHeight),this._rotateUp(qn*this._rotateDelta.y/i.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let i=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(qn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),i=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-qn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),i=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(qn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),i=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-qn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),i=!0;break}i&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),s=.5*(t.pageX+i.x),l=.5*(t.pageY+i.y);this._rotateStart.set(s,l)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),s=.5*(t.pageX+i.x),l=.5*(t.pageY+i.y);this._panStart.set(s,l)}}_handleTouchStartDolly(t){const i=this._getSecondPointerPosition(t),s=t.pageX-i.x,l=t.pageY-i.y,c=Math.sqrt(s*s+l*l);this._dollyStart.set(0,c)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const s=this._getSecondPointerPosition(t),l=.5*(t.pageX+s.x),c=.5*(t.pageY+s.y);this._rotateEnd.set(l,c)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const i=this.domElement;this._rotateLeft(qn*this._rotateDelta.x/i.clientHeight),this._rotateUp(qn*this._rotateDelta.y/i.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),s=.5*(t.pageX+i.x),l=.5*(t.pageY+i.y);this._panEnd.set(s,l)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const i=this._getSecondPointerPosition(t),s=t.pageX-i.x,l=t.pageY-i.y,c=Math.sqrt(s*s+l*l);this._dollyEnd.set(0,c),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const h=(t.pageX+i.x)*.5,d=(t.pageY+i.y)*.5;this._updateZoomParameters(h,d)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let i=0;i<this._pointers.length;i++)if(this._pointers[i]==t.pointerId){this._pointers.splice(i,1);return}}_isTrackingPointer(t){for(let i=0;i<this._pointers.length;i++)if(this._pointers[i]==t.pointerId)return!0;return!1}_trackPointer(t){let i=this._pointerPositions[t.pointerId];i===void 0&&(i=new fe,this._pointerPositions[t.pointerId]=i),i.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const i=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[i]}_customWheelEvent(t){const i=t.deltaMode,s={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(i){case 1:s.deltaY*=16;break;case 2:s.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(s.deltaY*=10),s}}function BA(r){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(r.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(r)&&(this._addPointer(r),r.pointerType==="touch"?this._onTouchStart(r):this._onMouseDown(r)))}function FA(r){this.enabled!==!1&&(r.pointerType==="touch"?this._onTouchMove(r):this._onMouseMove(r))}function HA(r){switch(this._removePointer(r),this._pointers.length){case 0:this.domElement.releasePointerCapture(r.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Hv),this.state=ke.NONE;break;case 1:const t=this._pointers[0],i=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:i.x,pageY:i.y});break}}function GA(r){let t;switch(r.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case Ar.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(r),this.state=ke.DOLLY;break;case Ar.ROTATE:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=ke.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=ke.ROTATE}break;case Ar.PAN:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=ke.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=ke.PAN}break;default:this.state=ke.NONE}this.state!==ke.NONE&&this.dispatchEvent(tp)}function VA(r){switch(this.state){case ke.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(r);break;case ke.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(r);break;case ke.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(r);break}}function kA(r){this.enabled===!1||this.enableZoom===!1||this.state!==ke.NONE||(r.preventDefault(),this.dispatchEvent(tp),this._handleMouseWheel(this._customWheelEvent(r)),this.dispatchEvent(Hv))}function jA(r){this.enabled!==!1&&this._handleKeyDown(r)}function XA(r){switch(this._trackPointer(r),this._pointers.length){case 1:switch(this.touches.ONE){case Tr.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(r),this.state=ke.TOUCH_ROTATE;break;case Tr.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(r),this.state=ke.TOUCH_PAN;break;default:this.state=ke.NONE}break;case 2:switch(this.touches.TWO){case Tr.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(r),this.state=ke.TOUCH_DOLLY_PAN;break;case Tr.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(r),this.state=ke.TOUCH_DOLLY_ROTATE;break;default:this.state=ke.NONE}break;default:this.state=ke.NONE}this.state!==ke.NONE&&this.dispatchEvent(tp)}function WA(r){switch(this._trackPointer(r),this.state){case ke.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(r),this.update();break;case ke.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(r),this.update();break;case ke.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(r),this.update();break;case ke.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(r),this.update();break;default:this.state=ke.NONE}}function qA(r){this.enabled!==!1&&r.preventDefault()}function YA(r){r.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function ZA(r){r.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const zd=[[11,12],[11,13],[13,15],[12,14],[14,16],[11,23],[12,24],[23,24],[23,25],[25,27],[24,26],[26,28],[27,29],[29,31],[27,31],[28,30],[30,32],[28,32]],Or={knee:{label:"膝関節の屈曲",triples:{left:[23,25,27],right:[24,26,28]}},hip:{label:"股関節の屈曲（近似）",triples:{left:[11,23,25],right:[12,24,26]}},elbow:{label:"肘関節の屈曲",triples:{left:[11,13,15],right:[12,14,16]}},abduction:{label:"股関節の外転／内転（概算）",triples:{left:[11,23,25],right:[12,24,26]}}},Gv={knee:[0,180],hip:[0,180],elbow:[0,180],abduction:[-90,90]};function nn(r){return!!r&&Number.isFinite(r.x+r.y+r.z)&&r.visibility>=.5&&(r.presence??1)>=.5}function KA(r,t,i){if(![r,t,i].every(nn))return null;const s=[r.x-t.x,r.y-t.y,r.z-t.z],l=[i.x-t.x,i.y-t.y,i.z-t.z],c=Math.hypot(...s)*Math.hypot(...l);return c<1e-8?null:Math.acos(Math.max(-1,Math.min(1,s.reduce((h,d,m)=>h+d*l[m],0)/c)))*180/Math.PI}const tv=(r,t)=>({x:(r.x+t.x)/2,y:(r.y+t.y)/2,z:(r.z+t.z)/2}),jh=(r,t)=>({x:r.x-t.x,y:r.y-t.y,z:r.z-t.z}),QA=(r,t)=>r.x*t.x+r.y*t.y+r.z*t.z,ev=(r,t)=>({x:r.y*t.z-r.z*t.y,y:r.z*t.x-r.x*t.z,z:r.x*t.y-r.y*t.x}),zo=r=>{const t=Math.hypot(r.x,r.y,r.z);return t<1e-8?null:{x:r.x/t,y:r.y/t,z:r.z/t}};function JA(r,t){if(!(r!=null&&r.world))return null;const[i,s,l,c,h,d]=[11,12,23,24,25,26].map(M=>r.world[M]);if(![i,s,l,c,h,d].every(nn))return null;const m=zo(jh(tv(i,s),tv(l,c))),p=zo(jh(c,l));if(!m||!p)return null;const v=zo(ev(m,p));if(!v)return null;const g=zo(ev(v,m));if(!g)return null;const E=zo(jh(t==="left"?h:d,t==="left"?l:c));if(!E)return null;const b=QA(E,g)*(t==="left"?-1:1);return Math.asin(Math.max(-1,Math.min(1,b)))*180/Math.PI}function jc(r,t,i){if(t==="abduction")return JA(r,i);if(!(r!=null&&r.world))return null;const[s,l,c]=Or[t].triples[i].map(d=>r.world[d]);if(!s||!l||!c)return null;const h=KA(s,l,c);return h===null?null:180-h}function $A(r,t){return r!=null&&r.frames.length?r.frames[Math.min(r.frames.length-1,Math.max(0,Math.round(t*r.fps)))]??null:null}function t2(r){return r.map((t,i)=>{var s;return{...t,world:((s=t.world)==null?void 0:s.map((l,c)=>{var m,p,v,g;if(!nn(l))return l;const d=[(p=(m=r[i-1])==null?void 0:m.world)==null?void 0:p[c],l,(g=(v=r[i+1])==null?void 0:v.world)==null?void 0:g[c]].filter(x=>nn(x));return{...l,x:d.reduce((x,S)=>x+S.x,0)/d.length,y:d.reduce((x,S)=>x+S.y,0)/d.length,z:d.reduce((x,S)=>x+S.z,0)/d.length}}))??null}})}function Vv(r){const t=[11,12,13,14,15,16,23,24,25,26,27,28];return r!=null&&r.landmarks?t.reduce((i,s)=>i+r.landmarks[s].visibility,0)/t.length:0}function e2(r){const t=[];for(const c of r){if(!c.world||!c.landmarks)continue;const[h,d,m,p]=[11,12,23,24].map(M=>c.landmarks[M]),[v,g,x,S]=[11,12,23,24].map(M=>c.world[M]);if(![h,d,m,p].every(nn)||![v,g,x,S].every(nn))continue;const E=Math.hypot((h.x+d.x)/2-(m.x+p.x)/2,(h.y+d.y)/2-(m.y+p.y)/2),b=Math.hypot((v.x+g.x)/2-(x.x+S.x)/2,(v.y+g.y)/2-(x.y+S.y)/2,(v.z+g.z)/2-(x.z+S.z)/2);E>1e-4&&b>1e-4&&t.push(b/E)}if(!t.length)return r.map(()=>null);t.sort((c,h)=>c-h);const i=t[Math.floor(t.length/2)];let s=null,l=null;return r.map(c=>{if(c.world&&c.landmarks){const[h,d]=[23,24].map(m=>c.landmarks[m]);if(nn(h)&&nn(d)){const m={x:(h.x+d.x)/2,y:(h.y+d.y)/2};s??(s=m),l={x:(m.x-s.x)*i,y:-(m.y-s.y)*i}}}return l})}const nv={knee:"knee_flexion_deg",hip:"hip_approx_deg",elbow:"elbow_flexion_deg",abduction:"hip_abduction_approx_deg"};function n2(r){const t=["knee","hip","elbow","abduction"];return[["time_seconds","pose_detected",r.engine==="rtmpose-motionbert"?"mean_2d_detection_score":"mean_visibility",...t.flatMap(s=>[`left_${nv[s]}`,`right_${nv[s]}`])].join(","),...r.frames.map(s=>[s.time.toFixed(4),s.world?1:0,Vv(s).toFixed(4),...t.flatMap(l=>["left","right"].map(c=>{var h;return((h=jc(s,l,c))==null?void 0:h.toFixed(2))??""}))].join(","))].join(`
`)}const i2={11:.06,12:.06,23:.07,24:.07,13:.05,14:.05,25:.06,26:.06,15:.04,16:.04,27:.045,28:.045},a2=r=>i2[r]??.028,s2={1:.045,3:.045,2:.035,4:.035,8:.065,10:.065,9:.05,11:.05},r2=r=>s2[r]??.02,o2=[5,6,7];function l2(r){var c;const t=se.useRef(null),i=se.useRef(r),[s,l]=se.useState(!1);return i.current=r,se.useEffect(()=>{const h=t.current;let d;try{d=new PA({antialias:!0,alpha:!0})}catch{l(!0);return}d.setPixelRatio(Math.min(devicePixelRatio,2)),d.setClearColor(1250847,1),h.appendChild(d.domElement);const m=new FM;m.fog=new qd(1250847,5,14);const p=new _i(36,1,.01,40);p.position.set(2,1.2,4.2);const v=new IA(p,d.domElement);v.target.set(0,-.05,0),v.enableDamping=!0,v.minDistance=1.5,v.maxDistance=9,v.maxPolarAngle=Math.PI*.85,m.add(new WM(15263999,4014690,2.5));const g=new ZM(16777215,3);g.position.set(3,5,4),m.add(g);const x=new QM(16,52,4276565,2369846);x.position.y=-1,m.add(x);const S=new Bn(new Jd(.63,.635,80),new Fo({color:7958927,side:bi,transparent:!0,opacity:.6}));S.rotation.x=-Math.PI/2,S.position.y=-.995,m.add(S);const E=[new Rc({color:10787839,roughness:.4}),new Rc({color:12906385,roughness:.4}),new Rc({color:13422044,roughness:.45}),new Rc({color:16169576,emissive:7819296,roughness:.32})],b=new Io;m.add(b);const M=new Map,_=rt=>{const Rt=Math.round(rt*1e3);let Y=M.get(Rt);return Y||(Y=new kc(rt,16,14),M.set(Rt,Y)),Y},F=Array.from({length:33},(rt,Rt)=>{const Y=new Bn(_(a2(Rt)),E[Rt%2===1?0:1]);return b.add(Y),Y}),L=new Map,D=rt=>{const Rt=Math.round(rt*1e3);let Y=L.get(Rt);return Y||(Y=new Qd(rt,rt,1,12),L.set(Rt,Y)),Y},G=zd.map(([rt,Rt],Y)=>{if(o2.includes(Y))return null;const ut=new Bn(D(r2(Y)),E[rt%2===1&&Rt%2===1?0:rt%2===0&&Rt%2===0?1:2]);return b.add(ut),ut}),N=new kc(.1,24,20),I=new Bn(N,E[2]);b.add(I);const W=new Fn;W.setAttribute("position",new vi(new Float32Array(12),3)),W.setAttribute("color",new vi(new Float32Array([...new _e(10787839).toArray(),...new _e(12906385).toArray(),...new _e(12906385).toArray(),...new _e(10787839).toArray()]),3)),W.setIndex([0,1,2,0,2,3]);const U=new Fo({vertexColors:!0,transparent:!0,opacity:.5,side:bi}),w=new Bn(W,U);b.add(w);const V=new Kd(.1,20),J=()=>new Fo({color:329226,transparent:!0,opacity:0}),lt=[J(),J()].map(rt=>{const Rt=new Bn(V,rt);return Rt.rotation.x=-Math.PI/2,Rt.position.y=-.999,m.add(Rt),Rt}),ht=new Fn,dt=new Zd({color:12906385,transparent:!0,opacity:.55}),B=new Dv(ht,dt);m.add(B);let $=0,q="",Mt=null;const Ct=()=>{const{width:rt,height:Rt}=h.getBoundingClientRect();d.setSize(rt,Rt),p.aspect=rt/Math.max(1,Rt),p.updateProjectionMatrix()},P=new ResizeObserver(Ct);P.observe(h),Ct();function nt(rt,Rt){var z;const Y=rt.world[Rt],ut=rt.world[23],Ut=rt.world[24],Pt=(z=i.current.rootOffsets)==null?void 0:z.get(rt),zt=Y.x-(ut.x+Ut.x)/2+((Pt==null?void 0:Pt.x)??0),Ft=-Y.y+(ut.y+Ut.y)/2+((Pt==null?void 0:Pt.y)??0),re=-Y.z+(ut.z+Ut.z)/2;return new tt(zt,Ft,re).multiplyScalar(i.current.displayScale??1)}const Et=()=>{var Pt;$=requestAnimationFrame(Et);const{frame:rt,metric:Rt,view:Y,trails:ut,history:Ut}=i.current;if(Y!==q){const zt={free:[2,1.2,4.2],front:[0,.2,4.5],side:[4.5,.2,0],top:[0,4.5,.01]};p.position.fromArray(zt[Y]??zt.free),v.target.set(0,-.05,0),q=Y}if(b.visible=!!(rt!=null&&rt.world),lt.forEach(zt=>zt.visible=!!(rt!=null&&rt.world)),rt!=null&&rt.world){const zt=[Or[Rt].triples.left[1],Or[Rt].triples.right[1]];if(F.forEach((Ft,re)=>{Ft.visible=re>=11&&nn(rt.world[re]),Ft.visible&&(Ft.position.copy(nt(rt,re)),Ft.material=zt.includes(re)?E[3]:E[re%2===1?0:1],Ft.scale.setScalar(zt.includes(re)?1.45:1))}),G.forEach((Ft,re)=>{if(!Ft)return;const[z,oe]=zd[re];if(Ft.visible=nn(rt.world[z])&&nn(rt.world[oe]),Ft.visible){const ee=nt(rt,z),qt=nt(rt,oe),Gt=qt.clone().sub(ee);Ft.position.copy(ee.add(qt).multiplyScalar(.5)),Ft.scale.y=Gt.length(),Ft.quaternion.setFromUnitVectors(new tt(0,1,0),Gt.normalize())}}),rt.head){I.visible=nn(rt.head);const Ft=rt.head,re=rt.world[23],z=rt.world[24],oe=(Pt=i.current.rootOffsets)==null?void 0:Pt.get(rt);I.position.set(Ft.x-(re.x+z.x)/2+((oe==null?void 0:oe.x)??0),-Ft.y+(re.y+z.y)/2+((oe==null?void 0:oe.y)??0),-Ft.z+(re.z+z.z)/2).multiplyScalar(i.current.displayScale??1)}else I.visible=nn(rt.world[7])&&nn(rt.world[8]),I.visible&&I.position.copy(nt(rt,7).add(nt(rt,8)).multiplyScalar(.5));if(w.visible=[11,12,23,24].every(Ft=>nn(rt.world[Ft])),w.visible){const Ft=W.attributes.position;[11,12,24,23].forEach((re,z)=>{const oe=nt(rt,re);Ft.setXYZ(z,oe.x,oe.y,oe.z)}),Ft.needsUpdate=!0}[[27,29],[28,30]].forEach(([Ft,re],z)=>{const oe=nn(rt.world[Ft])?Ft:nn(rt.world[re])?re:-1,ee=lt[z].material;if(oe<0){ee.opacity=0;return}const qt=nt(rt,oe);lt[z].position.set(qt.x,-.999,qt.z),ee.opacity=Math.max(.04,Math.min(.42,.42-(qt.y+.995)*1.1))})}if(B.visible=ut,Ut!==Mt){const zt=[];for(let Ft=1;Ft<Ut.length;Ft++){const re=Ut[Ft-1],z=Ut[Ft];re.world&&z.world&&nn(re.world[28])&&nn(z.world[28])&&zt.push(...nt(re,28).toArray(),...nt(z,28).toArray())}ht.setAttribute("position",new $e(zt,3)),Mt=Ut}v.update(),d.render(m,p)};return Et(),()=>{cancelAnimationFrame($),P.disconnect(),v.dispose(),M.forEach(rt=>rt.dispose()),L.forEach(rt=>rt.dispose()),N.dispose(),W.dispose(),U.dispose(),V.dispose(),lt.forEach(rt=>rt.material.dispose()),E.forEach(rt=>rt.dispose()),x.geometry.dispose(),x.material.dispose(),S.geometry.dispose(),S.material.dispose(),ht.dispose(),dt.dispose(),d.dispose(),h.removeChild(d.domElement)}},[]),C.jsxs("div",{className:"scene-host",ref:t,children:[s&&C.jsx("p",{className:"scene-empty",children:"3D表示にはWebGL対応ブラウザが必要です。"}),!((c=r.frame)!=null&&c.world)&&!s&&C.jsxs("div",{className:"scene-empty",children:[C.jsx("span",{className:"empty-orbit",children:"◎"}),C.jsx("p",{children:r.frame?"このフレームは姿勢を検出できません":"3Dモーションを待っています"}),C.jsx("small",{children:r.frame?"コマ送りで前後のフレームを確認してください":"動画を解析すると、ここに動きを再現します"})]})]})}function c2({analysis:r,selected:t,time:i,onSeek:s}){const l=se.useRef(null),[c,h]=se.useState(900);se.useEffect(()=>{const N=l.current,I=new ResizeObserver(()=>h(Math.max(260,N.clientWidth-24)));return I.observe(N),()=>I.disconnect()},[]);const d=150,m=38,p=15,v=12,g=25,x=c-m-p,S=d-v-g,E=(r==null?void 0:r.duration)??3.45,[b,M]=Gv[t],_=Array.from({length:5},(N,I)=>b+(M-b)*I/4),F=N=>m+N/E*x,L=N=>v+S-(N-b)/(M-b)*S,D=N=>{let I=!1;return(r==null?void 0:r.frames.map(W=>{const U=jc(W,t,N);if(U===null)return I=!1,"";const w=I?"L":"M";return I=!0,`${w}${F(W.time).toFixed(1)},${L(U).toFixed(1)}`}).join(" "))??""},G=N=>{const I=N.currentTarget.getBoundingClientRect();s(Math.max(0,Math.min(E,((N.clientX-I.left)/I.width*c-m)/x*E)))};return C.jsxs("div",{className:"chart-wrap",ref:l,children:[C.jsxs("svg",{viewBox:`0 0 ${c} ${d}`,role:"img","aria-label":`${Or[t].label}の時系列。グラフをクリックして再生位置を変更`,onPointerDown:G,children:[_.map(N=>C.jsxs("g",{children:[C.jsx("line",{x1:m,y1:L(N),x2:c-p,y2:L(N),stroke:"#2a2d38",strokeDasharray:"3 5"}),C.jsxs("text",{x:m-10,y:L(N)+4,textAnchor:"end",fill:"#787e90",fontSize:"10",children:[Math.round(N),"°"]})]},N)),Array.from({length:7},(N,I)=>E*I/6).map(N=>C.jsxs("text",{x:F(N),y:d-5,textAnchor:"middle",fill:"#787e90",fontSize:"10",children:[N.toFixed(1),"s"]},N)),C.jsx("path",{d:D("left"),fill:"none",stroke:"#aa9bf7",strokeWidth:"2.4"}),C.jsx("path",{d:D("right"),fill:"none",stroke:"#c1e990",strokeWidth:"2.4"}),r&&C.jsxs(C.Fragment,{children:[C.jsx("line",{x1:F(i),x2:F(i),y1:v,y2:v+S,stroke:"#f0f0f3",strokeWidth:"1"}),C.jsx("circle",{cx:F(i),cy:v,r:"3",fill:"#f0f0f3"})]})]}),!r&&C.jsx("span",{className:"chart-placeholder",children:"解析後に関節角度の変化が表示されます"})]})}function iv(r,t,i){return new Promise((s,l)=>{const c=setTimeout(()=>p(new Error("動画の読み込みがタイムアウトしました。H.264形式のMP4で再試行してください。")),15e3),h=()=>p(),d=()=>p(new Error("この動画形式をブラウザで読み込めません。H.264形式のMP4に変換してください。")),m=()=>p(new DOMException("中止しました","AbortError"));function p(v){clearTimeout(c),r.removeEventListener(t,h),r.removeEventListener("error",d),i.removeEventListener("abort",m),v?l(v):s()}r.addEventListener(t,h,{once:!0}),r.addEventListener("error",d,{once:!0}),i.addEventListener("abort",m,{once:!0}),i.aborted&&m()})}async function u2(r,t,i,s,l){const c=document.createElement("video");c.muted=!0,c.preload="auto",c.playsInline=!0;const h=new Worker("/pose-worker.js"),d=(m,p=[])=>new Promise((v,g)=>{const x=setTimeout(()=>M(new Error("推定処理がタイムアウトしました。ページを再読み込みして再試行してください。")),9e4),S=()=>M(new DOMException("中止しました","AbortError")),E=_=>M(new Error(_.message||"推定モデルを読み込めませんでした。npm run setup を実行してください。")),b=({data:_})=>_.type==="error"?M(new Error(_.message)):M(void 0,_);function M(_,F){clearTimeout(x),h.removeEventListener("message",b),h.removeEventListener("error",E),s.removeEventListener("abort",S),_?g(_):v(F)}h.addEventListener("message",b),h.addEventListener("error",E),s.addEventListener("abort",S,{once:!0}),s.aborted?S():h.postMessage(m,p)});try{l(0,"推定モデルを準備しています");const m=iv(c,"loadeddata",s);if(c.src=r,await m,!Number.isFinite(c.duration)||c.duration<=0||c.duration>120)throw new Error("解析できる動画は2分以内です。短く切り出して読み込んでください。");await d({type:"init"});const p=c.duration,v=[],g=Math.ceil(p*i),x=document.createElement("canvas"),S=Math.min(1,1280/c.videoWidth);x.width=Math.round(c.videoWidth*S),x.height=Math.round(c.videoHeight*S);const E=x.getContext("2d");for(let b=0;b<g;b++){if(s.aborted)throw new DOMException("中止しました","AbortError");const M=b/i;if(Math.abs(c.currentTime-M)>1e-4){const L=iv(c,"seeked",s);c.currentTime=M,await L}E.drawImage(c,0,0,x.width,x.height);const _=await createImageBitmap(x),F=await d({type:"frame",bitmap:_,time:M},[_]);v.push(F.frame),l((b+1)/g,`姿勢を推定しています · ${b+1} / ${g} フレーム`)}if(!v.some(b=>b.world))throw new Error("人物を検出できませんでした。全身が大きく写った、明るい動画を使用してください。");return{version:1,name:t,duration:p,fps:i,frames:v,createdAt:new Date().toISOString()}}finally{h.terminate(),c.removeAttribute("src"),c.load()}}function av(r,t,i){return new Promise((s,l)=>{const c=setTimeout(()=>p(new Error("動画の読み込みがタイムアウトしました。H.264形式のMP4で再試行してください。")),15e3),h=()=>p(),d=()=>p(new Error("この動画形式をブラウザで読み込めません。H.264形式のMP4に変換してください。")),m=()=>p(new DOMException("中止しました","AbortError"));function p(v){clearTimeout(c),r.removeEventListener(t,h),r.removeEventListener("error",d),i.removeEventListener("abort",m),v?l(v):s()}r.addEventListener(t,h,{once:!0}),r.addEventListener("error",d,{once:!0}),i.addEventListener("abort",m,{once:!0}),i.aborted&&m()})}async function f2(r,t,i,s,l,c){const h=document.createElement("video");h.muted=!0,h.preload="auto",h.playsInline=!0;const d=new Worker(new URL("/stride-motion-lab/assets/precision-worker-CLPpI44J.js",import.meta.url),{type:"module"});let m=null;const p=()=>{m&&d.removeEventListener("message",m),d.terminate()},v=(g,x,S,E,b)=>new Promise((M,_)=>{const F=setTimeout(()=>N(new Error(b)),E),L=()=>N(new DOMException("中止しました","AbortError")),D=I=>N(new Error(I.message||"モデルの読み込みに失敗しました。ページを再読み込みして再試行してください。")),G=I=>{const W=I.data;if(W.type==="error"){N(new Error(W.message));return}S(W)&&N(void 0,W)};function N(I,W){clearTimeout(F),d.removeEventListener("message",G),d.removeEventListener("error",D),l.removeEventListener("abort",L),I?_(I):M(W)}d.addEventListener("message",G),d.addEventListener("error",D),l.addEventListener("abort",L,{once:!0}),l.aborted?L():d.postMessage(g,x)});try{c(0,"ブラウザ内でRTMPose + MotionBERTを準備しています（初回はモデルのダウンロードに時間がかかります）");const g=av(h,"loadeddata",l);if(h.src=r,await g,!Number.isFinite(h.duration)||h.duration<=0||h.duration>120)throw new Error("解析できる動画は2分以内です。短く切り出して読み込んでください。");await v({type:"init",poseSize:s},[],L=>L.type==="ready",12e4,"モデルの読み込みがタイムアウトしました。回線を確認して再試行してください。");const x=h.duration,S=Math.ceil(x*i),E=document.createElement("canvas");E.width=h.videoWidth,E.height=h.videoHeight;const b=E.getContext("2d");for(let L=0;L<S;L++){if(l.aborted)throw new DOMException("中止しました","AbortError");const D=L/i;if(Math.abs(h.currentTime-D)>1e-4){const N=av(h,"seeked",l);h.currentTime=D,await N}b.drawImage(h,0,0);const G=await createImageBitmap(E);await v({type:"frame",bitmap:G,index:L},[G],N=>N.type==="frameDone"&&N.index===L,6e4,"推定処理がタイムアウトしました。ページを再読み込みして再試行してください。"),c((L+1)/S*.85,`RTMPose · 元解像度から人物を推定 ${L+1} / ${S}`)}m=L=>{const D=L.data;D.type==="progress"&&D.phase==="motionbert"&&c(.85+D.fraction*.14,"MotionBERT · 前後フレームから3Dを推定")},d.addEventListener("message",m);const F=(await v({type:"finalize",fps:i,name:t,duration:x,nativeFps:0},[],L=>L.type==="result",18e4,"3D推定の仕上げ処理がタイムアウトしました。")).result;if(!F.frames.some(L=>L.world))throw new Error("人物を検出できませんでした。全身が大きく写った、明るい動画を使用してください。");return c(1,"RTMPose + MotionBERT の解析が完了しました（ブラウザ内で処理）"),F}finally{p(),h.removeAttribute("src"),h.load()}}async function h2(r,t,i,s,l){const c=new FormData;if(c.append("fps",String(i)),l(0,"元解像度の動画をローカル推定エンジンへ読み込んでいます"),r==="/sample/hurdle.mp4")c.append("sample","true");else{const m=await(await fetch(r,{signal:s})).blob();c.append("file",m,t)}let h;const d=()=>{h&&fetch(`/api/precision/jobs/${h}`,{method:"DELETE",headers:{"x-stride-client":"1"}}).catch(()=>{})};s.addEventListener("abort",d,{once:!0});try{const m=await fetch("/api/precision/jobs",{method:"POST",headers:{"x-stride-client":"1"},body:c,signal:s}),p=await m.json();if(!m.ok)throw new Error(p.detail??"解析を開始できませんでした");if(h=p.id,s.aborted)throw d(),new DOMException("中止しました","AbortError");const v=Date.now()+1800*1e3;for(;Date.now()<v;){const g=await fetch(`/api/precision/jobs/${h}`,{signal:s}),x=await g.json();if(!g.ok)throw new Error(x.detail??"解析状態を読み込めませんでした");if(l(x.progress,x.message),x.state==="complete")return x.result;if(x.state==="error")throw new Error(x.message);if(x.state==="cancelled")throw new DOMException("中止しました","AbortError");await new Promise((S,E)=>{const b=()=>{clearTimeout(M),E(new DOMException("中止しました","AbortError"))},M=setTimeout(()=>{s.removeEventListener("abort",b),S()},500);s.addEventListener("abort",b,{once:!0}),s.aborted&&b()})}throw d(),new Error("解析がタイムアウトしました。短い区間に切り出して再試行してください。")}finally{s.removeEventListener("abort",d)}}async function d2(r,t,i,s,l){const c=await fetch("/api/precision/health",{signal:s}).catch(()=>null);return c!=null&&c.ok&&(await c.json()).ready?h2(r,t,i,s,l):f2(r,t,i,"m",s,l)}const Xh="/sample/hurdle.mp4",Wh=r=>r===null?"—":Math.round(r).toString();function sv(r,t,i){const s=URL.createObjectURL(new Blob([r],{type:i})),l=document.createElement("a");l.href=s,l.download=t,l.click(),setTimeout(()=>URL.revokeObjectURL(s),1e3)}function p2(){const[r,t]=se.useState("rtmpose-motionbert"),i=se.useRef({}),[s,l]=se.useState(""),[c,h]=se.useState(""),[d,m]=se.useState(0),[p,v]=se.useState({width:1280,height:720}),[g,x]=se.useState(null),[S,E]=se.useState(0),[b,M]=se.useState(!1),[_,F]=se.useState(.5),[L,D]=se.useState(!1),[G,N]=se.useState(0),[I,W]=se.useState(""),[U,w]=se.useState(""),[V,J]=se.useState("knee"),[lt,ht]=se.useState("free"),[dt,B]=se.useState(!0),[$,q]=se.useState(!0),[Mt,Ct]=se.useState(!1),[P,nt]=se.useState(30),[Et,rt]=se.useState(!1),[Rt,Y]=se.useState(!1),[ut,Ut]=se.useState(!1),[Pt,zt]=se.useState(!1),[Ft,re]=se.useState(""),z=se.useRef(null),oe=se.useRef(null),ee=se.useRef(null),qt=se.useRef(null),Gt=se.useRef(null),xe=se.useRef(0),Ot=se.useMemo(()=>g?{...g,frames:$?t2(g.frames):g.frames}:null,[g,$]),te=$A(Ot,S),Qe=se.useMemo(()=>(Ot==null?void 0:Ot.frames.filter(j=>j.time<=S&&j.time>S-.5))??[],[Ot,S]),qe=se.useMemo(()=>{if(!Et||!Ot)return null;const j=e2(Ot.frames),gt=new Map;return Ot.frames.forEach((Yt,k)=>{j[k]&&gt.set(Yt,j[k])}),gt},[Et,Ot]),O=(g==null?void 0:g.frames.filter(j=>j.world).length)??0,T=Vv(te),et=(g==null?void 0:g.engine)==="rtmpose-motionbert";se.useEffect(()=>{},[]),se.useEffect(()=>()=>{var j;(j=qt.current)==null||j.abort(),Gt.current&&URL.revokeObjectURL(Gt.current)},[]),se.useEffect(()=>{z.current&&(z.current.playbackRate=_)},[_,s]),se.useEffect(()=>{let j;const gt=()=>{z.current&&!z.current.paused&&E(z.current.currentTime),j=requestAnimationFrame(gt)};return j=requestAnimationFrame(gt),()=>cancelAnimationFrame(j)},[]),se.useEffect(()=>{const j=oe.current;if(!j)return;const gt=j.getContext("2d");if(gt.clearRect(0,0,j.width,j.height),!dt||!(te!=null&&te.landmarks))return;const Yt=te.landmarks;gt.lineWidth=3,gt.lineCap="round",zd.forEach(([k,St])=>{!nn(Yt[k])||!nn(Yt[St])||(gt.strokeStyle=k%2?"#b5a3ff":"#c3f291",gt.beginPath(),gt.moveTo(Yt[k].x*j.width,Yt[k].y*j.height),gt.lineTo(Yt[St].x*j.width,Yt[St].y*j.height),gt.stroke())}),Yt.forEach((k,St)=>{St<11||!nn(k)||(gt.fillStyle=St%2?"#c7baff":"#d4ffa7",gt.beginPath(),gt.arc(k.x*j.width,k.y*j.height,4,0,Math.PI*2),gt.fill())})},[te,dt,p]);const mt=j=>{const gt=Math.max(0,Math.min(d,j));z.current&&(z.current.currentTime=gt),E(gt)},At=()=>{const j=z.current;j&&(j.paused?(j.ended&&mt(0),j.play().catch(()=>w("動画を再生できません。別形式のMP4をお試しください。"))):j.pause())},pt=(j,gt)=>{var Yt,k;xe.current++,(Yt=qt.current)==null||Yt.abort(),(k=z.current)==null||k.pause(),D(!1),l(j),h(gt),x(null),i.current={},E(0),M(!1),w(""),re(""),m(0)},Qt=j=>{if(!j.type.startsWith("video/")&&!/\.(mp4|mov|webm|m4v)$/i.test(j.name)){w("MP4、MOV、WebM形式の動画を選んでください。");return}if(j.size>500*1024*1024){w("動画は500MB以下にしてください。");return}Gt.current&&URL.revokeObjectURL(Gt.current),Gt.current=URL.createObjectURL(j),pt(Gt.current,j.name)},Nt=async j=>{if(xe.current++,t(j),w(""),re(""),x(i.current[j]??null),s===Xh&&!i.current[j]){const gt=xe.current;try{const k=await(await fetch(j==="mediapipe"?"/sample/analysis.json":"/sample/analysis-precision.json")).json();gt===xe.current&&k.version===1&&(i.current[j]=k,x(k))}catch{}}},Zt=async()=>{var Yt,k;if(L)return;xe.current++;const j=xe.current;(Yt=z.current)==null||Yt.pause();const gt=new AbortController;qt.current=gt,D(!0),N(0),w(""),re("");try{const St=await(r==="rtmpose-motionbert"?d2:u2)(s,c,P,gt.signal,(Lt,Vt)=>{j===xe.current&&(N(Lt),W(Vt))});j===xe.current&&(x(St),i.current[r]=St,mt(((k=St.frames.find(Lt=>Lt.world))==null?void 0:k.time)??0),re(`${St.frames.filter(Lt=>Lt.world).length} / ${St.frames.length} フレームの姿勢を推定しました`))}catch(St){j===xe.current&&(St instanceof DOMException&&St.name==="AbortError"?re("解析を中止しました"):w(St instanceof Error?St.message:String(St)))}finally{j===xe.current&&D(!1)}},Kt=j=>{if(!g)return;const gt=Ot,Yt=c.replace(/\.[^.]+$/,"");j==="csv"?sv("\uFEFF"+n2(gt),`${Yt}-angles${$?"-smoothed":""}.csv`,"text/csv;charset=utf-8"):sv(JSON.stringify({...g,coordinates:et?"MotionBERT H36M17: hip-centered, relative units, x right / y down / z away; displayScale is visualization only":"MediaPipe world landmarks: hip-centered, meters, x right / y down / z away from camera",smoothing:"none (raw inference)"},null,2),`${Yt}-3d.json`,"application/json"),Ut(!1)},bt=se.useMemo(()=>{if(!Ot)return null;const j=Ot.frames.map(gt=>jc(gt,V,"left")).filter(gt=>gt!==null);return j.length?{min:Math.min(...j),max:Math.max(...j)}:null},[Ot,V]),[Dt,$t]=Gv[V];return C.jsxs("div",{className:"app-shell",children:[C.jsxs("aside",{className:"sidebar",children:[C.jsxs("a",{className:"brand",href:"#","aria-label":"STRIDE ホーム",children:[C.jsx(sc,{size:25,strokeWidth:2.5}),C.jsxs("span",{children:["STRIDE",C.jsx("span",{className:"brand-dot",children:"."})]})]}),C.jsx("div",{className:"workspace-label",children:"MOTION WORKSPACE"}),C.jsxs("button",{className:"nav-item active",onClick:()=>{var j;return(j=document.getElementById("workspace"))==null?void 0:j.scrollIntoView({behavior:"smooth"})},children:[C.jsx(X_,{size:18}),"モーション解析",C.jsx("span",{className:"nav-indicator"})]}),C.jsxs("button",{className:"nav-item",onClick:()=>{var j;return(j=ee.current)==null?void 0:j.click()},children:[C.jsx(mS,{size:18}),"動画を読み込む"]}),C.jsxs("button",{className:"nav-item",onClick:()=>Y(!0),children:[C.jsx(ch,{size:18}),"使い方ガイド"]}),C.jsx("div",{className:"sidebar-divider"}),!1,C.jsxs("div",{className:"sidebar-bottom",children:[C.jsxs("div",{className:"local-badge",children:[C.jsx("span",{}),C.jsxs("span",{children:["共有サーバーで解析",C.jsx("small",{children:"RTMPoseは解析後に動画を削除"})]}),C.jsx(Y_,{size:17})]}),C.jsxs("div",{className:"profile",children:[C.jsx("span",{className:"avatar",children:"S"}),C.jsxs("span",{children:["Personal workspace",C.jsx("small",{children:"3D Motion Lab"})]})]})]})]}),C.jsxs("main",{id:"workspace",children:[C.jsxs("header",{className:"topbar",children:[C.jsxs("div",{className:"breadcrumb",children:["ワークスペース ",C.jsx("span",{children:"/"})," ",C.jsx("strong",{children:"モーション解析"})]}),C.jsx("span",{className:"version-badge",children:"BETA 1.0"}),C.jsx("button",{className:"icon-button","aria-label":"使い方",onClick:()=>Y(!0),children:C.jsx(ch,{size:18})})]}),C.jsxs("div",{className:"main-content",children:[C.jsxs("div",{className:"page-heading",children:[C.jsxs("div",{children:[C.jsxs("div",{className:"eyebrow",children:[C.jsx("span",{})," VIDEO TO MOVEMENT"]}),C.jsx("h1",{children:"動きを、立体で読み解く。"}),C.jsx("p",{children:"動画から身体の動きを3Dで再現。見えなかった一瞬を、解析する。"})]}),C.jsxs("button",{className:"primary upload-top",onClick:()=>{var j;return(j=ee.current)==null?void 0:j.click()},disabled:L,children:[C.jsx(xS,{size:17}),"動画をアップロード"]})]}),C.jsx("input",{ref:ee,type:"file",accept:"video/*,.mov,.mp4,.webm",hidden:!0,onChange:j=>{var gt;(gt=j.target.files)!=null&&gt[0]&&Qt(j.target.files[0]),j.target.value=""}}),C.jsxs("div",{className:"workflow",children:[C.jsxs("span",{className:`workflow-step ${s?"complete":"current"}`,children:[C.jsx("span",{children:s?C.jsx(lh,{size:12}):1}),"動画をアップロード"]}),C.jsx("div",{}),C.jsxs("span",{className:`workflow-step ${g?"complete":s?"current":""}`,children:[C.jsx("span",{children:g?C.jsx(lh,{size:12}):2}),"3D姿勢を推定"]}),C.jsx("div",{}),C.jsxs("span",{className:`workflow-step ${g?"current":""}`,children:[C.jsx("span",{children:"3"}),"動作を解析"]}),C.jsxs("span",{className:"workflow-note",children:[C.jsx(Y_,{size:13}),"動画は解析後に削除"]})]}),C.jsxs("section",{className:"engine-bar","aria-label":"推定方式を選択",children:[C.jsxs("div",{children:[C.jsx("span",{className:"eyebrow",children:"POSE ENGINE"}),C.jsx("strong",{children:"同じ動きを、モデルで見比べる"})]}),C.jsxs("div",{className:"engine-options",children:[C.jsxs("button",{className:r==="rtmpose-motionbert"?"selected":"",disabled:L,onClick:()=>void Nt("rtmpose-motionbert"),children:[C.jsx(Z_,{size:14}),C.jsxs("span",{children:["RTMPose + MotionBERT",C.jsx("small",{children:"人物を切り出し · 前後フレームで3D推定"})]})]}),C.jsxs("button",{className:r==="mediapipe"?"selected":"",disabled:L,onClick:()=>void Nt("mediapipe"),children:[C.jsx(sc,{size:14}),C.jsxs("span",{children:["MediaPipe",C.jsx("small",{children:"従来の推定と比較"})]})]})]}),C.jsxs("p",{children:[r==="rtmpose-motionbert"?"共有の推定サーバーで処理。2D検出26点 → 3D骨格17点。":"ブラウザ内で処理。33点を各フレームから推定。",et&&(g!=null&&g.sourceWidth)?` 入力 ${g.sourceWidth} × ${g.sourceHeight}`:""]})]}),C.jsxs("section",{className:`source-bar ${Pt?"dragging":""}`,onDragOver:j=>{j.preventDefault(),zt(!0)},onDragLeave:()=>zt(!1),onDrop:j=>{j.preventDefault(),zt(!1),!L&&j.dataTransfer.files[0]&&Qt(j.dataTransfer.files[0])},children:[C.jsxs("div",{className:"file-thumbnail",children:[s===Xh?C.jsx("img",{src:"/sample/poster.jpg",alt:"ハードル走の動画サムネイル"}):C.jsx(dS,{size:25}),C.jsx("span",{children:C.jsx(q_,{size:9,fill:"currentColor"})})]}),C.jsxs("div",{className:"file-info",children:[C.jsx("strong",{children:c||"動画が選択されていません"}),C.jsxs("span",{children:[s?d?`${d.toFixed(2)} 秒`:"読み込み中":"動画をアップロードしてください",C.jsx("b",{children:"·"}),s===Xh?"ハードル走 / 参考動画":s?"アップロード動画":"MP4 / MOV / WebM",C.jsx("b",{children:"·"}),"RTMPoseは共有サーバーで処理"]})]}),C.jsxs("button",{className:"text-button replace",onClick:()=>{var j;return(j=ee.current)==null?void 0:j.click()},disabled:L,children:[C.jsx(ES,{size:14}),"変更"]}),C.jsx("div",{className:"source-divider"}),C.jsxs("label",{className:"fps-select",children:[C.jsx("span",{children:"解析フレームレート"}),C.jsxs("select",{value:P,onChange:j=>nt(Number(j.target.value)),disabled:L,children:[C.jsx("option",{value:15,children:"15 fps"}),C.jsx("option",{value:30,children:"30 fps"}),C.jsx("option",{value:60,children:"60 fps"})]})]}),C.jsxs("button",{className:"primary analyze-button",onClick:Zt,disabled:L||!d||d>120,children:[L?C.jsx(W_,{size:16,className:"spin"}):C.jsx(Z_,{size:16})," ",L?"解析中…":g?"再解析する":"3D推定を開始",!L&&C.jsx(rc,{size:15})]})]}),L&&C.jsxs("div",{className:"progress-panel",role:"status",children:[C.jsxs("div",{children:[C.jsx(W_,{size:15,className:"spin"}),I,C.jsxs("strong",{children:[Math.round(G*100),"%"]}),C.jsx("button",{onClick:()=>{var j;return(j=qt.current)==null?void 0:j.abort()},children:"中止"})]}),C.jsx("progress",{max:1,value:G})]}),U&&C.jsxs("div",{className:"message error",role:"alert",children:[U,C.jsx("button",{"aria-label":"エラーを閉じる",onClick:()=>w(""),children:C.jsx(uh,{size:15})})]}),Ft&&C.jsxs("div",{className:"message success",role:"status",children:[C.jsx(lh,{size:15}),Ft,C.jsx("button",{"aria-label":"通知を閉じる",onClick:()=>re(""),children:C.jsx(uh,{size:15})})]}),C.jsxs("div",{className:"analysis-layout",children:[C.jsxs("div",{className:"visuals",children:[C.jsxs("section",{className:"panel video-panel",children:[C.jsxs("div",{className:"panel-header",children:[C.jsxs("h2",{children:[C.jsx(pS,{size:16}),"オリジナル動画"]}),C.jsx("span",{className:"panel-tag",children:"SOURCE"})]}),C.jsxs("div",{className:"video-stage",children:[C.jsxs("div",{className:"video-inner",children:[C.jsx("video",{ref:z,src:s||void 0,playsInline:!0,muted:!0,preload:"auto",onLoadedMetadata:j=>{const gt=j.currentTarget;m(gt.duration),gt.playbackRate=_,v({width:gt.videoWidth,height:gt.videoHeight})},onTimeUpdate:j=>E(j.currentTarget.currentTime),onSeeked:j=>E(j.currentTarget.currentTime),onPlay:()=>M(!0),onPause:()=>M(!1),onEnded:()=>M(!1),onError:()=>w("動画を読み込めません。MOVが再生できない場合はH.264形式のMP4に変換してください。")}),C.jsx("canvas",{ref:oe,className:"pose-overlay",width:p.width,height:p.height})]}),C.jsxs("span",{className:"stage-label",children:[C.jsx("span",{className:g?"green-dot":"gray-dot"}),g?"POSE OVERLAY":"ORIGINAL VIDEO"]}),C.jsx("button",{className:"stage-expand","aria-label":"動画を全画面表示",onClick:()=>{var j;return(j=z.current)==null?void 0:j.requestFullscreen().catch(()=>re("このブラウザでは全画面表示を利用できません"))},children:C.jsx(_S,{size:15})}),C.jsxs("span",{className:"time-badge",children:[S.toFixed(2)," s"]})]}),C.jsxs("div",{className:"panel-footer",children:[C.jsxs("span",{children:[C.jsx("span",{className:"legend-dot purple"}),"左半身",C.jsx("span",{className:"legend-dot lime"}),"右半身"]}),C.jsxs("label",{className:"toggle-label",children:["骨格を重ねる",C.jsx("input",{type:"checkbox",checked:dt,onChange:j=>B(j.target.checked)}),C.jsx("i",{})]})]})]}),C.jsxs("section",{className:"panel model-panel",children:[C.jsxs("div",{className:"panel-header",children:[C.jsxs("h2",{children:[C.jsx(X_,{size:16}),"3Dモーション"]}),C.jsx("span",{className:"panel-tag accent",children:Et?"GROUND TRACKED":"HIP-CENTERED"})]}),C.jsxs("div",{className:"model-stage",children:[C.jsx(l2,{frame:te,metric:V,view:lt,trails:Mt,history:Qe,displayScale:Ot==null?void 0:Ot.displayScale,rootOffsets:qe}),C.jsx("div",{className:"view-switch",children:[["free","自由"],["front","正面"],["side","側面"],["top","上面"]].map(([j,gt])=>C.jsx("button",{className:lt===j?"selected":"",onClick:()=>ht(j),children:gt},j))}),C.jsxs("span",{className:"axis-label",children:[C.jsx("span",{children:"Y"}),C.jsx("span",{children:"Z"}),C.jsx("span",{children:"X"})]}),C.jsx("span",{className:"model-hint",children:"ドラッグで回転 · スクロールで拡大"})]}),C.jsxs("div",{className:"panel-footer",children:[C.jsxs("span",{children:[C.jsx(hS,{size:13}),Et?"固定カメラの移動を表示（概算）":"腰中心の相対座標"]}),C.jsxs("label",{className:"toggle-label",children:["足首の軌跡",C.jsx("input",{type:"checkbox",checked:Mt,onChange:j=>Ct(j.target.checked)}),C.jsx("i",{})]}),C.jsxs("label",{className:"toggle-label",title:"カメラが動いていない動画でのみ有効にしてください。追いかけ動画で使うと、カメラの動きを身体の移動として誤表示します。",children:["固定カメラで撮影",C.jsx("input",{type:"checkbox",checked:Et,onChange:j=>rt(j.target.checked)}),C.jsx("i",{})]})]})]}),C.jsxs("section",{className:"playback panel",children:[C.jsxs("div",{className:"transport",children:[C.jsx("button",{className:"icon-button","aria-label":"先頭に戻る",onClick:()=>mt(0),children:C.jsx(MS,{size:16})}),C.jsx("button",{className:"icon-button","aria-label":"1フレーム戻る",onClick:()=>{var j;(j=z.current)==null||j.pause(),mt(S-1/((g==null?void 0:g.fps)??P))},children:C.jsx(uS,{size:15})}),C.jsx("button",{className:"play-button","aria-label":b?"一時停止":"再生",onClick:At,children:b?C.jsx(vS,{size:17,fill:"currentColor"}):C.jsx(q_,{size:17,fill:"currentColor"})}),C.jsx("button",{className:"icon-button","aria-label":"1フレーム進む",onClick:()=>{var j;(j=z.current)==null||j.pause(),mt(S+1/((g==null?void 0:g.fps)??P))},children:C.jsx(rc,{size:15})}),C.jsxs("span",{className:"transport-time",children:[S.toFixed(2),C.jsxs("small",{children:[" / ",d.toFixed(2)," s"]})]}),C.jsx("label",{className:"speed-label",children:C.jsxs("select",{"aria-label":"再生速度",value:_,onChange:j=>F(Number(j.target.value)),children:[C.jsx("option",{value:.25,children:"0.25×"}),C.jsx("option",{value:.5,children:"0.5×"}),C.jsx("option",{value:1,children:"1×"}),C.jsx("option",{value:2,children:"2×"})]})}),C.jsxs("span",{className:"sync-label",children:[C.jsx("span",{}),"同期再生"]})]}),C.jsx("input",{className:"timeline",type:"range",min:0,max:d||1,step:.001,value:S,onChange:j=>mt(Number(j.target.value)),"aria-label":"再生位置",style:{"--progress":`${S/(d||1)*100}%`}}),C.jsxs("div",{className:"timeline-ticks",children:[C.jsx("span",{children:"0.00s"}),C.jsxs("span",{children:[(d*.25).toFixed(2),"s"]}),C.jsxs("span",{children:[(d*.5).toFixed(2),"s"]}),C.jsxs("span",{children:[(d*.75).toFixed(2),"s"]}),C.jsxs("span",{children:[d.toFixed(2),"s"]})]})]}),C.jsxs("section",{className:"panel chart-panel",children:[C.jsxs("div",{className:"panel-header",children:[C.jsxs("h2",{children:[C.jsx(sc,{size:16}),"関節角度の変化"]}),C.jsxs("div",{className:"chart-legend",children:[C.jsxs("span",{children:[C.jsx("i",{className:"legend-dot purple"}),"左"]}),C.jsxs("span",{children:[C.jsx("i",{className:"legend-dot lime"}),"右"]}),C.jsx("span",{className:"chart-unit",children:V==="abduction"?"外転(+) / 内転(−) / °":"屈曲角度 / °"})]})]}),C.jsxs("div",{className:"chart-tabs",children:[Object.keys(Or).map(j=>C.jsx("button",{className:V===j?"selected":"",onClick:()=>J(j),children:j==="knee"?"膝関節":j==="hip"?"股関節":j==="elbow"?"肘関節":"股関節（外転）"},j)),C.jsx("span",{children:"グラフをクリックして、その瞬間へ"})]}),C.jsx(c2,{analysis:Ot,selected:V,time:S,onSeek:mt})]})]}),C.jsxs("aside",{className:"inspector",children:[C.jsxs("section",{className:"panel metrics-panel",children:[C.jsxs("div",{className:"panel-header",children:[C.jsxs("h2",{children:[C.jsx(yS,{size:16}),"動作インサイト"]}),C.jsx("span",{className:"live-dot"})]}),C.jsxs("div",{className:"inspector-content",children:[C.jsxs("div",{className:"current-frame",children:[C.jsx("span",{children:"CURRENT FRAME"}),C.jsxs("strong",{children:[S.toFixed(2),C.jsx("small",{children:"s"})]})]}),C.jsxs("div",{className:"joint-select",children:[C.jsx("label",{htmlFor:"joint",children:"注目する関節"}),C.jsx("select",{id:"joint",value:V,onChange:j=>J(j.target.value),children:Object.entries(Or).map(([j,gt])=>C.jsx("option",{value:j,children:gt.label},j))})]}),C.jsx("div",{className:"angle-values",children:["left","right"].map(j=>{const gt=jc(te,V,j);return C.jsxs("div",{children:[C.jsxs("span",{children:[C.jsx("i",{className:`legend-dot ${j==="left"?"purple":"lime"}`}),j==="left"?"左":"右",V==="knee"?"膝":V==="hip"?"股関節":V==="elbow"?"肘":"股関節"]}),C.jsxs("strong",{className:j,children:[Wh(gt),C.jsx("small",{children:"°"})]}),C.jsx("span",{className:"angle-caption",children:gt===null?"未検出 / 遮蔽":V==="abduction"?gt>=0?"外転（外側へ・概算）":"内転（内側へ・概算）":"屈曲角度"})]},j)})}),C.jsxs("div",{className:"range-summary",children:[C.jsxs("span",{children:["左側の可動範囲 ",C.jsx("small",{children:"全区間"})]}),C.jsx("strong",{children:bt?`${Wh(bt.min)}° — ${Wh(bt.max)}°`:"—"}),C.jsx("div",{children:C.jsx("i",{style:{left:`${(((bt==null?void 0:bt.min)??Dt)-Dt)/($t-Dt)*100}%`,width:`${(((bt==null?void 0:bt.max)??Dt)-((bt==null?void 0:bt.min)??Dt))/($t-Dt)*100}%`}})})]}),C.jsxs("div",{className:"confidence-section",children:[C.jsxs("div",{children:[C.jsx("span",{children:et?"2D関節の検出スコア":"関節の見えやすさ"}),C.jsx("strong",{children:te!=null&&te.landmarks?`${Math.round(T*100)}%`:"—"})]}),C.jsx("div",{className:"confidence-bar",children:C.jsx("i",{style:{width:`${T*100}%`}})}),C.jsxs("p",{children:[te!=null&&te.landmarks?T>.8?"主要な関節が見えています":"遮蔽のある関節は角度を表示しません":g?"このフレームは人物を検出できませんでした":"解析後にフレームごとの値を表示します",C.jsx("br",{}),et?"RTMPoseの2Dスコア平均。3Dの精度ではありません。":"モデルの visibility 平均。精度の保証値ではありません。"]})]}),C.jsxs("label",{className:"toggle-label smoothing",children:[C.jsxs("span",{children:[C.jsx(SS,{size:14}),"動きをなめらかにする"]}),C.jsx("input",{type:"checkbox",checked:$,onChange:j=>q(j.target.checked)}),C.jsx("i",{})]})]})]}),C.jsxs("section",{className:"panel session-card",children:[C.jsxs("div",{className:"mini-heading",children:[C.jsx(gS,{size:15}),"解析サマリー"]}),C.jsxs("dl",{children:[C.jsxs("div",{children:[C.jsx("dt",{children:"推定点"}),C.jsx("dd",{children:et?"26点（2D） / 17点（3D）":"33 ランドマーク"})]}),C.jsxs("div",{children:[C.jsx("dt",{children:"解析フレーム"}),C.jsx("dd",{children:g?`${O} / ${g.frames.length}`:"—"})]}),C.jsxs("div",{children:[C.jsx("dt",{children:"解析間隔"}),C.jsx("dd",{children:g?`${g.fps} fps`:"—"})]}),C.jsxs("div",{children:[C.jsx("dt",{children:"座標"}),C.jsx("dd",{children:et?"腰中心・相対スケール":"腰中心・3D"})]})]}),C.jsxs("div",{className:"export-area",children:[C.jsxs("button",{className:"secondary export-button",disabled:!g,onClick:()=>Ut(!ut),children:[C.jsx(cS,{size:15}),"解析データを出力",C.jsx(fS,{size:13})]}),ut&&C.jsxs("div",{className:"export-menu",children:[C.jsx("button",{onClick:()=>Kt("csv"),children:"関節角度を CSV で保存"}),C.jsx("button",{onClick:()=>Kt("json"),children:"3D座標を JSON で保存"})]})]})]}),C.jsxs("div",{className:"info-note",children:[C.jsx(ch,{size:15}),C.jsxs("p",{children:["単眼動画からの推定です。カメラ移動や身体の遮蔽により誤差が生じます。移動距離・速度・筋力は算出しません。",C.jsxs("button",{onClick:()=>Y(!0),children:["解析について ",C.jsx(rc,{size:12})]})]})]})]})]}),C.jsxs("footer",{className:"page-footer",children:[C.jsxs("span",{children:[C.jsx(sc,{size:12})," STRIDE MOTION LAB"]}),C.jsx("span",{children:"ひとつの動画から、動きの理解を深める。"})]})]})]}),Rt&&C.jsx("div",{className:"modal-backdrop",onClick:()=>Y(!1),children:C.jsxs("section",{className:"help-modal",role:"dialog","aria-modal":"true","aria-label":"使い方と解析について",onClick:j=>j.stopPropagation(),children:[C.jsx("button",{className:"modal-close icon-button",onClick:()=>Y(!1),"aria-label":"ガイドを閉じる",children:C.jsx(uh,{size:19})}),C.jsx("div",{className:"eyebrow",children:"GETTING STARTED"}),C.jsx("h2",{children:"動作を、いろいろな角度から。"}),C.jsxs("ol",{children:[C.jsxs("li",{children:[C.jsx("strong",{children:"動画を選ぶ"}),C.jsx("p",{children:"2分・500MB以内の動画を読み込みます。全身が写った1人の動画を推奨します。付属のハードル動画でも試せます。"})]}),C.jsxs("li",{children:[C.jsx("strong",{children:"3D推定を開始"}),C.jsx("p",{children:"各フレームを端末内で解析します。15 / 30 / 60 fpsを選べます。複数人の場合は最初に大きく写った人物を追跡しますが、交差時には入れ替わる可能性があります。"})]}),C.jsxs("li",{children:[C.jsx("strong",{children:"同期再生で確認"}),C.jsx("p",{children:"動画と3D骨格、関節角度が連動します。スロー再生、コマ送り、グラフのクリックで気になる瞬間を確認できます。"})]})]}),C.jsxs("div",{className:"help-detail",children:[C.jsx("h3",{children:"数値と3D表示の読み方"}),C.jsx("p",{children:"膝・肘は3点間の角度から屈曲角を計算し、伸びた状態を0°とします。股関節（屈曲・近似）は肩・腰・膝を使う近似値で、外転や体幹の動きも含んだ1つの数値です。"}),C.jsx("p",{children:"「股関節（外転）」は肩・腰の位置から体幹基準の矢状面を近似し、大腿がその面からどれだけ横に外れているかを±90°の範囲で表す概算値です。前後の屈曲量に関わらず定義され、股関節が深く曲がっている局面でも数値は破綻しません。前後の屈曲成分自体は含みません。単一カメラのため肩と腰から近似した体幹の向きに基づいており、体幹が大きく前傾・回旋する局面では実際の骨盤の傾きとのずれが乗ります。肩・反対側の腰が遮蔽されているフレームは欠測になります。"}),C.jsx("p",{children:"3Dは腰中心の相対座標です。RTMPoseは26点の2D検出を行い、MotionBERTが前後最大243フレームから17点の3D骨格を推定します。この3D座標は未校正の相対スケールで、表示サイズの調整は関節角度に影響しません。MediaPipeとの切り替えで同じ時刻を比較できます。地面の格子は表示の目安で、実際の地面や跳躍高を測定してはいません。"}),C.jsx("p",{children:"3D表示は既定では腰を原点に固定するため、追いかけ動画・定点動画のどちらでも身体はその場で動いているように見えます。「固定カメラで撮影」を有効にすると、肩・腰の画面上の動きから横方向・上下方向の実際の移動を概算し、腰を原点に固定せず前後左右に動かします（奥行き方向の移動は推定していません）。この機能はカメラが動いていない動画専用です。追いかけ動画で有効にすると、カメラ自身の動きを身体の移動として誤表示します。足首の軌跡は、この設定に関わらず腰を基準にした相対的な動きです。"}),C.jsx("p",{children:"なめらか表示は前後1フレームの平均です。関節のvisibilityまたはRTMPoseの2Dスコアが0.5未満の角度は欠測です。MotionBERT入力の欠測は一時補間しますが、該当点の低スコアは出力に引き継ぎます。CSVは表示中の補正設定、JSONは生の推定座標を出力します。"}),C.jsx("p",{children:"MediaPipeはブラウザ内で処理し、動画を送信しません。RTMPose + MotionBERTはこのサイトの共有サーバーで処理します。アップロードした動画は解析の完了・中止・エラー時にサーバーから削除し、それ以外の目的には使用しません。個別に読み込んだ動画と解析結果は再読み込みで消えるため、必要な結果は出力してください。"}),C.jsx("a",{href:"https://ai.google.dev/edge/mediapipe/solutions/vision/pose_landmarker",target:"_blank",rel:"noreferrer",children:"MediaPipe Pose Landmarker 公式ドキュメント ↗"})]}),C.jsxs("button",{className:"primary",onClick:()=>Y(!1),children:["解析をはじめる ",C.jsx(rc,{size:15})]})]})})]})}sS.createRoot(document.getElementById("root")).render(C.jsx(Qy.StrictMode,{children:C.jsx(p2,{})}));
